...
// node_modules/@carrotsearch/foamtree/foamtree.js
(function() {
  var ea = function() {
  ...
  function na() {
    function a() {
      ...
      for (var c = 0; c < e.length; c++) {
        var b = e[c];
        null !== b && (true === b.ee.call(b.context) ? e[c] = null : P.zc(b.repeat) && (b.repeat = b.repeat - 1, 0 >= b.repeat && (e[c] = null)));
      }
      e = e.filter(function(h) {
        return null !== h;
      });
  ...
  var ra = ea.md(function() {
    ...
    a.prototype.Na = function(m) {
      ...
      m instanceof ra ? c(m, this.buffer, this.ma) : b(m, this.buffer, this.ma, P.I(
        m.globalAlpha,
        1
      ));
    };
    ...
    a.prototype.fillPolygonWithText = function(m, c, b, h, f) {
      f || (f = {});
      var u = { hb: P.I(f.maxFontSize, ta.ya.hb), Gc: P.I(f.minFontSize, ta.ya.Gc), lineHeight: P.I(f.lineHeight, ta.ya.lineHeight), cb: P.I(f.horizontalPadding, ta.ya.cb), Ua: P.I(f.verticalPadding, ta.ya.Ua), ib: P.I(f.maxTotalTextHeight, ta.ya.ib), fontFamily: P.I(f.fontFamily, ta.ya.fontFamily), fontStyle: P.I(f.fontStyle, ta.ya.fontStyle), fontVariant: P.I(f.fontVariant, ta.ya.fontVariant), fontWeight: P.I(f.fontWeight, ta.ya.fontWeight), verticalAlign: P.I(f.verticalAlign, ta.ya.verticalAlign) }, t = f.cache;
      if (t && P.has(f, "area")) {
        t.Qc || (t.Qc = new ra());
        var n = f.area, k = P.I(f.cacheInvalidationThreshold, 0.05);
        m = ta.de(u, this, h, m, wa.F(m, {}), { x: c, y: b }, f.allowForcedSplit || false, f.allowEllipsis || false, t, n, k, f.invalidateCache);
      } else m = ta.se(u, this, h, m, wa.F(m, {}), { x: c, y: b }, f.allowForcedSplit || false, f.allowEllipsis || false);
      return m.ka ? { fit: true, lineCount: m.bc, fontSize: m.fontSize, box: { x: m.box.x, y: m.box.y, w: m.box.w, h: m.box.o }, ellipsis: m.Ub } : { fit: false };
    };
    return a;
  });
  var xa = ea.md(function() {
    function a(b) {
      ...
      this.yd = [10];
      this.Xb = [10];
      this.Hb = [this.zb, this.vc, this.Xb, this.td, this.ud, this.Rd, this.yd, this.Sd, this.Td];
      this.da = [1, 0, 0, 1, 0, 0];
    }
    function q(b) {
  ...
  var ya = { Ud: function(a, q) {
    ...
    for (e = 0; e < m; e++) {
      ...
      wa.ga(t, b, g, f);
      u++;
      0 == e && (wa.ga(Math.min(0.5, l / d[0]), c, b, p), u++, a.moveTo(p.x, p.y));
  ...
  function Ba(a) {
    ...
    this.M = function(n) {
      e = n;
      0 !== e.clientWidth && 0 !== e.clientHeight || Ca.i("element has zero dimensions: " + e.clientWidth + " x " + e.clientHeight + ".");
      e.innerHTML = "";
      p = e.clientWidth;
      m = e.clientHeight;
      c = 0 !== p ? p : void 0;
    ...
    this.Za = function() {
      q() && (e.removeAttribute("data-foamtree"), h = [], f = {}, e.removeChild(d), a.j.D("stage:disposed", this, d));
    };
    this.u = function() {
      p = e.clientWidth;
      m = e.clientHeight;
  ...
  function Da(a) {
    ...
    var e = 1, d = { x: 0, y: 0 }, p = 1, m = 1, c = 1, b = { x: 0, y: 0 }, h = 1, f = { x: 0, y: 0 }, u = { x: 0, y: 0 }, t = { x: 0, y: 0 }, n, k, r = { x: 0, y: 0, w: 0, o: 0 }, y = { x: 0, y: 0, w: 0, o: 0, scale: 1 }, v = true;
    ...
    this.ga = function(w, z) {
      ...
      return q(z, function() {
        for (var D = false; !D; ) {
          ...
          D = g(w.x + D * w.w, w.y + G * w.o, r.x + D * r.w, r.y + G * r.o, w.x + O * w.w, w.y + H * w.o, r.x + O * r.w, r.y + H * r.o, b);
        }
      }, true);
    };
    this.ic = function(w, z) {
      ...
      if (E < D) {
        ...
        E = w.x - 0.5 * (G - w.w);
        D = w.y;
      } else E > D ? (G = w.w, O = w.w * k / n, E = w.x, D = w.y - 0.5 * (O - w.o)) : (E = w.x, D = w.y, G = w.w, O = w.o);
      E -= G * z;
      D -= O * z;
      G *= 1 + 2 * z;
      if (g(E, D, f.x, f.y, E + G, D, f.x + n / h, f.y, b)) return q(n / h / G, P.qa, false);
      v = false;
    ...
    this.reset = function(w) {
      ...
      return this.ga({ x: r.x + f.x, y: r.y + f.y, w: r.w / h, o: r.o / h }, c / p);
    };
    this.Fb = function(w) {
  ...
  function Ka(a) {
    ...
    var y, v, w, z, E = { x: 0, y: 0 }, D = { x: 0, y: 0 }, G = false, O = false;
    d.addEventListener("mousedown", q(function(H) {
      if (H.target !== a) {
        ...
        y = window.setTimeout(function() {
          100 > wa.i(E, B) && (window.clearTimeout(z), g(H, m), v = true);
        }, 400);
      }
    }));
    d.addEventListener("mouseup", function(H) {
      var B = g(H, b);
      G && (O && g(H, k), window.clearTimeout(y), v || O || !l(H) || (B = { x: B.x, y: B.y }, w && 100 > wa.i(B, w) ? g(H, h) : g(H, p), w = B, z = window.setTimeout(function() {
        w = null;
      }, 350)), O = G = false);
    });
    ...
    d.addEventListener("wheel", q(/* @__PURE__ */ function() {
      return function(H) {
        ...
        else B = 0, "detail" in H && (B = H.detail), "wheelDelta" in H && (B = -H.wheelDelta / 120), "wheelDeltaY" in H && (B = -H.wheelDeltaY / 120), "axis" in H && H.axis === H.HORIZONTAL_AXIS && (B = 0), B *= 10;
        B && H.deltaMode && (B = 1 === H.deltaMode ? 67 * B : 800 * B);
        g(H, r, { ed: -B / 200, ci: true });
      };
    }()), { passive: false });
  ...
  var La = function() {
    ...
    }]), Uf: a(2), Gb: q(2), Vf: l(2), xg: a(3), fe: q(3), yg: l(3), vi: a(2), xi: q(2), wi: l(2), rj: g };
  }();
  var P = { V: function(a) {
    return void 0 === a;
  }, Se: function(a) {
    ...
    for (var a = 0; a < arguments.length; a++) {
      var q = arguments[a];
      if (!(P.V(q) || P.zc(q) && isNaN(q) || P.Ac(q) && P.Oe(q))) return q;
    }
  }, Jf: function(a, q) {
    q = a.indexOf(q);
    0 <= q && a.splice(q, 1);
  ...
  function Qa(a) {
    function q(b, h, f) {
      ...
      this.start = function() {
        if (!u.xb()) {
          if (-1 == c.indexOf(u)) {
            var k = m.now();
            true === u.bf(k) && (c = c.slice(), c.push(u));
          }
      ...
      this.bf = function(k) {
        ...
        if (0 !== h.length) {
          ...
          for (; t < h.length; ) {
            if (r.gb && r.gb.call(r, k, n, u)) return true;
    ...
    this.K = function() {
      ...
      function h(k) {
        ...
        var y = k.target, v = k.duration, w = k.ba, z, E;
        this.before = function() {
          z = {};
          for (var D in k.P) y.hasOwnProperty(D) && (z[D] = { start: P.V(k.P[D].start) ? y[D] : r(k.P[D].start), end: P.V(k.P[D].end) ? y[D] : r(k.P[D].end), easing: P.V(k.P[D].easing) ? La.Ab : k.P[D].easing });
          E = m.now();
        };
        this.gb = function() {
          var D = m.now() - E;
      ...
      b.A = function(k, r) {
        return new function() {
          ...
          this.call = function(w, z) {
            return y(this, w, z, false);
          };
          this.Xa = function(w, z) {
            return y(this, w, z, true);
          };
          this.fa = function(w) {
  ...
  var Ra = function() {
    var a = { oe: function(q, l) {
      ...
      if (q.m) {
        q = q.m;
        for (var g = 0; g < q.length; g++) if (false === a.sc(q[g], l) || false === l(q[g], g)) return false;
      }
    } };
    a.L = a.sc;
    a.tc = function(q, l) {
      if (q.m) {
        q = q.m;
        for (var g = 0; g < q.length; g++) if (false === l(q[g], g) || false === a.tc(q[g], l)) return false;
      }
    };
    a.za = function(q, l) {
      if (q.m) {
        for (var g = q.m, e = 0; e < g.length; e++) if (false === a.za(g[e], l)) return false;
      }
      return l(q);
    };
    a.sj = a.za;
  ...
  var wa = new function() {
    ...
    function q(l, g, e) {
      for (var d = 0; d < l.length; d++) {
        var p = wa.T(l[d], l[d + 1] || l[0], g, e, true);
        if (p) return p;
      }
    }
    ...
    this.Ka = function(l, g, e, d, p) {
      ...
      function c(n, k, r) {
        ...
        var y = q(l, g, f), v = Math.sqrt(a(y, g) / (n * n + k * k));
        return v < b ? (b = v, m = y.x, h = y.y, 0 !== k ? Math.abs(h - g.y) / Math.abs(k) : Math.abs(m - g.x) / Math.abs(n)) : r;
      }
      d = P.I(d, 0.5);
      p = P.I(p, 0.5);
      e = P.I(e, 1);
  ...
  var Sa = new function() {
    ...
    function q(d, p, m) {
      ...
      this.Ya = [];
      this.ad = this.visible = false;
    }
    this.i = function(d) {
      function p(aa, C, U) {
        var ha = aa.la[0], ba = aa.Ha, ja = ba.x, N = ba.y;
        ba = ba.z;
        var S = Array(b);
        C = C.Ya;
        var ca = C.length;
        for (c = 0; c < ca; c++) {
          var I = C[c].Rc;
          S[I.index] = true;
          0 > ja * (I.x - ha.x) + N * (I.y - ha.y) + ba * (I.z - ha.z) && a.add(aa, I);
        }
        C = U.Ya;
        ca = C.length;
        for (c = 0; c < ca; c++) I = C[c].Rc, true !== S[I.index] && 0 > ja * (I.x - ha.x) + N * (I.y - ha.y) + ba * (I.z - ha.z) && a.add(aa, I);
      }
      var m, c, b = d.length;
      ...
      if (0 < (f = function() {
        function aa(T, R, V, fa) {
          ...
          x = x.x * A.y - x.y * A.x;
          return F * fa.x + L * fa.y + x * fa.z > F * T.x + L * T.y + x * T.z ? new q(T, R, V) : new q(V, R, T);
        }
        function C(T, R, V, fa) {
          function x(A, F, L) {
            A = A.la;
        ...
        if (4 > b) return 0;
        var U = d[0], ha = d[1], ba = d[2], ja = d[3], N = aa(U, ha, ba, ja), S = aa(U, ba, ja, ha), ca = aa(U, ha, ja, ba), I = aa(ha, ba, ja, U);
        C(N, S, ba, U);
        C(N, ca, U, ha);
        C(N, I, ha, ba);
        C(S, ca, ja, U);
        ...
        C(ca, I, ja, ha);
        h.push(N, S, ca, I);
        for (U = 4; U < b; U++) for (ha = d[U], ba = 0; 4 > ba; ba++) ja = h[ba], N = ja.la[0], S = ja.Ha, 0 > S.x * (ha.x - N.x) + S.y * (ha.y - N.y) + S.z * (ha.z - N.z) && a.add(ja, ha);
        return 4;
      }())) {
        for (; f < b; ) {
          var u = d[f];
          if (u.Pb) {
            for (m = u.Pb; null !== m; ) m.face.visible = true, m = m.ec;
            m = 0;
            a: for (; m < h.length; m++) {
              var t = h[m];
              if (false === t.visible) {
            ...
            var y = k, v = r;
            do
              if (t.push(y), n.push(v), v = (v + 1) % 3, false === y.J[v].visible) {
                do
                  for (m = y.la[v], y = y.J[v], c = 0; 3 > c; c++) y.la[c] == m && (v = c);
                while (false === y.J[v].visible && (y !== k || v !== r));
              }
            while (y !== k || v !== r);
            var w = null, z = null;
            for (m = 0; m < t.length; m++) {
              y = t[m];
              v = n[m];
              var E = y.J[v], D = y.la[(v + 1) % 3], G = y.la[v], O = D.y - u.y, H = G.z - u.z, B = D.x - u.x, M = D.z - u.z, Q = G.x - u.x, X = G.y - u.y;
              if (0 < e.length) {
                var Y = e.pop();
                Y.la[0] = u;
                Y.la[1] = D;
                ...
                Y.visible = false;
                Y.ad = true;
              } else Y = { la: [u, D, G], J: Array(3), Ha: { x: O * H - M * X, y: M * Q - B * H, z: B * X - O * Q }, Ya: [], visible: false };
              h.push(Y);
              y.J[v] = Y;
              Y.J[1] = y;
            ...
            for (c = 0; c < h.length; c++) if (t = h[c], true === t.visible) {
              n = t.Ya;
              y = n.length;
              for (u = 0; u < y; u++) v = n[u], w = v.Lc, z = v.ec, null !== w && (w.ec = z), null !== z && (z.Lc = w), null === w && (v.Rc.Pb = z), l.push(v);
              t.ad && e.push(t);
            } else m.push(t);
            h = m;
          }
    ...
    var e = Array(1e3);
    for (g = 0; g < e.length; g++) e[g] = { la: Array(3), J: Array(3), Ha: { x: 0, y: 0, z: 0 }, Ya: [], visible: false };
  }();
  var Ta = new function() {
  ...
  var Ua = new function() {
    ...
    this.i = function(q, l) {
      function g(n) {
        var k = [n[0]], r = n[0][0], y = n[0][1], v = n.length, w = 1;
        a: for (; w < v; w++) for (var z = 1; z < v; z++) {
          var E = n[z];
          if (null !== E) {
            if (E[1] === r) if (k.unshift(E), r = E[0], n[z] = null, k.length === v) break a;
            else continue;
            if (E[0] === y && (k.push(E), y = E[1], n[z] = null, k.length === v)) break a;
          }
        }
      ...
      function e(n, k, r, y) {
        var v = [], w = [], z = r.length, E, D = k.length, G = 0, O = -1, H = -1, B, M = y;
        for (y = 0; y < z; y++) {
          var Q = (M + 1) % z, X = r[M][0], Y = r[Q][0];
          if (1e-12 < wa.i(X.ea, Y.ea)) if (X.jb && Y.jb) {
            var aa = [], C = [];
            for (E = 0; E < D; E++) {
              var U = (G + 1) % D;
              if (B = wa.T(k[G], k[U], X.ea, Y.ea, false)) {
            ...
            if (2 === aa.length) {
              ...
              E = C[X];
              -1 === O && (O = E);
              if (-1 !== H) for (; E != H; ) H = (H + 1) % D, v.push(k[H]), w.push(null);
              v.push(aa[X], aa[B]);
              w.push(r[M][2], null);
              H = C[B];
            }
          } else if (X.jb && !Y.jb) for (E = 0; E < D; E++) {
            U = (G + 1) % D;
            if (B = wa.T(k[G], k[U], X.ea, Y.ea, false)) {
              if (-1 !== H) for (aa = H; G != aa; ) aa = (aa + 1) % D, v.push(k[aa]), w.push(null);
              v.push(B);
              w.push(r[M][2]);
              -1 === O && (O = G);
              break;
        ...
        else if (-1 !== H) for (; O != H; ) H = (H + 1) % D, v.push(k[H]), w.push(null);
        n.C = v;
        n.J = w;
      }
      if (1 === q.length) q[0].C = l.slice(0), q[0].J = [];
        ...
        (function() {
          for (d = 0; d < b.length; d++) {
            var n = b[d], k = n.la, r = k[0], y = k[1], v = k[2];
            k = r.x;
            var w = r.y;
            r = r.z;
            var z = y.x, E = y.y;
            ...
            n.ea = { x: -(w * (y - v) + E * (v - r) + G * (r - y)) / O / 2, y: -(r * (z - D) + y * (D - k) + v * (k - z)) / O / 2 };
          }
        })();
        (function(n) {
          for (d = 0; d < b.length; d++) {
        ...
        m = function(n, k) {
          var r = Array(k.length), y;
          for (y = 0; y < r.length; y++) r[y] = [];
          for (y = 0; y < n.length; y++) {
            var v = n[y];
            if (!(0 > v.Ha.z)) for (var w = v.J, z = 0; z < w.length; z++) {
              var E = w[z];
              if (!(0 > E.Ha.z)) {
                var D = v.la, G = D[(z + 1) % 3].index;
                D = D[z].index;
        ...
        for (d = 0; d < q.length; d++) if (c = m[d], 0 !== c.length) {
          ...
          if (0 <= u) e(h, l, c, u);
            ...
            u = [];
            var t = [];
            for (p = 0; p < f; p++) 1e-12 < wa.i(c[p][0].ea, c[(p + 1) % f][0].ea) && (u.push(c[p][0].ea), t.push(c[p][2]));
            h.C = u;
            h.J = t;
          }
    ...
    this.u = function(q, l) {
      ...
      if (e) {
        ...
        for (p = 0; p < g; p++) {
          ...
          t = Number.MAX_VALUE;
          m = null;
          for (var n in b) b = q[n], h = wa.i(c, b), t > h && (t = h, m = b);
          c.zj = m;
          c.$e = Math.sqrt(t);
        }
        for (g = 0; g < d; g++) p = q[g], n = Math.min(Math.sqrt(p.w), 0.95 * p.$e), p.w = n * n;
        this.i(q, l);
        for (g = 0; g < d; g++) p = q[g], p.Yd !== p.w && 0 < p.kc && (l = Math.min(
          p.kc,
          p.Yd - p.w
        ), p.w += l, p.kc -= l);
      }
  ...
  var Va = new function() {
    ...
    this.u = function(a, q, l) {
      ...
      if (g[0].J) {
        var e = g.length;
        for (a = 0; a < e; a++) g[a].Sc = false, g[a].Zb = 0;
        e = [];
        var d;
        var p = d = 0;
        e[d++] = q || g[0];
        for (q = q.Zb = 0; p < d; ) if (g = e[p++], !g.Sc && g.J) {
          l(g, q++, g.Zb);
          g.Sc = true;
          var m = g.J, c = m.length;
          for (a = 0; a < c; a++) {
            var b = m[a];
            b && true !== b.Sc && (0 === b.Zb && (b.Zb = g.Zb + 1), e[d++] = b);
          }
        }
  ...
  var ta = /* @__PURE__ */ function() {
    function a(n, k, r, y, v, w, z, E) {
      ...
      n = D.fontFamily;
      var G = D.fontStyle + " " + D.fontVariant + " " + D.fontWeight, O = D.hb, H = D.Gc, B = G + " " + n;
      D.ue = B;
      var M = { ka: false, bc: 0, fontSize: 0 };
      k.save();
      k.font = G + " 100px " + n;
      ...
      u.text = r;
      e(y, v, w, t);
      if (/[\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf]/.test(r)) g(u), l(k, u, B), d(D, u, t, H, O, true, M);
      else if (l(k, u, B), d(
        D,
        u,
        t,
        ...
        false,
        M
      ), !M.ka && (z && (g(u), l(k, u, B)), E || z)) E && (M.Ub = true), d(D, u, t, H, H, true, M);
      if (M.ka) {
        var Q = "", X = 0, Y = Number.MAX_VALUE, aa = Number.MIN_VALUE;
        p(D, u, M.bc, M.fontSize, t, M.Ub, function(C, U) {
          0 < Q.length && " " === U && (Q += " ");
          Q += C;
    ...
    function l(n, k, r) {
      var y, v = k.text.split(/(\n|[ \f\r\t\v\u2028\u2029]+|\u00ad+|\u200b+)/), w = [], z = [], E = v.length >>> 1;
      for (y = 0; y < E; y++) w.push(v[2 * y]), z.push(v[2 * y + 1]);
      2 * y < v.length && (w.push(v[2 * y]), z.push(void 0));
      r = c[r];
      for (y = 0; y < w.length; y++) v = w[y], E = r[v], void 0 === E && (E = n.measureText(v).width, r[v] = E);
      k.Tc = w;
      k.Rf = z;
    }
    function g(n) {
      for (var k = n.text.split(/\s+/), r = [], y = {
        ".": true,
        ",": true,
        ";": true,
        "?": true,
    ...
    function d(n, k, r, y, v, w, z) {
      var E = n.lineHeight, D = Math.max(n.Ua, 1e-3), G = n.ib, O = k.Tc, H = r.cd, B = r.F, M = void 0, Q = void 0;
      ...
      if (0 >= G) z.ka = false;
        ...
        do {
          var X = (H + v) / 2, Y = Math.min(O.length, Math.floor((G + X * (E - 1 - 2 * D)) / (X * E))), aa = void 0;
          if (0 < Y) {
            var C = 1, U = Y;
            do {
        ...
        void 0 === Q ? (z.ka = false, z.fontSize = 0) : (z.ka = true, z.fontSize = Q, z.bc = M, z.Ub = w && X === H);
        return z;
      }
    }
    function p(n, k, r, y, v, w, z, E) {
      var D = n.cb, G = y * (n.lineHeight - 1), O = Math.max(n.Ua, 1e-3), H = c[n.ue], B = k.Tc;
      k = k.Rf;
      var M = v.C, Q = v.cd, X = v.Ye, Y = v.Ze;
      switch (n.verticalAlign) {
        case "top":
          v = Q.y + y / 2 + y * O;
          var aa = 1;
      ...
      n = v;
      for (O = 0; O < r; O++) b[2 * O] = v - y / 2, b[2 * O + 1] = v + y / 2, v += aa * y, v += aa * G;
      ...
      Y = (Y + 1) % C;
      for (var ba = 0; ba < v; ) {
        for (var ja = O[ba], N = M[X]; N.y < ja; ) U = X, X = (X - 1 + C) % C, N = M[X];
      ...
      for (O = 0; O < r; O++) M = 2 * O, v = Q.x, aa = v - h[M][0], C = h[M][1] - v, aa = aa < C ? aa : C, C = v - h[M + 1][0], M = h[M + 1][1] - v, M = C < M ? C : M, f[O] = 2 * (aa < M ? aa : M) - D * y;
      U = H[" "] * y / 100;
      aa = H["…"] * y / 100;
      D = 0;
      X = f[D];
      ...
      for (O = 0; O < B.length; O++) {
        ...
        ha = k[O];
        C = H[v] * y / 100;
        if (Q + C < X && B.length - O >= r - D && "\n" != M) Q += C, " " === ha && (Q += U), z && z(v, M);
        else {
          if (C > X && (D !== r - 1 || !w)) return false;
          if (D + 1 >= r) {
            if (w) {
              r = X - Q - aa;
    ...
    }, c = {}, b = [], h = [], f = [], u = { text: "", Tc: void 0, Rf: void 0 }, t = { C: void 0, F: void 0, cd: void 0, Ye: 0, Ze: 0 };
    return { se: a, de: function(n, k, r, y, v, w, z, E, D, G, O, H) {
      var B = 0, M = 0;
      r = r.toString().trim();
      if (!H && D.result && r === D.Yf && Math.abs(G - D.Zd) / G <= O) {
        var Q = D.result;
        Q.ka && (B = w.x - D.fg, M = w.y - D.gg, O = D.Qc, k.save(), k.translate(B, M), O.Na(k), k.restore());
      }
      Q || (O = D.Qc, O.clear(), Q = a(
        n,
        O,
        r,
        y,
        ...
        z,
        E
      ), Q.ka && O.Na(k), D.Zd = G, D.fg = w.x, D.gg = w.y, D.result = Q, D.Yf = r);
      return Q.ka ? { ka: true, bc: Q.bc, fontSize: Q.fontSize, box: { x: Q.box.x + B, y: Q.box.y + M, w: Q.box.w, o: Q.box.o }, Ub: Q.Ub } : { ka: false };
    }, bi: function() {
      return { Zd: 0, fg: 0, gg: 0, result: void 0, Qc: new ra(), Yf: void 0 };
    }, ya: m };
  }();
  var Wa = new function() {
    function a(g, e) {
      return function(d, p, m, c) {
        function b(r, y, v, w, z) {
          if (0 != r.length) {
            ...
            B = D / z;
            do
              D = E.shift(), H = D.lc, O = H / B, H = D, M = G, Q = O, H.x = y + B / 2, H.y = M + Q / 2, m && h(D, y, G, B, O), G += O;
            while (0 < E.length);
            return b(r, y + B, v, w - B, z);
          }
        }
        function h(r, y, v, w, z) {
          r.C = [{ x: y, y: v }, { x: y + w, y: v }, { x: y + w, y: v + z }, { x: y, y: v + z }];
        }
        var f = p.x, u = p.y, t = p.w;
        p = p.o;
        if (0 != d.length) if (1 == d.length) d[0].x = f + t / 2, d[0].y = u + p / 2, d[0].nd = 0, m && h(d[0], f, u, t, p);
        else {
          d = d.slice(0);
  ...
  function Xa(a) {
    ...
    this.bd = function(e, d, p, m, c, b, h) {
      if (e) {
        ...
        0 < d.length && h(P.extend({ groups: Ra.uc(g, m).map(function(t) {
          return t.group;
        }) }, c));
      }
    };
    ...
    this.Wc = function(e, d, p) {
      ...
      p && d.$ && (e.polygon = d.$.map(function(c) {
        return { x: c.x, y: c.y };
      }), e.neighbors = d.J && d.J.map(function(c) {
        return c && c.group;
      }));
      return e;
    };
  ...
  function Ya(a) {
    function q(k, r) {
      ...
      k.Ea = true;
      var y = e(r), v = 0;
      if (("flattened" === a.mb || "always" === a.Ag && k.group && k.group.description) && 0 < r.length && 0 < k.level) {
    ...
    function p(k) {
      if (!k.empty()) {
        k = k.m.slice(0).sort(function(y, v) {
          return y.weight < v.weight ? 1 : y.weight > v.weight ? -1 : y.index - v.index;
        });
        for (var r = 0; r < k.length; r++) k[r].nd = r;
      }
    }
    function m() {
      for (var k = b.m.reduce(function(v, w) {
        return v + w.weight;
      }, 0), r = 0; r < b.m.length; r++) {
        var y = b.m[r];
    ...
    this.T = function(k) {
      var r = k.group.groups, y = a.Uh;
      return !k.m && !k.description && r && 0 < r.length && n + r.length <= y ? (n += r.length, q(k, r), d(k), p(k), true) : false;
    };
    this.load = function(k) {
      ...
      function y(v, w) {
        ...
        if ((v = v.groups) && 0 < v.length) for (var z = v.length - 1; 0 <= z; z--) w = y(v[z], w);
        return w;
      }
      b.group = k;
      b.xa = false;
    ...
    this.H = function(k, r, y) {
      return { m: c.u(k), Ca: P.I(k && k[r], true), Ba: P.I(k && k.keepPrevious, y) };
    };
  }
  function $a(a, q, l) {
    var g = {};
    q.Ba && Ra.L(a, function(m) {
      l(m) && (g[m.id] = m);
    });
    a = q.m;
    q = q.Ca;
  ...
  function ab(a) {
    ...
    function l(B) {
      B = B.ja;
      return Math.max(1e-3, 0 === B ? 1 : 1 + B * (t.Pa - 1));
    }
    function g(B, M) {
      for (var Q = B.reduce(function(C, U) {
        C[U.id] = U;
        return C;
      }, {}), X = B.length - 1; 0 <= X; X--) Ra.L(B[X], function(C) {
        Q[C.id] = void 0;
      });
      var Y = [];
      P.Aa(Q, function(C) {
        C && Ra.ne(C, function(U) {
          U.open || Y.push(U);
        });
      });
      var aa = [];
    ...
    function e(B, M, Q, X) {
      ...
      if (z.reduce(function(ba, ja) {
        ...
        z.forEach(function(ba) {
          aa[ba.id] && (ba.U || C.push(ba), ba.U = true, Ra.za(ba, function(ja) {
            U.push(b(ja, 1));
            ha[ja.id] = true;
          }));
        });
        0 < U.length ? (Ra.L(n, function(ba) {
          aa[ba.id] || (ba.U && C.push(ba), ba.U = false);
          ha[ba.id] || U.push(b(ba, -1));
        }), B.push(v.K.A({}).Qa(U).call(h).Ta()), d(aa), B.push(p(Y)), Q && (y.ic(E, t.Yb, t.Oa, La.ia(t.Wb)), y.Fb())) : (B.push(c(Q)), M && Ra.L(n, function(ba) {
          ba.U && C.push(ba);
        }));
      }
      return Ga(B).then(function() {
        r.bd(M, C, "exposed", function(ba) {
          return ba.U;
        }, { indirect: X }, a.options.jf, a.options.hf);
      });
    }
    function d(B) {
    ...
    function p(B) {
      if (B || !y.zd()) return v.K.A(k).fa({ duration: 0.7 * t.Oa, P: { x: { end: E.x + E.w / 2, easing: La.ia(t.Wb) }, y: { end: E.y + E.o / 2, easing: La.ia(t.Wb) } }, ba: function() {
        a.j.D("foamtree:dirty", true);
      } }).Ta();
      k.x = E.x + E.w / 2;
      k.y = E.y + E.o / 2;
    ...
    function b(B, M, Q) {
      ...
      X.fa({ duration: t.Oa, P: { ja: { end: M, easing: La.ia(t.Wb) } }, ba: function() {
        n.N = true;
        n.Fa = true;
        a.j.D("foamtree:dirty", true);
      } });
    ...
    function h() {
      var B = n.m.reduce(f(false, O.transformPoint, void 0), u({})).box, M = t.Yb, Q = Math.min(B.x, E.x - E.w * M), X = Math.min(B.y, E.y - E.o * M);
    ...
    function f(B, M, Q) {
      ...
      return function(Y, aa) {
        if (!Q || Q(aa)) {
          for (var C = B ? aa.$ || aa.C : aa.C, U, ha = C.length - 1; 0 <= ha; ha--) U = void 0 !== M ? M(aa, C[ha], X) : C[ha], Y.Hc = Math.min(Y.Hc, U.x), Y.wd = Math.max(Y.wd, U.x), Y.Ic = Math.min(Y.Ic, U.y), Y.xd = Math.max(Y.xd, U.y);
          Y.box.x = Y.Hc;
          Y.box.y = Y.Ic;
          Y.box.w = Y.wd - Y.Hc;
          Y.box.o = Y.xd - Y.Ic;
    ...
    function u(B) {
      return { Hc: Number.MAX_VALUE, wd: Number.MIN_VALUE, Ic: Number.MAX_VALUE, xd: Number.MIN_VALUE, box: B };
    }
    var t = a.options, n, k, r, y, v, w, z, E, D, G, O = { We: function(B, M) {
      M.scale = l(B);
      return false;
    }, Ib: function(B, M) {
      B = l(B);
  ...
  function bb(a) {
    function q(c) {
      ...
      var h = a.options, f = h.Ui, u = h.Vi, t = h.Ri, n = h.Si, k = h.Ti, r = h.Od, y = f + u + t + n + k, v = 0 < y ? r / y : 0, w = [];
      ...
      if (c.m && c.R) {
        Va.u(c, Va.i(c, a.options.Qd), function(D, G, O) {
          ...
          G = g.K.A(D).wait(O * v * f).fa({ duration: v * u, P: { ra: { end: 1, easing: La.ia(h.Qi) } }, ba: function() {
            this.N = true;
            a.j.D("foamtree:dirty", 0 < v);
          } }).done();
          O = g.K.A(D).wait(p ? v * (t + O * n) : 0).fa({ duration: p ? v * k : 0, P: { yb: { end: 1, easing: La.Ab } }, ba: function() {
            this.N = true;
            a.j.D("foamtree:dirty", 0 < v);
          } }).done();
          D = g.K.A(D).Qa([G, O]).Xd().Xa(function() {
            this.vd();
            this.cc();
            this.Nc(m);
            this.Mc(b);
    ...
    var m = new function() {
      ...
      this.Ib = function(n, k) {
        var r = c + b * n.ra, y = n.parent, v = t * n.x + (1 - t) * y.x, w = t * n.y + (1 - t) * y.y;
        k.translate(v, w);
        k.scale(r, r);
        n = 1 - n.ra;
      ...
      this.Jb = function(n, k, r) {
        var y = c + b * n.ra, v = t * n.x + (1 - t) * n.parent.x, w = t * n.y + (1 - t) * n.parent.y, z = 1 - n.ra;
        n = n.parent;
    ...
    this.u = function() {
      ...
      var h = a.options, f = h.Gd, u = h.li, t = h.mi, n = h.ni, k = h.hi, r = h.ii, y = h.ji, v = h.di, w = h.ei, z = h.fi, E = k + r + y + v + w + z + u + t + n, D = 0 < E ? f / E : 0, G = [];
      d.initial() ? m.i(h.si, h.pi, h.ti, h.ui, h.oi) : m.i(h.Nf, h.Mf, h.Of, h.Pf, h.Lf);
      Va.u(l, Va.i(l, a.options.ri), function(O, H, B) {
        var M = "groups" === a.options.ki ? B : H;
        G.push(g.K.A(O).call(function() {
          this.qb(c);
        }).wait(p ? D * (k + M * r) : 0).fa({ duration: p ? D * y : 0, P: { yb: { end: 0, easing: La.Ab } }, ba: function() {
          this.N = true;
          a.j.D("foamtree:dirty", true);
        } }).done());
        Ra.L(O, function(Q) {
          G.push(g.K.A(Q).call(function() {
            this.mc(m);
            this.qb(b);
          }).wait(D * (v + w * M)).fa({ duration: D * z, P: { Hd: { end: 0, easing: La.Ab } }, ba: function() {
            this.N = true;
            a.j.D("foamtree:dirty", true);
          } }).Xa(function() {
            this.selected = false;
        ...
        G.push(g.K.A(O).call(function() {
          this.mc(m);
        }).wait(D * (u + t * M)).fa({ duration: D * n, P: { ra: { end: 0, easing: La.ia(h.gi) } }, ba: function() {
          this.N = true;
          a.j.D("foamtree:dirty", true);
        } }).Xa(function() {
          this.selected = false;
  ...
  function cb(a) {
    function q(c, b) {
      ...
      Ra.L(p, function(u) {
        if (u.m) {
          var t = P.has(c, u.id);
          u.open !== t && (t || u.U || Ra.L(u, function(n) {
            if (n.U) return h.push(u), false;
          }));
        }
      });
      ...
      b = d.Vb({ m: h, Ca: true, Ba: true }, b, true, true);
    ...
    function l(c, b, h) {
      function f(k, r) {
        k.qb(u);
        var y = e.K.A(k).fa({ duration: a.options.Kc, P: { Cb: { end: r ? 1 : 0, easing: La.fe } }, ba: function() {
          this.N = true;
          a.j.D("foamtree:dirty", true);
        } }).call(function() {
          this.open = r;
      ...
      Ra.L(p, function(k) {
        if (k.R && k.X) {
          var r = P.has(c, k.id), y = g[k.id];
          if (y && y.xb()) y.stop();
          else if (k.open === r) return;
          k.Va = r;
          r || (k.open = r, k.Bd = false);
          n.push(k);
          t.push(f(k, r));
        }
      });
      return 0 < t.length ? (a.j.D("openclose:changing"), e.K.A({}).Qa(t).Ta().then(function() {
        m.bd(b, n, "open", function(k) {
          return k.open;
        }, { indirect: h }, a.options.sf, a.options.rf);
  ...
  function db(a) {
    function q(e, d) {
      ...
      0 < c.length && a.j.D("foamtree:dirty", false);
      g.bd(d, c, "selected", function(b) {
        return b.selected;
      }, {}, a.options.uf, a.options.tf);
    }
    var l, g;
  ...
  function eb(a) {
    function q(N) {
      return function(S) {
        N.call(this, { x: S.x, y: S.y, scale: S.scale, ed: S.delta, ctrlKey: S.ctrlKey, metaKey: S.metaKey, altKey: S.altKey, shiftKey: S.shiftKey, lb: S.secondary, touches: S.touches });
      };
    }
    function l() {
      function N(S) {
      ...
      "external" !== f.Ne && ("hammerjs" === f.Ne && P.has(window, "Hammer") && (ba.M(u), ba.A("tap", N(h.i), true), ba.A("doubletap", N(h.u), true), ba.A("hold", N(h.sa), true), ba.A("touch", N(h.ua), true), ba.A(
        "release",
        N(h.wa),
        false
      ), ba.A("dragstart", N(h.ga), true), ba.A("drag", N(h.H), true), ba.A("dragend", N(h.T), true), ba.A("transformstart", N(h.pb), true), ba.A("transform", N(h.transform), true), ba.A("transformend", N(h.Ka), true)), Q = new Ka(u), X = new Ja(), Q.i(N(h.i)), Q.u(N(h.u)), Q.sa(N(h.sa)), Q.wa(N(h.ua)), Q.Ka(N(h.wa)), Q.ga(N(h.ga)), Q.H(N(h.H)), Q.T(N(h.T)), Q.ta(N(h.ta)), Q.Ja(N(h.ta)), Q.ua(N(h.Ja)), X.addEventListener("keyup", function(S) {
        var ca = false, I = void 0, T = f.yf({ keyCode: S.keyCode, preventDefault: function() {
          ca = true;
        ...
        (ca = ca || 0 <= T.indexOf(false)) || 27 === S.keyCode && a.j.D("interaction:reset");
      }));
    }
    function g() {
    ...
    function d(N, S, ca) {
      ...
      return function(R) {
        ...
        var fa = false, x = !V.empty(), A = t.absolute(R, I), F = (S || x) && m(A), L = (S || x) && c(A);
        x && (x = F ? F.group : null, A = F ? F.Jb(A, T) : A, R.Db = void 0, V = V({
          type: N,
          group: x,
        ...
        }), fa = fa || 0 <= V.indexOf(false), F && F.attribution && "click" === N && (fa = false));
    ...
    function p(N) {
      function S(fa, x) {
        ...
        if (A) {
          for (var F = -Number.MAX_VALUE, L, K = 0; K < A.length; K++) {
            var J = A[K];
            !J.description && J.Y && ja(J, fa) && J.scale > F && (L = J, F = J.scale);
          }
          var W;
          L && (W = S(fa, L));
          return W || L || x;
      ...
      for (var ca = C.length, I = C[0].scale, T = C[0].scale, R = 0; R < ca; R++) {
        var V = C[R];
        V = V.scale;
        V < I && (I = V);
        V > T && (T = V);
      ...
      if (I !== T) {
        for (R = 0; R < ca; R++) if (V = C[R], V.scale === T && V.Y && ja(V, N)) return S(N, V);
      }
      return S(N, w);
    }
    function m(N, S) {
      if ("flattened" === f.mb) N = p(N);
        ...
        for (var ca = C.length, I = void 0, T = 0; T < ca; T++) {
          var R = C[T];
          R.scale > S && false === R.open && R.Y && ja(R, N) && (I = R, S = R.scale);
        }
        N = I;
      }
    ...
    function c(N) {
      var S = void 0, ca = 0;
      Ra.sc(w, function(I) {
        true === I.open && I.Y && I.scale > ca && ja(I, N) && (S = I, ca = I.scale);
      });
      return S;
    }
    var b = ea.Nh(), h = this, f = a.options, u, t, n, k, r, y, v, w, z = false, E, D, G, O, H, B, M, Q, X, Y, aa;
    ...
    this.wa = e(d("mouseup", false, void 0));
    this.i = e(d("click", true, function(N, S) {
      S.lb || S.shiftKey || !(N = N.dd) || (N.attribution ? S.ctrlKey ? document.location.href = Pa.Qf("iuuqr;..b`ssnurd`sbi/bnl.gn`lusdd") : (S = La.ia(f.Kb), N.be ? (t.reset(f.ob, S), N.be = false) : (t.cg(N, f.Yb, f.ob, S), N.be = true)) : y.select({ m: [N], Ca: !N.selected, Ba: S.metaKey || S.ctrlKey }, true));
    }));
    this.u = e(d("doubleclick", true, function(N, S) {
      var ca = N.dd;
      ca && ca.attribution || (S.lb || S.shiftKey ? ca && (ca.parent.U && (ca = ca.parent), N = { m: ca.parent !== w ? [ca.parent] : [], Ca: true, Ba: false }, y.select(N, true), k.Vb(N, true, true, false)) : ca && (N = { m: [ca], Ca: true, Ba: false }, ca.Va = true, a.j.D("foamtree:attachChildren", [ca]), k.Vb(N, true, true, false)), ca && n.K.A({}).wait(f.Oa / 2).call(function() {
        r.Bb({ m: Ra.uc(w, function(I) {
          return I.Bd && !Ra.Lh(ca, I);
        }), Ca: false, Ba: true }, true, true);
        ca.Bd = true;
        r.Bb({ m: [ca], Ca: !(S.lb || S.shiftKey), Ba: true }, true, true);
      }).start());
    }));
    this.sa = e(d("hold", true, function(N, S) {
      (N = (S = !(S.metaKey || S.ctrlKey || S.shiftKey) && !S.lb) ? N.dd : N.vg) && N !== w && r.Bb({ m: [N], Ca: S, Ba: true }, true, false);
    }));
    this.ga = e(d("dragstart", false, function(N, S) {
      E = S.x;
      D = S.y;
      G = Date.now();
      z = true;
    }));
    this.H = e(d("drag", false, function(N, S) {
      if (z) {
        N = Date.now();
        B = Math.min(1, N - G);
        G = N;
    ...
    this.T = e(d("dragend", false, function() {
      if (z) {
        z = false;
    ...
    this.pb = e(d("transformstart", false, function(N, S) {
      M = 1;
      E = S.x;
      D = S.y;
    }));
    var U = 1, ha = false;
    this.transform = e(d("transform", false, function(N, S) {
      N = S.scale - 0.01;
    ...
    this.Ka = e(d("transformend", false, function() {
      ha && 0.8 > U ? a.j.D("interaction:reset") : g();
      ha = false;
    }));
    this.Ja = e(d("mousewheel", false, function() {
      var N = P.zg(function() {
        g();
      }, 300);
      return function(S, ca) {
        S = f.lj;
        1 !== S && (S = Math.pow(S, ca.ed), b ? (t.rg(ca, S), N()) : t.Nb(ca, S, f.ob, La.ia(f.Kb)).then(g));
      };
    }()));
    this.ta = e(function() {
      var N = void 0, S = {}, ca = false, I, T = d("hover", false, function() {
        N && (N.ub = false, 0 < N.level && (N.N = true));
        I && (I.ub = true, 0 < I.level && (I.N = true));
        v.update(I);
        a.j.D("foamtree:dirty", false);
      }), R = d("mousemove", false, void 0);
      return function(V) {
        if ("out" === V.type) I = void 0, ca = I !== N;
        else if (t.absolute(V, S), N && !N.open && ja(N, S)) {
          var fa = m(S, N.scale);
          fa && fa !== N ? (ca = true, I = fa) : ca = false;
        } else I = m(S), ca = I !== N;
        ca && (T(V), N = I, ca = false);
        N && R(V);
      };
    }());
    this.Lb = { click: q(this.i), doubleclick: q(this.u), hold: q(this.sa), mouseup: q(this.wa), mousedown: q(this.ua), dragstart: q(this.ga), drag: q(this.H), dragend: q(this.T), transformstart: q(this.pb), transform: q(this.transform), transformend: q(this.Ka), hover: q(this.ta), mousewheel: q(this.Ja) };
    var ba = /* @__PURE__ */ function() {
      function N(I, T) {
        return function(R) {
          ...
          I.call(u, V);
          (void 0 === V.Db && T || "prevent" === V.Db) && R.preventDefault();
        };
      }
      var S, ca = {};
      return { M: function(I) {
        S = window.Hammer(I, { doubletap_interval: 350, hold_timeout: 400, doubletap_distance: 10 });
      }, A: function(I, T, R) {
        ca[I] = T;
        S.on(I, N(T, R));
      }, Za: function() {
  ...
  function fb(a) {
    function q(e, d, p, m) {
      ...
      for (c = 1; c < e.length; c++) {
        ...
        var k = (u - 1 + h.length) % h.length, r = 1 - (f - b) / h[k], y = d[k].x;
        k = d[k].y;
        var v = d[u].x, w = d[u].y;
        y = (y - p.x) * n + p.x;
        k = (k - p.y) * n + p.y;
    ...
    }, Ob: "box" }, ordered: { vb: function(e, d) {
      e = e.slice(0);
      g.ac && e.sort(gb);
      Wa.i(e, d, false, g.Ld);
    }, Ob: "box" }, squarified: { vb: function(e, d) {
      e = e.slice(0);
      g.ac && e.sort(gb);
      Wa.u(e, d, false, g.Ld);
    }, Ob: "box" }, fisheye: { vb: function(e, d, p) {
      e = e.slice(0);
      g.ac && e.sort(gb);
      q(e, d, p, 0.25);
    }, Ob: "polygon" }, blackhole: { vb: function(e, d, p) {
      e = e.slice(0);
    ...
    this.i = function(e, d, p) {
      if (0 < e.length) {
        ...
        for (p = e.length - 1; 0 <= p; p--) {
          ...
          m.attribution && (c = wa.ta(d, g.$d, g.sg), m.x = c.x, m.y = c.y);
          P.wb(m.group.initialPosition) && (c = m.group.initialPosition, c = wa.ta(d, c.position || "bottomright", c.distanceFromCenter || 1), m.x = c.x, m.y = c.y);
        }
      }
    };
  }
  ;
  function hb(a) {
    var q, l = a.options, g = new ib(a, this), e = new jb(a, this), d = { relaxed: g, ordered: e, squarified: e }, p = d[a.options.Dc] || g;
    this.kg = 5e-5;
    ...
    this.Pe = function(m) {
      return m === q ? true : 2 * Math.sqrt(m.O.ha / (Math.PI * m.m.length)) >= Math.max(l.Ce, 5e-5);
    };
  ...
  function ib(a, q) {
    ...
    function g(n, k) {
      q.Pe(n) && (n.G || (n.G = Ta.i(n.C, f.jd * Math.pow(f.La, n.level - 1)), n.G && n.m[0] && n.m[0].description && "stab" == f.Tb && m(n)), n.G && (b.Eb(n), u.i(e(n), n.G, n.group), n.R = true, k(n)), l(n));
    }
    function e(n) {
      return "stab" === f.Tb && 0 < n.m.length && n.m[0].description ? n.m.slice(1) : n.m;
    }
    function d(n) {
      var k = e(n);
      Ua.i(k, n.G);
    ...
    function m(n) {
      var k = f.Sb / (1 + f.Sb), r = wa.F(n.G, {}), y = { x: r.x, y: 0 }, v = r.y, w = r.o, z = f.ie * Math.pow(f.La, n.level - 1), E = w * f.he, D = f.qc;
      "bottom" == D || 0 <= D && 180 > D ? (D = Math.PI, v += w, w = -1) : (D = 0, w = 1);
      var G = n.G, O = D, H = 0, B = 1, M = wa.u(G, {}), Q = M.ha;
      k *= Q;
      ...
      wa.F(aa[0], r);
      if (r.o < z || r.o > E) y.y = r.o < z ? v + w * Math.min(z, E) : v + w * E, aa = wa.ua(n.G, y, D);
      n.m[0].C = aa[0];
      n.G = aa[1];
    }
    function c(n) {
      n !== h && 2 * Math.sqrt(n.O.ha / (Math.PI * n.m.length)) < Math.max(0.85 * f.Ce, q.kg) && (n.R = false, n.xa = false, n.Ia = true, n.G = null);
    }
    ...
    this.step = function(n, k, r, y) {
      function v(G) {
        G.R && G.xa ? c(G) : G.Ia && G.C && g(G, function() {
          var H = e(G);
          Ua.i(H, G.G);
          Ua.u(H, G.G);
          n(G);
    ...
    this.Eb = function(n) {
      for (var k = e(n), r = n.ha, y, v = y = 0; v < k.length; v++) y += k[v].weight;
      n.Gj = y;
      for (n = 0; n < k.length; n++) v = k[n], v.Wf = v.w, v.hc = r / Math.PI * (0 < y ? v.weight / y : 1 / k.length);
    };
  }
  ;
  function jb(a, q) {
    function l(b, h) {
      if (q.Pe(b)) {
        ...
        b.G && (b.R = true, h(b));
      } else b.R = false, Ra.za(b, function(u) {
        u.G = null;
      });
    }
    function g(b) {
      function h(t) {
        ...
        var k = m.Sb / (1 + m.Sb), r = t.m[0], y = wa.F(t.G, {}), v = y.o;
        k = Math.min(Math.max(v * k, m.ie * Math.pow(m.La, t.level - 1)), v * m.he);
        var w = m.qc;
        "bottom" == w || 0 <= w && 180 > w ? (y.o = v - k, t.G = wa.H(y), y.y += v - k, y.o = k, n()) : (y.o = k, n(), y.y += k, y.o = v - k, t.G = wa.H(y));
      }
      ...
      m.ac && f.sort(gb);
      "floating" == m.Tb && d(f, m.qc, function(t) {
    ...
    var p, m = a.options, c = { squarified: Wa.u, ordered: Wa.i };
  ...
  function lb(a, q) {
    ...
    function g(x, A, F, L) {
      ...
      X.rc([F, G], function(W) {
        ...
        if (null !== x) {
          ...
          for (Z = x.length - 1; 0 <= Z; Z--) {
            var ia = x[Z], la = ia.C;
            la && (F.save(), F.beginPath(), ia.Ib(F), ya.Ud(F, la), F.fill(), ia = C.$a * Math.pow(C.La, ia.level - 1), 0 < ia && (F.lineWidth = ia / 2, F.stroke()), F.restore());
          }
          F.restore();
        }
        W = W.scale;
        if (0 !== A.length) {
          ...
          for (ia = I.length - 1; 0 <= ia; ia--) if (la = I[ia], Z[la.id]) {
            ...
            for (la = 0; la < A.length; la++) {
              var oa = A[la];
              !oa.parent || oa.parent.xa && oa.parent.R ? qa(oa, W) : oa.aa.clear();
            }
          }
        }
      ...
      C.Zc && (F.canvas.style.opacity = 0.99, setTimeout(function() {
        F.canvas.style.opacity = 1;
      }, 1));
    }
    function e(x) {
      k === y ? x < 0.9 * u && (k = r, w = z, c()) : x >= u && (k = y, w = E, c());
    }
    function d() {
      function x(K, J, W) {
      ...
      X.rc([], function(K) {
        ...
        Ra.fd(U, function(da) {
          da.parent && da.parent.Z && (da.aa.clear(), da.Ma = true, W || (da.oc = true, da.Qb.clear()));
          W && (da.oc = true, da.Qb.clear());
        });
        ...
        if (p()) A = L, F = null;
          ...
          var ia = {}, la = {}, qa = "none" != C.ld && C.$a < C.ab / 2, oa = C.$a < C.yc / 2 + C.kd * C.Ee.a;
          Ra.L(U, function(da) {
            if (da.W && !da.description && (da.Z || da.N || da.Fc && da.parent.X && da.Ma)) {
              var ma, sa, ua = [da], va = da.J || da.parent.m;
              if (qa) for (ma = 0; ma < va.length; ma++) (sa = va[ma]) && ua.push(sa);
      ...
      (function() {
        var K = false;
        C.Hf && Ra.L(U, function(J) {
          if (J.W && 0 !== J.pa.a && 1 !== J.pa.a) return K = true, false;
        });
        K ? (Ra.sc(U, function(J) {
          if (J.W && (J.opacity !== J.Jc || J.Fa)) {
            var W = J.m;
            if (W) {
              for (var Z = 0, ia = W.length - 1; 0 <= ia; ia--) Z = Math.max(Z, W[ia].Ec);
              J.Ec = Z + J.opacity * J.pa.a;
            } else J.Ec = J.opacity * J.pa.a;
          }
        }), Ra.L(U, function(J) {
          if (J.W && (J.opacity !== J.Jc || J.Fa)) {
            for (var W = J.Ec, Z = J; (Z = Z.parent) && Z !== U; ) W += Z.opacity * Z.pa.a * C.Ff;
    ...
    function p() {
      ...
      if (!x && !U.empty()) {
        var A = U.m[0].scale;
        Ra.L(U, function(F) {
          if (F.W && F.Y && F.scale !== A) return x = true, false;
        });
      }
      !x && 0 < C.ye && 1 != C.Pa && Ra.L(U, function(F) {
        if (F.W && 0 < F.ja) return x = true, false;
      });
      "accurate" == C.Le && (x = (x = x || 0 === C.$a) || "none" != C.ld && C.$a < C.ab / 2, !x && C.$a < C.yc / 2 + C.kd * C.Ee.a && Ra.L(U, function(F) {
        if (F.W && (F.selected && !F.Sa || !F.selected && F.Sa)) return x = true, false;
      }));
      return x;
    }
    function m() {
      if (C.B !== C.nb) return true;
      ...
      Ra.L(U, function(L) {
        if (L.W && L.U) return x.push("polygonExposureShadow"), false;
      });
      for (var A = x.length - 1; 0 <= A; A--) {
        var F = x[A];
        if (!!ba[F] !== !!N[F]) return true;
      }
      return false;
    }
    function c() {
      function x(J, W, Z, ia, la) {
        ...
        switch (Z) {
          case "never":
            J.labelPlainFill = false;
            break;
          case "always":
          case "auto":
            J.labelPlainFill = true;
        }
        if (C.xc) switch (ia) {
          case "never":
            J.contentDecoration = false;
            break;
          case "always":
          case "auto":
            J.contentDecoration = true;
        }
        else J.contentDecoration = false;
        var oa = 0;
        ...
        if (oa <= la || (oa = qa(J, oa, 2, "polygonExposureShadow")) <= la || (oa = qa(J, oa, W, "polygonGradientFill", "polygonPlainFill")) <= la || (oa = qa(J, oa, W, "polygonGradientStroke")) <= la || (oa = qa(J, oa, W, "polygonPlainStroke")) <= la || "auto" === ia && (oa = qa(J, oa, W, "contentDecoration")) <= la) return J;
    ...
    function b(x) {
      return function(A, F) {
        return A === k ? true === ba[x] : true === (F ? N : ja)[x];
      };
    }
    function h(x, A) {
      return function(F, L) {
    ...
    function f(x) {
      ...
      Ra.fd(U, function(A) {
        if (A.W && A.X && A.xa && A.R && (U.N || A.Z || A.Vd)) {
          A.Vd = false;
          var F = A.m, L = { x: 0, y: 0, w: 0, o: 0 }, K = !!A.G;
          if (1 < O / x.w) {
            var J;
            for (J = F.length - 1; 0 <= J; J--) F[J].Y = false;
            if (A.Y && K) {
              for (J = F.length - 1; 0 <= J; J--) if (A = F[J], 1 !== A.scale && (A.Jb(x, L), L.w = x.w / A.scale, L.o = x.o / A.scale), false === A.Y && A.C) {
                K = A.C;
                var W = K.length;
                if (wa.sa(A.C, 1 === A.scale ? x : L)) A.Y = true;
                else for (var Z = 0; Z < W; Z++) if (wa.Vc(K[Z], K[(Z + 1) % W], 1 === A.scale ? x : L)) {
                  A.Y = true;
                  A.J && (A = A.J[Z]) && (F[A.index].Y = true);
                  break;
                }
              }
            }
    ...
    var u = ea.Te() ? 50 : 1e4, t, n, k, r, y, v, w, z, E, D, G, O, H, B, M = new mb(a), Q = new nb(a), X, Y, aa, C = a.options, U, ha, ba, ja, N;
    a.j.subscribe("stage:initialized", function(x, A, F, L) {
      B = x;
      O = F;
      H = L;
      n = B.dc("wireframe", C.nb, false);
      r = n.getContext("2d");
      y = new xa(r);
      v = B.dc("hifi", C.B, false);
      z = v.getContext("2d");
      E = new xa(z);
      k = r;
      w = z;
      ...
      z.B = C.B;
      E.B = C.B;
      D = B.dc("tmp", Math.max(C.B, C.nb), true);
      G = D.getContext("2d");
      G.B = 1;
    ...
    a.j.subscribe("model:loaded", function(x) {
      function A(F) {
        var L = 0;
        if (!F.empty()) {
          for (var K = F.m, J = K.length - 1; 0 <= J; J--) L = Math.max(L, A(K[J]));
          L += 1;
        }
        return F.Tf = L;
      }
    ...
    var S = "groupFillType groupStrokeType wireframeDrawMaxDuration wireframeLabelDrawing wireframeContentDecorationDrawing finalCompleteDrawMaxDuration finalIncrementalDrawMaxDuration groupContentDecorator".split(" "), ca = [
    ...
    a.j.subscribe("options:changed", function(x) {
      ...
      x.dataObject || (P.bb(x, S) && c(), P.bb(x, ca) && Ra.L(U, function(L) {
        L.hd = -1;
      }));
      var F = P.has(x, "pixelRatio");
      x = P.has(x, "wireframePixelRatio");
      if (F || x) F && A(v, w, C.B, true), x && A(n, k, C.nb, true), A(D, G, Math.max(C.B, C.nb), false);
    });
    ...
    var I = [{ id: "offsetPolygon", Kd: function(x) {
      if ((x.selected || 0 < x.opacity && false === x.open || !x.X) && x.aa.Ga()) {
        var A = x.aa;
        A.clear();
        if (x.$) {
          var F = x.$, L = C.Ig;
          0 < L ? ya.Wi(A, F, x.parent.O.r / 32, Math.min(1, L * Math.pow(1 - C.Jg * L, x.Tf))) : ya.Ud(A, F);
        }
        x.Dd = true;
      }
    } }, { id: "label", Kd: function(x) {
      x.Ma && x.Fc && M.u(x);
    } }, { id: "custom", Kd: function(x, A) {
      if (x.$ && (0 < x.opacity && (false === x.open || true === x.selected) || !x.X) && x.oc && a.options.xc && !x.attribution) {
        var F = {};
        aa.Xc(F, x);
        aa.Yc(F, x);
        aa.Wc(F, x, true);
        ...
        F.shapeDirty = x.Dd;
        F.viewportScale = A;
        A = { groupLabelDrawn: true, groupPolygonDrawn: true };
      ...
      this.Nd = function(F, L, K) {
        if (0 !== F.length) {
          ...
          for (var la = Z = 0; la < W.length; la++) {
            for (var qa = W[la], oa = x.length - 1; 0 <= oa; oa--) if (A[oa]) {
              var da = x[oa];
              L.save();
              for (J = Z; J < qa; J++) ia = F[J], L.save(), ia.Ib(L), da.kb.call(da, ia, L, K), L.restore();
              da.Wa.call(da, L, K);
              L.restore();
            }
            Z = qa;
      ...
      this.na = function(F, L) {
        for (var K = false, J = x.length - 1; 0 <= J; J--) A[J] = x[J].na(F, L), K |= A[J];
        return K;
      };
      this.before = function(F, L) {
        for (var K = x.length - 1; 0 <= K; K--) if (A[K]) {
          var J = x[K];
          J.before.call(J, F, L);
        }
      };
      this.after = function(F) {
        for (var L = x.length - 1; 0 <= L; L--) if (A[L]) {
          var K = x[L];
          K.after.call(K, F);
        }
      };
      this.og = function(F) {
        for (var L = x.length - 1; 0 <= L; L--) {
          var K = x[L];
          if (A[L]) for (var J = K.Ra.length - 1; 0 <= J; J--) F[K.Ra[J]] = true;
        }
      };
    }([
      {
        ...
        Wa: function(x) {
          this.Sf && (this.Sf = false, x.save(), x.setTransform(1, 0, 0, 1, 0, 0), x.drawImage(D, 0, 0, x.canvas.width, x.canvas.height, 0, 0, x.canvas.width, x.canvas.height), x.restore(), G.save(), G.setTransform(1, 0, 0, 1, 0, 0), G.clearRect(0, 0, D.width, D.height), G.restore());
        },
        kb: function(x, A, F) {
          if (!(x.open && x.X || x.aa.Ga())) {
            var L = C.ye * x.opacity * x.ja * ("flattened" === C.mb ? 1 - x.parent.ja : (1 - x.Cb) * x.parent.Cb) * (1.1 <= C.Pa ? 1 : (C.Pa - 1) / 0.1);
            0 < L && (G.save(), G.beginPath(), x.Ib(G), x.aa.Na(G), G.shadowBlur = F * A.B * L, G.shadowColor = C.Og, G.fillStyle = "rgba(0, 0, 0, 1)", G.globalCompositeOperation = "source-over", G.globalAlpha = x.opacity, G.fill(), G.shadowBlur = 0, G.shadowColor = "transparent", G.globalCompositeOperation = "destination-out", G.fill(), G.restore(), this.Sf = true);
          }
        }
      },
      { Ra: ["offsetPolygon"], na: function() {
        return true;
      }, before: function() {
        function x(K) {
          var J = K.pa, W = K.ub, Z = K.selected, ia = (J.h + (W ? C.$g : 0) + (Z ? C.rh : 0)) % 360, la = A(J.l * K.va + (W ? C.ah : 0) + (Z ? C.sh : 0));
        ...
        var F = [{ type: "fill", na: b("polygonPlainFill"), Pc: function(K, J) {
          J.fillStyle = Ea.H(x(K));
        } }, { type: "fill", na: b("polygonGradientFill"), Pc: function(K, J) {
          var W = K.O.r, Z = x(K);
          W = J.createRadialGradient(K.x, K.y, 0, K.x, K.y, W * C.Sg);
          var ia = Z.l, la = C.Qg;
          W.addColorStop(0, Ea.i((Z.h + C.Pg) % 360, A(Z.s + C.Rg), A(ia + la)));
          ia = Z.l;
          la = C.Ug;
          W.addColorStop(1, Ea.i((Z.h + C.Tg) % 360, A(Z.s + C.Vg), A(ia + la)));
          K.aa.Na(J);
          J.fillStyle = W;
        } }, { type: "stroke", na: h(b("polygonPlainStroke"), function() {
          return 0 < C.ab;
        }), Pc: function(K, J) {
          var W = K.pa, Z = K.ub, ia = K.selected, la = (W.h + C.Ie + (Z ? C.ze : 0) + (ia ? C.Fe : 0)) % 360, qa = A(W.s * K.saturation + C.Ke + (Z ? C.Be : 0) + (ia ? C.He : 0));
          W = A(W.l * K.va + C.Je + (Z ? C.Ae : 0) + (ia ? C.Ge : 0));
          J.strokeStyle = Ea.i(la, qa, W);
          J.lineWidth = C.ab * Math.pow(C.La, K.level - 1);
        } }, { type: "stroke", na: h(b("polygonGradientStroke"), function() {
          return 0 < C.ab;
        }), Pc: function(K, J) {
          var W = K.O.r * C.zh, Z = K.pa, ia = Math.PI * C.vh / 180;
          W = J.createLinearGradient(K.x + W * Math.cos(ia), K.y + W * Math.sin(ia), K.x + W * Math.cos(ia + Math.PI), K.y + W * Math.sin(ia + Math.PI));
          var la = K.ub, qa = K.selected;
          ia = (Z.h + C.Ie + (la ? C.ze : 0) + (qa ? C.Fe : 0)) % 360;
          var oa = A(Z.s * K.saturation + C.Ke + (la ? C.Be : 0) + (qa ? C.He : 0));
          Z = A(Z.l * K.va + C.Je + (la ? C.Ae : 0) + (qa ? C.Ge : 0));
          la = C.xh;
          W.addColorStop(0, Ea.i((ia + C.wh) % 360, A(oa + C.yh), A(Z + la)));
          la = C.Bh;
          W.addColorStop(1, Ea.i((ia + C.Ah) % 360, A(oa + C.Ch), A(Z + la)));
          J.strokeStyle = W;
          J.lineWidth = C.ab * Math.pow(C.La, K.level - 1);
        } }], L = Array(F.length);
        return function(K, J) {
        ...
        if (!(!x.Ed || (0 === x.opacity || x.open) && x.X || x.aa.Ga() || !C.je && x.description)) {
          var F = this.$i, L = this.wg;
          A.beginPath();
          x.aa.Na(A);
          for (var K = false, J = false, W = F.length - 1; 0 <= W; W--) {
            var Z = F[W];
            if (L[W]) switch (Z.Pc(x, A), Z.type) {
              case "fill":
                K = true;
                break;
              case "stroke":
          ...
          }, 0) / x.m.length * (1 - C.Ff) : 1, A.globalAlpha = F * x * W, ob(A));
          J && (A.globalAlpha = F * (L ? C.$h : 1) * W, A.closePath(), pb(A), A.stroke());
        }
      } },
      { Ra: ["offsetPolygon"], na: function() {
        return 0 < C.yc;
        ...
        if (x.Ed && x.selected && !x.aa.Ga()) {
          ...
          A.strokeStyle = C.uh;
          var K = C.kd;
          0 < K && (A.shadowBlur = K * L * F * A.B, A.shadowColor = C.De);
          x.aa.Na(A);
          A.closePath();
          A.stroke();
        }
      ...
      { Ra: [], na: function() {
      ...
      }, Rh: kb, kb: function(x, A) {
        function F(K, J, W) {
          var Z = wa.Ka(x.$, x.O, K / J);
          Z = Math.min(Math.min(0.9 * Z, 0.5 * x.F.o) / J, 0.5 * x.F.w / K);
          A.save();
          A.translate(x.x, x.y);
        ...
        var L = this.Rh;
        x.attribution && !x.aa.Ga() && F(L.ke.width, L.ke.height, function(K) {
          L.Hg(K, C.ae);
        });
      } },
      { Ra: [], na: /* @__PURE__ */ function(x, A) {
        return function(F, L) {
          return x(F, L) || A(F, L);
        };
      }(
        ...
        (0 < x.opacity && 0 < x.ca && !x.open || !x.X) && !x.aa.Ga() && (x.Cc = x.oa && x.oa.ka && C.B * x.oa.fontSize * x.scale * F >= C.oh, "auto" === x.pd ? !C.je && x.description ? x.fb = x.parent.fb : (F = x.xe, A = F.h + (F.s << 9) + (F.l << 16), x.hd !== A && (F = Ea.T(F), x.fb = F > (0 > x.ja ? C.Dh : C.dh) ? C.eh : C.nh, x.hd = A)) : x.fb = x.pd);
      } },
      {
        Ra: ["custom"],
        ...
        kb: function(x, A) {
          !(0 < x.opacity && 0 < x.ca && !x.open || !x.X) || x.Qb.Ga() || x.aa.Ga() || (x.Cc || void 0 === x.oa ? (A.globalAlpha = x.ca * (x.X ? x.opacity : 1) * (x.empty() ? 1 : C.Gf), A.fillStyle = x.fb, A.strokeStyle = x.fb, x.Qb.Na(A)) : l(x, A));
        }
      },
      { Ra: ["label"], na: b("labelPlainFill"), before: function() {
      }, after: function() {
      }, rb: function() {
      }, Wa: function() {
      }, kb: function(x, A, F) {
        x.Ue && x.Fc && (0 < x.opacity && 0 < x.ca && !x.open || !x.X) && !x.aa.Ga() && x.oa && (A.fillStyle = x.fb, A.globalAlpha = x.ca * (x.X ? x.opacity : 1) * (x.empty() ? 1 : C.Gf), x.Cc ? qb(x, A, F) : l(x, A));
      } }
    ].reverse())];
    this.M = function() {
      t = Ma.Jh(function() {
    ...
    var R = false, V = void 0;
    this.u = function(x) {
      R ? V = x : x();
    };
    this.Nd = /* @__PURE__ */ function() {
      function x() {
      ...
      return function(L) {
        tb(Q);
        F = d();
        var K = null !== F.ag, J = 0 < B.$b("hifi"), W = J && (K || !L);
        L = K || ha || !L;
        ha = false;
        J && !W && fa.Yi();
        g(F.ag, F.bg, W ? w : k, L);
    ...
    this.i = function(x) {
      ...
      try {
        ...
        C.B = L;
        var K = B.dc("export", L, true), J = K.getContext("2d");
        k === y && (J = new xa(J));
        J.scale(L, L);
        var W = P.has(x, "backgroundColor");
        W && (J.save(), J.fillStyle = x.backgroundColor, J.fillRect(0, 0, O, H), J.restore());
        g(W ? [] : null, A.bg, J, true);
      } finally {
        C.B = F;
      }
    ...
    var fa = /* @__PURE__ */ function() {
      function x(L, K, J, W, Z, ia) {
        function la(ma, sa, ua, va) {
          return Y.K.A({ opacity: B.$b(ma) }).fa({ duration: ua, P: { opacity: { end: sa, easing: va } }, ba: function() {
            B.$b(ma, this.opacity);
          } }).done();
        }
        var qa = P.od(B.$b(L), K), oa = P.od(B.$b(W), Z);
        if (!qa || !oa) {
      ...
      var A, F = [];
      return { Yi: function() {
        C.Zc ? 1 !== n.style.opacity && (n.style.visibility = "visible", v.style.visibility = "hidden", n.style.opacity = 1, v.style.opacity = 0) : A && A.xb() || (A = x("wireframe", 1, C.te, "hifi", 0, C.te));
      }, Xi: function() {
        C.Zc ? (v.style.visibility = "visible", n.style.visibility = "hidden", n.style.opacity = 0, v.style.opacity = 1) : x("hifi", 1, C.eg, "wireframe", 0, C.eg);
      } };
    }();
    tb = function(x) {
      x.apply();
  ...
  function mb(a) {
    function q(c) {
      ...
      "undefined" !== typeof c.groupLabelHorizontalPadding && (g.cb = c.groupLabelHorizontalPadding);
      "undefined" !== typeof c.groupLabelVerticalPadding && (g.Ua = c.groupLabelVerticalPadding);
      "undefined" !== typeof c.groupLabelMaxTotalHeight && (g.ib = c.groupLabelMaxTotalHeight);
      "undefined" !== typeof c.groupLabelMaxFontSize && (g.hb = c.groupLabelMaxFontSize);
    }
    ...
    this.i = function(c) {
      if (!c.$) return false;
      var b = c.group.label;
      l.gh && !c.attribution && (p.labelText = b, d.nc(l.fh, c, p), b = p.labelText);
      c.Ve = b;
      return c.qd !== b;
    };
    this.u = function(c) {
      ...
      c.Bc.clear();
      c.oa = void 0;
      if (c.$ && !P.Oe(b) && ("flattened" !== l.mb || c.empty() || !c.R || !c.m[0].W)) {
        var h = ta, f = h.de;
        if (l.mh) {
        ...
        c.oa = f.call(h, u, c.Bc, b, c.$, c.F, c.O, false, false, c.Oh, c.O.ha, l.ph, c.Ma);
      }
      c.Ma = false;
    };
  ...
  function nb(a) {
    function q(b, h) {
      var f = b.m, u = f.length, t, n = m.O.r;
      for (t = 0; t < u; t++) {
        var k = f[t];
    ...
    this.apply = function() {
      function b(z) {
        if (z.R && z.xa) {
          var E = z.m, D;
          if (z.Z || z.Fa || y) {
            0 === z.level ? u(z, d.zi * Math.PI / 180) : t(z, d.Di * Math.PI / 180);
            for (D = E.length - 1; 0 <= D; D--) {
              ...
              if (0 === z.level) {
                ...
                var Q = (1 + (0 > G.ja ? v * (G.ja + 1) : v) * (1 - G.wc)) * g(O, n, k, "l");
                var X = g(O, n, k, "a");
              } else Q = z.pa, B = Q.h, M = Q.s, Q = h(Q.l, O, d.Ei, d.Fi), X = z.we.a;
              H.h = B;
              H.s = M;
              H.l = Q;
              H.a = X;
              B = G.pa;
              G.attribution ? (B.h = 0, B.s = 0, B.l = "light" == d.ae ? 90 : 10, B.a = 1) : (B.h = H.h, B.s = H.s, B.l = H.l, B.a = H.a);
              y && !G.attribution && (c.groupColor = B, c.labelColor = "auto", p.nc(r, G, c, function(Y) {
                Y.ratio = O;
              }), G.pa = Ea.u(c.groupColor), G.pa.a = P.has(c.groupColor, "a") ? c.groupColor.a : 1, "auto" !== c.labelColor && (G.pd = Ea.wa(c.labelColor)));
            }
            z.Fa = false;
          }
      ...
      var u = e[d.yi] || q, t = l, n = d.Ii, k = d.Bi, r = d.Kg, y = d.Lg, v = d.Ci, w = d.Gi;
      b(m);
    };
    return this;
  }
  ;
  function Za() {
    this.kc = this.Yd = this.hc = this.Wf = this.w = this.dg = this.weight = this.y = this.x = this.id = 0;
    ...
    this.Fd = this.G = null;
    this.Fc = this.W = this.Sa = this.oc = this.Vd = this.Dd = this.Ma = this.Fa = this.N = this.Z = this.Ea = this.xa = this.R = this.Ia = false;
    this.saturation = this.va = this.Da = this.ca = this.opacity = this.scale = 1;
    this.ra = 0;
    this.Hd = 1;
    this.Cb = this.ja = this.yb = 0;
    this.description = this.selected = this.ub = this.Bd = this.open = this.U = false;
    this.sb = 0;
    this.Ue = this.Ed = this.X = true;
    this.oa = void 0;
    this.Cc = false;
    this.Bc = new ra();
    this.aa = new ra();
    ...
    this.vd = function() {
      var e = false;
      this.scale = 1;
      for (var d = 0; d < a.length; d++) e = a[d].We(this, q) || e, this.scale *= q.scale;
      return e;
    };
    this.Ib = function(e) {
    ...
    this.cc = function() {
      if (0 !== l.length) {
        ...
        for (var e = l.length - 1; 0 <= e; e--) (0, l[e])(this, g), this.opacity *= g.opacity, this.va *= g.va, this.saturation *= g.saturation, this.ca *= g.ca, this.Da *= g.Da;
      }
    };
  }
  function gb(a, q) {
  ...
  function ub(a) {
    ...
    this.update = function(b) {
      ...
      if (b) {
        ...
        var h = p.ej, f = p.dj, u = Math.min(d / 2, p.Wd + 2 * h), t = u - 2 * h, n = e - 2 * f;
        if (!(0 >= t || 0 >= n)) {
          var k = b.Cc ? b.oa.fontSize * b.scale * c.scale() : 0, r = { titleBarText: b.qd, titleBarTextColor: p.$f, titleBarBackgroundColor: p.Zf, titleBarMaxFontSize: p.Wd, titleBarShown: k < p.Vh };
          if (b.attribution) var y = Pa.Qf("B`ssnu!Rd`sbi!Gn`lUsdd!whrt`mh{`uhno/!Busm,bmhbj!uid!mnfn!un!fn!un!iuuqr;..b`ssnurd`sbi/bnl.gn`lusdd!gns!lnsd!edu`hmr/");
          else m.nc(p.aj, b, r, function(v) {
            v.titleBarWidth = n;
            v.titleBarHeight = t;
            v.labelFontSize = k;
            v.viewportScale = c.scale();
          }), y = r.titleBarText;
          y && 0 !== y.length && r.titleBarShown && (b = c.Uc(b.transformPoint(b, {}), {}).y > d / 2, h = { x: f, y: b ? h : d - u + h, w: n, o: t }, f = wa.H(h), g.fillStyle = p.Zf, g.fillRect(0, b ? 0 : d - u, e, u), g.fillStyle = p.$f, ta.se({ fontFamily: p.bj || p.hh, fontStyle: p.Dj || p.ih, fontWeight: p.Fj || p.kh, fontVariant: p.Ej || p.jh, hb: p.Wd, Gc: p.cj, cb: 0, Ua: 0, ib: 1 }, g, y, f, h, { x: h.x + h.w / 2, y: h.y + h.o / 2 }, true, true).ka || g.clearRect(0, 0, e, d));
        }
      }
    };
  }
  ...
  function vb(a) {
    ...
    function e() {
      if (1 === b.ratio) {
        ...
        0 !== v && (f.Id = v, h = r.K.jc(f).fa({ duration: 500, P: { x: { start: v, end: 0, easing: La.Gb } }, ba: function() {
          c.i(f.x - f.Id, 0);
          l(1);
          f.Id = f.x;
        } }).start());
    ...
    function d() {
      if (1 === b.ratio) {
        ...
        0 !== v && (t.Jd = v, u = r.K.jc(t).fa({ duration: 500, P: { y: { start: v, end: 0, easing: La.Gb } }, ba: function() {
          c.i(0, t.y - t.Jd);
          l(1);
          t.Jd = t.y;
        } }).start());
    ...
    function p(v, w, z) {
      return v ? r.K.jc(b).fa({ duration: void 0 === w ? 700 : w, P: { ratio: { start: 0, end: 1, easing: z || La.Vf } }, ba: function() {
        l(b.ratio);
    ...
    var c = new Da(a), b = { ratio: 1 }, h, f = { le: 0, x: 0, Id: 0 }, u, t = { me: 0, y: 0, Jd: 0 }, n = this, k, r, y = false;
    a.j.subscribe(
      "model:loaded",
      function(v) {
        k = v;
    ...
    this.Yh = m(function(v, w, z) {
      1 === b.ratio && (h = r.K.jc(f).fa({ duration: v / 0.03, P: { le: { start: w, end: 0, easing: La.Gb } }, ba: function() {
        c.i(f.le, 0) && l(1);
        e();
      } }).start(), u = r.K.jc(t).fa({ duration: v / 0.03, P: { me: { start: z, end: 0, easing: La.Gb } }, ba: function() {
        g(0, t.me) && l(1);
        d();
      } }).start());
    });
  ...
  function wb(a, q, l) {
    ...
    function e(I, T) {
      var R = f.options, V = R.Pi, fa = R.Oi;
      R = R.Od;
      var x = 0 < V + fa ? R : 0, A = [];
      Va.u(I, Va.i(I, f.options.Qd), function(F, L, K) {
        L = "groups" === f.options.Pd ? K : L;
        F.m && (F = n.K.A(F).wait(x * (fa + V * L)).call(T).done(), A.push(F));
      });
    ...
    function p(I) {
      function T(A, F) {
        ...
        A.W = F <= R;
        A.Fc = F <= V;
        A.W !== L && Ra.ne(A, function(K) {
          K.Vd = true;
        });
        A.open || A.Va || F++;
        if (A = A.m) for (L = 0; L < A.length; L++) T(A[L], F);
      }
      var R = f.options.Xe, V = Math.min(f.options.Xe, f.options.Sh);
      if (I) for (var fa = 0; fa < I.length; fa++) {
        var x = I[fa];
        T(x, b(x));
      }
      else T(u, 0);
    ...
    function c(I, T) {
      function R(L, K) {
        ...
        L.open || L.Va || K++;
        var W = L.m;
        !W && J && (fa = w.T(L) || fa, W = L.m, F && (L.Ma = true));
        if (W) for (L = 0; L < W.length; L++) A.push(W[L], K);
      }
      var V = T || f.options.Th, fa = false, x = false, A, F = "flattened" === q.mb;
      for (I ? A = I.reduce(function(L, K) {
        L.push(K, 1);
        return L;
      }, []) : A = [u, 1]; 0 < A.length; ) R(A.shift(), A.shift());
      return { Wh: fa, Ji: x };
    }
    function b(I) {
    ...
    var h = this, f = { j: new Oa(), options: q, Cd: l }, u, t = new na(), n = new Qa(t), k = ka.create(), r = new Ba(f), y = new vb(f), v = new Xa(f), w = new Ya(f.options), z = new hb(f), E = new lb(f, t), D = new eb(f);
    new ub(f);
    var G = new ab(f), O = new bb(f), H = new cb(f), B = new db(f);
    ...
    this.jg = function(I, T) {
      P.defer(function() {
        if (X) C.Ph(I), X = false;
          ...
          if (T) for (var R = w.u(T), V = R.length - 1; 0 <= V; V--) R[V].N = true;
          else u.N = true;
          d(I);
        }
      });
    ...
    this.T = E.i;
    this.Ja = /* @__PURE__ */ function() {
      var I = {};
      return function(T, R) {
        return (T = w.i(T)) ? v.Wc(I, T, R) : null;
      };
    }();
    this.wa = /* @__PURE__ */ function() {
      var I = { x: 0, y: 0 }, T = { x: 0, y: 0 };
      return function(R, V) {
        return (R = w.i(R)) ? (I.x = V.x, I.y = V.y, R.transformPoint(I, I), y.Uc(I, I), T.x = I.x, T.y = I.y, T) : null;
      };
    }();
    ...
    this.i = function(I) {
      return U.submit(function() {
        return G.Vb(w.H(I, "exposed", false), false, true, false);
      });
    };
    this.pb = function() {
      return g(function(I) {
    ...
    this.u = function(I) {
      return U.submit(function() {
        return H.Bb(w.H(I, "open", true), false, false);
      });
    };
    this.Lb = function() {
      return g(function(I) {
    ...
    this.H = function(I) {
      return U.submit(function() {
        B.select(w.H(I, "selected", true), false);
        return new Fa().resolve().promise();
      });
    };
    this.ng = function(I) {
      return (I = w.i(I)) ? I === u ? y.reset(q.ob, La.ia(q.Kb)) : y.cg(I, q.Yb, q.ob, La.ia(q.Kb)) : new Fa().resolve().promise();
    };
    ...
    this.mg = function() {
      var I = pa;
      return { frames: I.frames, totalTime: I.totalTime, lastFrameTime: I.rd, lastInterFrameTime: I.sd, fps: I.ve };
    };
    var C = /* @__PURE__ */ function() {
      function I(fa, x) {
        ...
        R = A;
        V = F;
        (fa = q.Rb && q.Rb.boundary) && 2 < fa.length ? u.C = fa.map(function(L) {
          return { x: A * L.x, y: F * L.y };
        }) : u.C = [{ x: 0, y: 0 }, { x: A, y: 0 }, { x: A, y: F }, {
          x: 0,
          y: F
        }];
        T();
      ...
      var R, V;
      return { Me: I, Ni: function(fa, x, A, F) {
        N.stop();
        var L = A / fa, K = F / x;
        Ra.oe(u, function(J) {
        ...
        I(A, F);
        u.Ea = true;
        z.step(N.eb, true, false, function(J) {
          var W = J.m;
          if (W) {
            z.Eb(J);
        ...
        }) ? d(false) : (z.fc(u), f.options.Md ? (d(false), ja.Kf(), ja.Oc()) : (z.complete(N.eb), u.Fa = true, d(false)));
      }, Ph: function(fa) {
        var x = false;
        u.empty() || (T(), ja.xb() || (x = z.step(N.eb, false, false), d(fa)));
        return x;
      }, gj: function(fa) {
        fa.forEach(function(x) {
          ...
          z.fc(x);
          f.options.Md ? (ja.Kf(), Ra.za(x, function(A) {
            A.empty() || N.grow(A);
          })) : (Ra.za(x, function(A) {
            A.empty() || N.eb(A);
          }), z.complete(N.eb), x.Fa = true, d(false));
        });
      } };
    }(), U = /* @__PURE__ */ function() {
      function I() {
        ...
        f.options.zf(q.Rb);
        F && (f.options.Df(), F.then(function() {
          E.u(function() {
            t.once(f.options.Cf);
          });
        }));
      ...
      function R(F, L) {
        return 0 === q.re || L ? (r.i(F), new Fa().resolve().promise()) : n.K.A({ opacity: r.i() }).Xd(2).fa({ duration: q.re, P: { opacity: { end: F, easing: La.ia(q.Dg) } }, ba: function() {
          r.i(this.opacity);
        } }).Ta();
      }
      function V() {
        ...
        var F = new Fa(), L = new Ha(F.resolve);
        L.i();
        u.xa = true;
        O.i(u).then(L.u);
        e(u, function J() {
          this.R && this.C && (this.Z = this.xa = true, L.i(), O.i(this).then(L.u), L.i(), e(this, J).then(L.u));
        });
        return F.promise();
      }
      function fa() {
        for (var F = 0; F < A.length; F++) {
          var L = A[F], K = L.action();
      ...
      return { reload: function() {
        x || (u.empty() ? I() : (N.stop(), n.i(), ja.stop(), x = true, Ga(0 < q.Gd ? [O.u(), S(false)] : [R(0)]).then(function() {
          R(0, true);
          x = false;
          I();
          P.defer(fa);
    ...
    }(), ha, ba = new Ha(function() {
      ha.resolve();
    }), ja = /* @__PURE__ */ function() {
      function I() {
        V || (ba.initial() && (ha = new Fa()), ba.i(), T(), V = true, t.repeat(R));
        return ha.promise();
      }
      function T() {
        fa = k.now();
      ...
      var T = [];
      return { grow: function(R) {
        var V = f.options, fa = V.Yg;
        0 < fa ? Va.u(R, Va.i(R, f.options.Qd), function(x, A, F) {
          A = "groups" === f.options.Pd ? F : A;
          ba.i();
          T.push(n.K.A(x).wait(A * V.Xg * fa).fa({ duration: fa, P: { w: { start: x.Wf, end: x.hc, easing: La.ia(V.Zg) } }, ba: function() {
      ...
      return function(T) {
        ...
        var V = new Fa();
        G.Vb({ m: [], Ca: false, Ba: false }, T, false, true).then(function() {
          H.Bb({ m: [], Ca: false, Ba: false }, T, false).then(V.resolve);
        });
        R.push(V.promise());
  ...
  function sb() {
    return { version: "3.5.1", build: "bugfix/3.5.x/26b14206", brandingAllowed: false };
  }
  ;
  ea.md(function() {
    window.CarrotSearchFoamTree = function(a) {
      ...
      function l(u) {
        ...
        m && m.validate(n, b.Qh);
        var k = 0;
        h && (k += t("selection", h.H), k += t("open", h.u), k += t("exposure", h.i));
        var r = {};
        P.Aa(n, function(y, v) {
      ...
      l(a);
      (a = c.element || document.getElementById(c.id)) || Ca.i("Element to embed FoamTree in not found.");
      c.element = a;
      var h = new wb(a, b, c);
      h.M();
      var f = {
...
var FoamTree = window.CarrotSearchFoamTree;
export {
  FoamTree,
  FoamTree as default
};
//# sourceMappingURL=@carrotsearch_foamtree.js.map
