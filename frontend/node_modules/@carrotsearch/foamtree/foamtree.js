 ...
 */
/* eslint-disable */
(function() {var ea=function(){var a=window.navigator.userAgent;try{window.localStorage.setItem("ftap5caavc","ftap5caavc");window.localStorage.removeItem("ftap5caavc");var q=!0}catch(l){q=!1}return{Te:function(){return/webkit/i.test(a)},Nh:function(){return/Mac/.test(a)},Re:function(){return/iPad|iPod|iPhone/.test(a)},Mh:function(){return/Android/.test(a)},Ih:function(){return"ontouchstart"in window||!!window.DocumentTouch&&document instanceof window.DocumentTouch},Hh:function(){return q},Gh:function(){var l=
document.createElement("canvas");return!(!l.getContext||!l.getContext("2d"))},md:function(l,g){return[].forEach&&ea.Gh()?l&&l():g&&g()}}}();var ka=function(){function a(){return window.performance&&(window.performance.now||window.performance.mozNow||window.performance.msNow||window.performance.oNow||window.performance.webkitNow)||Date.now}var q=a();return{create:function(){return{now:function(){var l=a();return function(){return l.call(window.performance)}}()}},now:function(){return q.call(window.performance)}}}();function na(){function a(){if(!d)throw"AF0";var m=ka.now();0!==p&&(l.sd=m-p);p=m;e=e.filter(function(h){return null!==h});l.frames++;for(var c=0;c<e.length;c++){var b=e[c];null!==b&&(!0===b.ee.call(b.context)?e[c]=null:P.zc(b.repeat)&&(b.repeat=b.repeat-1,0>=b.repeat&&(e[c]=null)))}e=e.filter(function(h){return null!==h});d=!1;q();m=ka.now()-m;0!==m&&(l.rd=m);l.totalTime+=m;l.ve=1E3*l.frames/l.totalTime;0===e.length?p=0:p=ka.now()}function q(){0<e.length&&!d&&(d=!0,g(a))}var l=this.Xf={frames:0,totalTime:0,
rd:0,sd:0,ve:0};pa=l;var g=function(){return ea.Re()?function(m){window.setTimeout(m,0)}:window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(){var m=ka.create();return function(c){var b=0;window.setTimeout(function(){var h=m.now();c();b=m.now()-h},16>b?16-b:0)}}()}(),e=[],d=!1,p=0;this.repeat=function(m,c,b){this.cancel(m);e.push({ee:m,context:b,repeat:c});q()};this.once=function(m,
...
n);for(n=0;n<f.length;n++)f[n](g);g.restore();t++;n=ka.now()}while(n-u<p);b[h]=a*(n-u)/t}b.total=ka.now()-c;return b}}}();var ya={Ud:function(a,q){var l=q[0];a.moveTo(l.x,l.y);for(var g=q.length-1;0<g;g--)l=q[g],a.lineTo(l.x,l.y)},Wi:function(a,q,l,g){var e,d=[],p=0,m=q.length;for(e=0;e<m;e++){var c=q[e];var b=q[(e+1)%m];c=wa.i(c,b);c=Math.sqrt(c);d.push(c);p+=c}l=g*(l+.5*g*p/m);p={};var h={},f={},u=0;for(e=0;e<m;e++){c=q[e];b=q[(e+1)%m];g=q[(e+2)%m];var t=d[(e+1)%m];t=Math.min(.5,l/t);wa.ga(1-t,b,g,h);wa.ga(t,b,g,f);u++;0==e&&(wa.ga(Math.min(.5,l/d[0]),c,b,p),u++,a.moveTo(p.x,p.y));a.quadraticCurveTo(b.x,b.y,h.x,h.y);
...
b)*(2/3-f)*6:b}function e(b,h,f){return Math.sqrt(b*b*.241+h*h*.691+f*f*.068)/255}if("rgb"==l.model||"rgba"==l.model)return e(l.r,l.g,l.b);var d=l.l/100;var p=l.s/100;var m=l.h/360;if(0==l.Cj)d=l=m=d;else{p=.5>d?d*(1+p):d+p-d*p;var c=2*d-p;d=g(c,p,m+1/3);l=g(c,p,m);m=g(c,p,m-1/3)}return e(255*d,255*l,255*m)};this.wa=function(l){if(P.Ac(l))return l;if(P.wb(l))switch(l.model){case "hsla":return Ea.sa(l);case "hsl":return Ea.H(l);case "rgba":return Ea.ua(l);case "rgb":return Ea.ta(l);default:return"#000"}else return"#000"};
this.ua=function(l){return"rgba("+(.5+l.r|0)+","+(.5+l.g|0)+","+(.5+l.b|0)+","+l.a+")"};this.ta=function(l){return"rgba("+(.5+l.r|0)+","+(.5+l.g|0)+","+(.5+l.b|0)+")"};this.sa=function(l){return"hsla("+(.5+l.h|0)+","+(.5+l.s|0)+"%,"+(.5+l.l|0)+"%,"+l.a+")"};this.H=function(l){return"hsl("+(.5+l.h|0)+","+(.5+l.s|0)+"%,"+(.5+l.l|0)+"%)"};this.i=function(l,g,e){return"hsl("+(.5+l|0)+","+(.5+g|0)+"%,"+(.5+e|0)+"%)"}};function Fa(){var a=!1,q,l=[],g=this,e=new function(){this.then=function(d){d&&(a?d.apply(g,q):l.push(d));return this};this.Gg=function(d){g=d;return{then:this.then}}};this.resolve=function(){q=arguments;for(var d=0;d<l.length;d++)l[d].apply(g,q);a=!0;return this};this.promise=function(){return e}}function Ga(a){var q=new Fa,l=a.length;if(0<a.length)for(var g=a.length-1;0<=g;g--)a[g].then(function(){0===--l&&q.resolve()});else q.resolve();return q.promise()}
function Ha(a){var q=0;this.i=function(){q++};this.u=function(){q--;0===q&&a()};this.clear=function(){q=0};this.initial=function(){return 0===q}};var Ia={pe:function(a,q,l,g){g=g||{};try{var e=a.getBoundingClientRect()}catch(p){if(!Ia.Kh){Ia.Kh=!0;window.console.log("getBoundingClientRect() failed.");window.console.log("Element",a);e=window.console;for(var d=e.log;null!==a.parentElement;)a=a.parentElement;d.call(e,"Attached to DOM",a===document.body.parentElement)}e={left:0,top:0}}g.x=q-e.left;g.y=l-e.top;return g}};function Ja(){var a=document,q={};this.addEventListener=function(l,g,e){var d=q[l];d||(d=[],q[l]=d);d.push(g);a.addEventListener(l,g,e)};this.i=function(){P.Aa(q,function(l,g){for(var e=l.length-1;0<=e;e--)a.removeEventListener(g,l[e])})}};function Ka(a){function q(H){return function(B){l(B)&&H.apply(this,arguments)}}function l(H){for(H=H.target;H;){if(H===a)return!0;H=H.parentElement}return!1}function g(H,B,M){M=M||{};e(H,M);for(var Q=0;Q<B.length;Q++)B[Q].call(H.target,M);e(H,M);(void 0===M.Db&&M.ci||"prevent"===M.Db)&&H.preventDefault();return M}function e(H,B){Ia.pe(a,H.clientX,H.clientY,B);B.altKey=H.altKey;B.metaKey=H.metaKey;B.ctrlKey=H.ctrlKey;B.shiftKey=H.shiftKey;B.lb=3===H.which;return B}var d=new Ja,p=[],m=[],c=[],b=[],
...
g(H,n,B)});d.addEventListener("mouseout",q(function(H){g(H,u,{type:"out"})}));d.addEventListener("wheel",q(function(){return function(H){if("deltaY"in H)var B=H.deltaY;else B=0,"detail"in H&&(B=H.detail),"wheelDelta"in H&&(B=-H.wheelDelta/120),"wheelDeltaY"in H&&(B=-H.wheelDeltaY/120),"axis"in H&&H.axis===H.HORIZONTAL_AXIS&&(B=0),B*=10;B&&H.deltaMode&&(B=1===H.deltaMode?67*B:800*B);g(H,r,{ed:-B/200,ci:!0})}}()),{passive:!1});d.addEventListener("contextmenu",q(function(H){H.preventDefault()}))};var La=function(){function a(e){return function(d){return Math.pow(d,e)}}function q(e){return function(d){return 1-Math.pow(1-d,e)}}function l(e){return function(d){return 1>(d*=2)?.5*Math.pow(d,e):1-.5*Math.abs(Math.pow(2-d,e))}}function g(e){return function(d){for(var p=0;p<e.length;p++)d=(0,e[p])(d);return d}}return{ia:function(e){switch(e){case "linear":return La.Ab;case "bounce":return La.ug;case "squareIn":return La.Uf;case "squareOut":return La.Gb;case "squareInOut":return La.Vf;case "cubicIn":return La.xg;
case "cubicOut":return La.fe;case "cubicInOut":return La.yg;case "quadIn":return La.vi;case "quadOut":return La.xi;case "quadInOut":return La.wi;default:return La.Ab}},Ab:function(e){return e},ug:g([l(2),function(e){return 0===e?0:1===e?1:e*(e*(e*(e*(25.9425*e-85.88)+105.78)-58.69)+13.8475)}]),Uf:a(2),Gb:q(2),Vf:l(2),xg:a(3),fe:q(3),yg:l(3),vi:a(2),xi:q(2),wi:l(2),rj:g}}();var P={V:function(a){return void 0===a},Se:function(a){return null===a},zc:function(a){return"[object Number]"===Object.prototype.toString.call(a)},Ac:function(a){return"[object String]"===Object.prototype.toString.call(a)},Qe:function(a){return"function"===typeof a},wb:function(a){return a===Object(a)},od:function(a,q){return 1E-6>a-q&&-1E-6<a-q},Oe:function(a){return P.V(a)||P.Se(a)||P.Ac(a)&&!/\S/.test(a)},has:function(a,q){return a&&a.hasOwnProperty(q)},bb:function(a,q){if(a)for(var l=q.length-
1;0<=l;l--)if(a.hasOwnProperty(q[l]))return!0;return!1},extend:function(a){P.Cg(Array.prototype.slice.call(arguments,1),function(q){if(q)for(var l in q)q.hasOwnProperty(l)&&(a[l]=q[l])});return a},Aj:function(a,q){return a.map(function(l){return l[q]},[])},Cg:function(a,q,l){null!=a&&(a.forEach?a.forEach(q,l):P.Aa(a,q,l))},Aa:function(a,q,l){for(var g in a)if(a.hasOwnProperty(g)&&!1===q.call(l,a[g],g,a))break},I:function(){for(var a=0;a<arguments.length;a++){var q=arguments[a];if(!(P.V(q)||P.zc(q)&&
isNaN(q)||P.Ac(q)&&P.Oe(q)))return q}},Jf:function(a,q){q=a.indexOf(q);0<=q&&a.splice(q,1)},zg:function(a,q,l){var g;return function(){var e=this,d=arguments,p=l&&!g;clearTimeout(g);g=setTimeout(function(){g=null;l||a.apply(e,d)},q);p&&a.apply(e,d)}},defer:function(a){setTimeout(a,1)},yj:function(a){return a},qa:function(){}};var Ma={Jh:function(a,q,l){return ea.Hh()?function(){var g=q+":"+JSON.stringify(arguments),e=window.localStorage.getItem(g);e&&(e=JSON.parse(e));if(e&&Date.now()-e.t<l)return e.v;e=a.apply(this,arguments);window.localStorage.setItem(g,JSON.stringify({v:e,t:Date.now()}));return e}:a}};var Na={A:function(a,q){function l(){var g=[];if(Array.isArray(a))for(var e=0;e<a.length;e++){var d=a[e];d&&g.push(d.apply(q,arguments))}else a&&g.push(a.apply(q,arguments));return g}l.empty=function(){return 0===a.length&&!P.Qe(a)};return l}};function Oa(){var a={};this.subscribe=function(q,l){var g=a[q];g||(g=[],a[q]=g);g.push(l)};this.D=function(q,l){var g=a[q];if(g)for(var e=Array.prototype.slice.call(arguments,1),d=0;d<g.length;d++)g[d].apply(this,e)}};var Pa={Qf:function(a){for(var q="",l=0;l<a.length;l++)q+=String.fromCharCode(a.charCodeAt(l)^1);return q}};function Qa(a){function q(b,h,f){var u=this,t,n=0;this.id=p++;this.name=f?f:"{unnamed on "+b+"}";this.target=function(){return b};this.xb=function(){return-1!=c.indexOf(u)};this.start=function(){if(!u.xb()){if(-1==c.indexOf(u)){var k=m.now();!0===u.bf(k)&&(c=c.slice(),c.push(u))}0<c.length&&a.repeat(g)}return this};this.stop=function(){for(d(u);t<h.length;t++){var k=h[t];k.Xa&&k.gb.call()}return this};this.bf=function(k){n++;if(0!==h.length){if(P.V(t)){t=0;var r=h[t];r.before&&r.before.call(r,k,n,
u)}else r=h[t];for(;t<h.length;){if(r.gb&&r.gb.call(r,k,n,u))return!0;r.after&&r.after.call(r,k,n,u);P.V(t)&&(t=-1);++t<h.length&&(r=h[t],r.before&&r.before.call(r,k,n,u))}}return!1}}function l(b){return P.V(b)?c.slice():c.filter(function(h){return h.target()===b})}function g(){e();0==c.length&&a.cancel(g)}function e(){var b=m.now();c.forEach(function(h){!0!==h.bf(b)&&d(h)})}function d(b){c=c.filter(function(h){return h!==b})}var p=0,m=ka.create(),c=[];this.i=function(){for(var b=c.length-1;0<=b;b--)c[b].stop();
c=[]};this.K=function(){function b(){}function h(k){function r(D){return P.Qe(D)?D.call(void 0):D}var y=k.target,v=k.duration,w=k.ba,z,E;this.before=function(){z={};for(var D in k.P)y.hasOwnProperty(D)&&(z[D]={start:P.V(k.P[D].start)?y[D]:r(k.P[D].start),end:P.V(k.P[D].end)?y[D]:r(k.P[D].end),easing:P.V(k.P[D].easing)?La.Ab:k.P[D].easing});E=m.now()};this.gb=function(){var D=m.now()-E;D=0===v?1:Math.min(v,D)/v;for(var G in z){var O=z[G];y[G]=O.start+(O.end-O.start)*O.easing(D)}w&&w.call(y,D);return 1>
...
return w.promise()};this.Ta=function(){var w=this.i();this.start();return w}}};b.jc=function(k){l(k).forEach(function(r){r.stop()});return b.A(k,void 0)};return b}()};var Ra=function(){var a={oe:function(q,l){if(q.m){q=q.m;for(var g=0;g<q.length;g++)l(q[g],g)}},sc:function(q,l){if(q.m){q=q.m;for(var g=0;g<q.length;g++)if(!1===a.sc(q[g],l)||!1===l(q[g],g))return!1}}};a.L=a.sc;a.tc=function(q,l){if(q.m){q=q.m;for(var g=0;g<q.length;g++)if(!1===l(q[g],g)||!1===a.tc(q[g],l))return!1}};a.za=function(q,l){if(q.m)for(var g=q.m,e=0;e<g.length;e++)if(!1===a.za(g[e],l))return!1;return l(q)};a.sj=a.za;a.fd=function(q,l){!1!==l(q)&&a.tc(q,l)};a.uc=function(q,l){var g=[];a.tc(q,
function(e){g.push(e)});return l?g.filter(l):g};a.ne=function(q,l){for(q=q.parent;q&&!1!==l(q);)q=q.parent};a.Lh=function(q,l){for(q=q.parent;q&&q!==l;)q=q.parent;return!!q};return a}();var wa=new function(){function a(l,g){var e=l.x-g.x;l=l.y-g.y;return e*e+l*l}function q(l,g,e){for(var d=0;d<l.length;d++){var p=wa.T(l[d],l[d+1]||l[0],g,e,!0);if(p)return p}}this.T=function(l,g,e,d,p){var m=l.x;l=l.y;var c=g.x-m;g=g.y-l;var b=e.x,h=e.y;e=d.x-b;var f=d.y-h;d=c*f-e*g;if(!(1E-12>=d&&-1E-12<=d)&&(b-=m,h-=l,e=(b*f-e*h)/d,d=(b*g-c*h)/d,0<=d&&(p||1>=d)&&0<=e&&1>=e))return{x:m+c*e,y:l+g*e}};this.Lb=function(l,g,e,d){var p=l.x;l=l.y;var m=g.x-p;g=g.y-l;var c=e.x;e=e.y;var b=d.x-c;d=d.y-e;
...
0);break;case "bottom":d=Math.atan2(d.o,0);break;case "left":d=Math.atan2(0,-d.w);break;case "right":d=Math.atan2(0,d.w);break;case "topleft":d=Math.atan2(-d.o,-d.w);break;case "topright":d=Math.atan2(-d.o,d.w);break;case "bottomleft":d=Math.atan2(d.o,-d.w);break;default:d=Math.atan2(d.o,d.w)}g=wa.u(l,{});l=q(l,g,{x:g.x+Math.cos(d),y:g.y+Math.sin(d)});return wa.ga(e,l,g,{})};return this};var Sa=new function(){function a(d,p){this.face=d;this.Rc=p;this.ec=this.Lc=null}function q(d,p,m){this.la=[d,p,m];this.J=Array(3);var c=p.y-d.y,b=m.z-d.z,h=p.x-d.x;p=p.z-d.z;var f=m.x-d.x;d=m.y-d.y;this.Ha={x:c*b-p*d,y:p*f-h*b,z:h*d-c*f};this.Ya=[];this.ad=this.visible=!1}this.i=function(d){function p(aa,C,U){var ha=aa.la[0],ba=aa.Ha,ja=ba.x,N=ba.y;ba=ba.z;var S=Array(b);C=C.Ya;var ca=C.length;for(c=0;c<ca;c++){var I=C[c].Rc;S[I.index]=!0;0>ja*(I.x-ha.x)+N*(I.y-ha.y)+ba*(I.z-ha.z)&&a.add(aa,I)}C=
U.Ya;ca=C.length;for(c=0;c<ca;c++)I=C[c].Rc,!0!==S[I.index]&&0>ja*(I.x-ha.x)+N*(I.y-ha.y)+ba*(I.z-ha.z)&&a.add(aa,I)}var m,c,b=d.length;for(m=0;m<b;m++)d[m].index=m,d[m].Pb=null;var h=[],f;if(0<(f=function(){function aa(T,R,V,fa){var x={x:R.x-T.x,y:R.y-T.y,z:R.z-T.z};var A={x:V.x-T.x,y:V.y-T.y,z:V.z-T.z};var F=x.y*A.z-x.z*A.y;var L=x.z*A.x-x.x*A.z;x=x.x*A.y-x.y*A.x;return F*fa.x+L*fa.y+x*fa.z>F*T.x+L*T.y+x*T.z?new q(T,R,V):new q(V,R,T)}function C(T,R,V,fa){function x(A,F,L){A=A.la;F=A[0]==F?0:A[1]==
F?1:2;return A[(F+1)%3]!=L?(F+2)%3:F}R.J[x(R,V,fa)]=T;T.J[x(T,fa,V)]=R}if(4>b)return 0;var U=d[0],ha=d[1],ba=d[2],ja=d[3],N=aa(U,ha,ba,ja),S=aa(U,ba,ja,ha),ca=aa(U,ha,ja,ba),I=aa(ha,ba,ja,U);C(N,S,ba,U);C(N,ca,U,ha);C(N,I,ha,ba);C(S,ca,ja,U);C(S,I,ba,ja);C(ca,I,ja,ha);h.push(N,S,ca,I);for(U=4;U<b;U++)for(ha=d[U],ba=0;4>ba;ba++)ja=h[ba],N=ja.la[0],S=ja.Ha,0>S.x*(ha.x-N.x)+S.y*(ha.y-N.y)+S.z*(ha.z-N.z)&&a.add(ja,ha);return 4}())){for(;f<b;){var u=d[f];if(u.Pb){for(m=u.Pb;null!==m;)m.face.visible=!0,
m=m.ec;m=0;a:for(;m<h.length;m++){var t=h[m];if(!1===t.visible){var n=t.J;for(c=0;3>c;c++)if(!0===n[c].visible){var k=t;var r=c;break a}}}t=[];n=[];var y=k,v=r;do if(t.push(y),n.push(v),v=(v+1)%3,!1===y.J[v].visible){do for(m=y.la[v],y=y.J[v],c=0;3>c;c++)y.la[c]==m&&(v=c);while(!1===y.J[v].visible&&(y!==k||v!==r))}while(y!==k||v!==r);var w=null,z=null;for(m=0;m<t.length;m++){y=t[m];v=n[m];var E=y.J[v],D=y.la[(v+1)%3],G=y.la[v],O=D.y-u.y,H=G.z-u.z,B=D.x-u.x,M=D.z-u.z,Q=G.x-u.x,X=G.y-u.y;if(0<e.length){var Y=
...
y=E[1],n[z]=null,k.length===v))break a}}k[0][0]!=k[v-1][1]&&k.push([k[v-1][1],k[0][0]]);return k}function e(n,k,r,y){var v=[],w=[],z=r.length,E,D=k.length,G=0,O=-1,H=-1,B,M=y;for(y=0;y<z;y++){var Q=(M+1)%z,X=r[M][0],Y=r[Q][0];if(1E-12<wa.i(X.ea,Y.ea))if(X.jb&&Y.jb){var aa=[],C=[];for(E=0;E<D;E++){var U=(G+1)%D;if(B=wa.T(k[G],k[U],X.ea,Y.ea,!1))if(C.push(G),2===aa.push(B))break;G=U}if(2===aa.length){E=aa[1];B=wa.i(X.ea,aa[0]);E=wa.i(X.ea,E);X=B<E?0:1;B=B<E?1:0;E=C[X];-1===O&&(O=E);if(-1!==H)for(;E!=
H;)H=(H+1)%D,v.push(k[H]),w.push(null);v.push(aa[X],aa[B]);w.push(r[M][2],null);H=C[B]}}else if(X.jb&&!Y.jb)for(E=0;E<D;E++){U=(G+1)%D;if(B=wa.T(k[G],k[U],X.ea,Y.ea,!1)){if(-1!==H)for(aa=H;G!=aa;)aa=(aa+1)%D,v.push(k[aa]),w.push(null);v.push(B);w.push(r[M][2]);-1===O&&(O=G);break}G=U}else if(!X.jb&&Y.jb)for(E=0;E<D;E++){U=(G+1)%D;if(B=wa.T(k[G],k[U],X.ea,Y.ea,!1)){v.push(X.ea,B);w.push(r[M][2],null);H=G;break}G=U}else v.push(X.ea),w.push(r[M][2]);M=Q}if(0==v.length)w=v=null;else if(-1!==H)for(;O!=
H;)H=(H+1)%D,v.push(k[H]),w.push(null);n.C=v;n.J=w}if(1===q.length)q[0].C=l.slice(0),q[0].J=[];else{var d;var p=a(l);var m=[];for(d=0;d<p.length;d++){var c=p[d];m.push({x:c.x,y:c.y,z:c.x*c.x+c.y*c.y-c.w})}for(d=0;d<q.length;d++)c=q[d],c.C=null,m.push({x:c.x,y:c.y,z:c.x*c.x+c.y*c.y-c.w});var b=Sa.i(m).qe;(function(){for(d=0;d<b.length;d++){var n=b[d],k=n.la,r=k[0],y=k[1],v=k[2];k=r.x;var w=r.y;r=r.z;var z=y.x,E=y.y;y=y.z;var D=v.x,G=v.y;v=v.z;var O=k*(E-G)+z*(G-w)+D*(w-E);n.ea={x:-(w*(y-v)+E*(v-r)+
G*(r-y))/O/2,y:-(r*(z-D)+y*(D-k)+v*(k-z))/O/2}}})();(function(n){for(d=0;d<b.length;d++){var k=b[d];k.jb=!wa.sa(n,k.ea)}})(l);m=function(n,k){var r=Array(k.length),y;for(y=0;y<r.length;y++)r[y]=[];for(y=0;y<n.length;y++){var v=n[y];if(!(0>v.Ha.z))for(var w=v.J,z=0;z<w.length;z++){var E=w[z];if(!(0>E.Ha.z)){var D=v.la,G=D[(z+1)%3].index;D=D[z].index;2<G&&r[G-3].push([v,E,2<D?k[D-3]:null])}}}return r}(b,q);for(d=0;d<q.length;d++)if(c=m[d],0!==c.length){var h=q[d];c=g(c);var f=c.length,u=-1;for(p=0;p<
f;p++)c[p][0].jb&&(u=p);if(0<=u)e(h,l,c,u);else{u=[];var t=[];for(p=0;p<f;p++)1E-12<wa.i(c[p][0].ea,c[(p+1)%f][0].ea)&&(u.push(c[p][0].ea),t.push(c[p][2]));h.C=u;h.J=t}h.C&&3>h.C.length&&(h.C=null,h.J=null)}}};this.u=function(q,l){var g,e=!1,d=q.length;for(g=0;g<d;g++){var p=q[g];null===p.C&&(e=!0);p.Yd=p.w}if(e){e=a(l);var m=[];g=q.length;for(p=0;p<e.length;p++){var c=e[p];m.push({x:c.x,y:c.y,z:c.x*c.x+c.y*c.y})}for(p=0;p<g;p++)c=q[p],m.push({x:c.x,y:c.y,z:c.x*c.x+c.y*c.y});c=Sa.i(m).qe;e=Array(g);
for(p=0;p<g;p++)e[p]={};m=c.length;for(p=0;p<m;p++){var b=c[p];if(0<b.Ha.z){var h=b.la,f=h.length;for(b=0;b<f-1;b++){var u=h[b].index-3,t=h[b+1].index-3;0<=u&&0<=t&&(e[u][t]=!0,e[t][u]=!0)}b=h[0].index-3;0<=t&&0<=b&&(e[t][b]=!0,e[b][t]=!0)}}for(p=0;p<g;p++){b=e[p];c=q[p];t=Number.MAX_VALUE;m=null;for(var n in b)b=q[n],h=wa.i(c,b),t>h&&(t=h,m=b);c.zj=m;c.$e=Math.sqrt(t)}for(g=0;g<d;g++)p=q[g],n=Math.min(Math.sqrt(p.w),.95*p.$e),p.w=n*n;this.i(q,l);for(g=0;g<d;g++)p=q[g],p.Yd!==p.w&&0<p.kc&&(l=Math.min(p.kc,
p.Yd-p.w),p.w+=l,p.kc-=l)}}};var Va=new function(){this.H=function(a){a=a.m;for(var q=0,l=a.length,g=0;g<l;g++){var e=a[g];if(e.C){var d=e.x,p=e.y;wa.u(e.C,e);d-=e.x;e=p-e.y;e=(0<d?d:-d)+(0<e?e:-e);q<e&&(q=e)}}return q};this.i=function(a,q){var l=a.m;switch(q){case "random":return a.m[Math.floor(l.length*Math.random())];case "topleft":a=l[0];var g=a.x+a.y;for(q=1;q<l.length;q++){var e=l[q];var d=e.x+e.y;d<g&&(g=d,a=e)}return a;case "bottomright":a=l[0];g=a.x+a.y;for(q=1;q<l.length;q++)e=l[q],d=e.x+e.y,d>g&&(g=d,a=e);return a;
default:e=l[0];g=d=wa.i(a,e);for(q=l.length-1;1<=q;q--){var p=l[q];d=wa.i(a,p);d<g&&(g=d,e=p)}return e}};this.u=function(a,q,l){var g=a.m;if(g[0].J){var e=g.length;for(a=0;a<e;a++)g[a].Sc=!1,g[a].Zb=0;e=[];var d;var p=d=0;e[d++]=q||g[0];for(q=q.Zb=0;p<d;)if(g=e[p++],!g.Sc&&g.J){l(g,q++,g.Zb);g.Sc=!0;var m=g.J,c=m.length;for(a=0;a<c;a++){var b=m[a];b&&!0!==b.Sc&&(0===b.Zb&&(b.Zb=g.Zb+1),e[d++]=b)}}}else for(a=0;a<g.length;a++)l(g[a],a,1)}};var ta=function(){function a(n,k,r,y,v,w,z,E){var D=P.extend({},m,n);1>n.lineHeight&&(n.lineHeight=1);n=D.fontFamily;var G=D.fontStyle+" "+D.fontVariant+" "+D.fontWeight,O=D.hb,H=D.Gc,B=G+" "+n;D.ue=B;var M={ka:!1,bc:0,fontSize:0};k.save();k.font=G+" 100px "+n;k.textBaseline="middle";k.textAlign="center";q(k,D);r=r.trim();u.text=r;e(y,v,w,t);if(/[\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf]/.test(r))g(u),l(k,u,B),d(D,u,t,H,O,!0,M);else if(l(k,u,B),d(D,u,t,H,O,!1,
M),!M.ka&&(z&&(g(u),l(k,u,B)),E||z))E&&(M.Ub=!0),d(D,u,t,H,H,!0,M);if(M.ka){var Q="",X=0,Y=Number.MAX_VALUE,aa=Number.MIN_VALUE;p(D,u,M.bc,M.fontSize,t,M.Ub,function(C,U){0<Q.length&&" "===U&&(Q+=" ");Q+=C},function(C,U,ha,ba,ja){"\u00ad"===ba&&(Q+="\u2010");k.save();k.translate(w.x,U);C=M.fontSize/100;k.scale(C,C);k.fillText(Q,0,0);k.restore();Q=ha;X<ja&&(X=ja);Y>U&&(Y=U);aa<U&&(aa=U)});M.box={x:w.x-X/2,y:Y-M.fontSize/2,w:X,o:aa-Y+M.fontSize};k.restore()}else k.clear&&k.clear();return M}function q(n,
k){k=k.ue;var r=c[k];void 0===r&&(r={},c[k]=r);r[" "]=n.measureText(" ").width;r["\u2026"]=n.measureText("\u2026").width}function l(n,k,r){var y,v=k.text.split(/(\n|[ \f\r\t\v\u2028\u2029]+|\u00ad+|\u200b+)/),w=[],z=[],E=v.length>>>1;for(y=0;y<E;y++)w.push(v[2*y]),z.push(v[2*y+1]);2*y<v.length&&(w.push(v[2*y]),z.push(void 0));r=c[r];for(y=0;y<w.length;y++)v=w[y],E=r[v],void 0===E&&(E=n.measureText(v).width,r[v]=E);k.Tc=w;k.Rf=z}function g(n){for(var k=n.text.split(/\s+/),r=[],y={".":!0,",":!0,";":!0,
"?":!0,"!":!0,":":!0,"\u3002":!0},v=0;v<k.length;v++){var w=k[v];if(3<w.length){var z="";z+=w.charAt(0);z+=w.charAt(1);for(var E=2;E<w.length-2;E++){var D=w.charAt(E);y[D]||(z+="\u200b");z+=D}z+="\u200b";z+=w.charAt(w.length-2);z+=w.charAt(w.length-1);r.push(z)}else r.push(w)}n.text=r.join(" ")}function e(n,k,r,y){for(var v,w,z=0;z<n.length;z++)n[z].y===k.y&&(void 0===v?v=z:w=z);void 0===w&&(w=v);v!==w&&n[w].x<n[v].x&&(z=v,v=w,w=z);y.C=n;y.F=k;y.cd=r;y.Ye=v;y.Ze=w}function d(n,k,r,y,v,w,z){var E=
n.lineHeight,D=Math.max(n.Ua,.001),G=n.ib,O=k.Tc,H=r.cd,B=r.F,M=void 0,Q=void 0;switch(n.verticalAlign){case "top":H=B.y+B.o-H.y;break;case "bottom":H=H.y-B.y;break;default:H=2*Math.min(H.y-B.y,B.y+B.o-H.y)}G=Math.min(H,G*r.F.o);if(0>=G)z.ka=!1;else{H=y;v=Math.min(v,G);B=Math.min(1,G/Math.max(20,k.Tc.length));do{var X=(H+v)/2,Y=Math.min(O.length,Math.floor((G+X*(E-1-2*D))/(X*E))),aa=void 0;if(0<Y){var C=1,U=Y;do{var ha=Math.floor((C+U)/2);if(p(n,k,ha,X,r,w&&X===y&&ha===Y,null,null)){if(U=M=aa=ha,
C===U)break}else if(C=ha+1,C>U)break}while(1)}void 0!==aa?H=Q=X:v=X}while(v-H>B);void 0===Q?(z.ka=!1,z.fontSize=0):(z.ka=!0,z.fontSize=Q,z.bc=M,z.Ub=w&&X===H);return z}}function p(n,k,r,y,v,w,z,E){var D=n.cb,G=y*(n.lineHeight-1),O=Math.max(n.Ua,.001),H=c[n.ue],B=k.Tc;k=k.Rf;var M=v.C,Q=v.cd,X=v.Ye,Y=v.Ze;switch(n.verticalAlign){case "top":v=Q.y+y/2+y*O;var aa=1;break;case "bottom":v=Q.y-(y*r+G*(r-1))+y/2-y*O;aa=-1;break;default:v=Q.y-(y*(r-1)/2+G*(r-1)/2),aa=1}n=v;for(O=0;O<r;O++)b[2*O]=v-y/2,b[2*
O+1]=v+y/2,v+=aa*y,v+=aa*G;for(;h.length<b.length;)h.push(Array(2));O=b;v=2*r;aa=h;var C=M.length,U=X;X=(X-1+C)%C;var ha=Y;Y=(Y+1)%C;for(var ba=0;ba<v;){for(var ja=O[ba],N=M[X];N.y<ja;)U=X,X=(X-1+C)%C,N=M[X];for(var S=M[Y];S.y<ja;)ha=Y,Y=(Y+1)%C,S=M[Y];var ca=M[U],I=M[ha];S=I.x+(S.x-I.x)*(ja-I.y)/(S.y-I.y);aa[ba][0]=ca.x+(N.x-ca.x)*(ja-ca.y)/(N.y-ca.y);aa[ba][1]=S;ba++}for(O=0;O<r;O++)M=2*O,v=Q.x,aa=v-h[M][0],C=h[M][1]-v,aa=aa<C?aa:C,C=v-h[M+1][0],M=h[M+1][1]-v,M=C<M?C:M,f[O]=2*(aa<M?aa:M)-D*y;U=
H[" "]*y/100;aa=H["\u2026"]*y/100;D=0;X=f[D];Q=0;M=void 0;for(O=0;O<B.length;O++){v=B[O];ha=k[O];C=H[v]*y/100;if(Q+C<X&&B.length-O>=r-D&&"\n"!=M)Q+=C," "===ha&&(Q+=U),z&&z(v,M);else{if(C>X&&(D!==r-1||!w))return!1;if(D+1>=r){if(w){r=X-Q-aa;if(r>aa||C>aa)r=Math.floor(v.length*r/C),0<r&&z&&z(v.substring(0,r),M);z&&z("\u2026",void 0);E&&E(D,n,v,M,Q);return!0}return!1}D++;E&&E(D,n,v,M,Q);n+=y;n+=G;X=f[D];Q=C;" "===ha&&(Q+=U);if(C>X&&(D!==r||!w))return!1}M=ha}E&&E(D,n,void 0,void 0,Q);return!0}var m={hb:72,
Gc:0,lineHeight:1.05,cb:1,Ua:.5,ib:.9,fontFamily:"sans-serif",fontStyle:"normal",fontWeight:"normal",fontVariant:"normal",verticalAlign:"center"},c={},b=[],h=[],f=[],u={text:"",Tc:void 0,Rf:void 0},t={C:void 0,F:void 0,cd:void 0,Ye:0,Ze:0};return{se:a,de:function(n,k,r,y,v,w,z,E,D,G,O,H){var B=0,M=0;r=r.toString().trim();if(!H&&D.result&&r===D.Yf&&Math.abs(G-D.Zd)/G<=O){var Q=D.result;Q.ka&&(B=w.x-D.fg,M=w.y-D.gg,O=D.Qc,k.save(),k.translate(B,M),O.Na(k),k.restore())}Q||(O=D.Qc,O.clear(),Q=a(n,O,r,
y,v,w,z,E),Q.ka&&O.Na(k),D.Zd=G,D.fg=w.x,D.gg=w.y,D.result=Q,D.Yf=r);return Q.ka?{ka:!0,bc:Q.bc,fontSize:Q.fontSize,box:{x:Q.box.x+B,y:Q.box.y+M,w:Q.box.w,o:Q.box.o},Ub:Q.Ub}:{ka:!1}},bi:function(){return{Zd:0,fg:0,gg:0,result:void 0,Qc:new ra,Yf:void 0}},ya:m}}();var Wa=new function(){function a(g,e){return function(d,p,m,c){function b(r,y,v,w,z){if(0!=r.length){var E=r.shift(),D=l(E);if(e(w,z)){var G=y;var O=D/w;do{D=E.shift();var H=D.lc;var B=H/O;H=D;var M=v,Q=O;H.x=G+B/2;H.y=M+Q/2;m&&h(D,G,v,B,O);G+=B}while(0<E.length);return b(r,y,v+O,w,z-O)}G=v;B=D/z;do D=E.shift(),H=D.lc,O=H/B,H=D,M=G,Q=O,H.x=y+B/2,H.y=M+Q/2,m&&h(D,y,G,B,O),G+=O;while(0<E.length);return b(r,y+B,v,w-B,z)}}function h(r,y,v,w,z){r.C=[{x:y,y:v},{x:y+w,y:v},{x:y+w,y:v+z},{x:y,y:v+z}]}var f=
...
1;w.attribution=!0;v.m.push(w)}})(b);d(b);m();p(b)};this.update=function(k){k.forEach(function(r){Ra.za(r,function(y){if(!y.empty()){y=y.m;for(var v=e(y.map(function(E){return E.group})),w=0;w<y.length;w++){var z=y[w];z.weight=0<z.group.weight?z.group.weight:.9*v}}});d(r);r===b&&m();p(r)})};this.u=function(k){return function(){if(P.V(k)||P.Se(k))return[];if(Array.isArray(k))return k.map(c.i,c);if(P.wb(k)){if(P.has(k,"__id"))return[c.i(k)];if(P.has(k,"all")){var r=[];Ra.L(b,function(y){r.push(y)});
...
function $a(a,q,l){var g={};q.Ba&&Ra.L(a,function(m){l(m)&&(g[m.id]=m)});a=q.m;q=q.Ca;for(var e=a.length-1;0<=e;e--){var d=a[e];g[d.id]=q?d:void 0}var p=[];P.Aa(g,function(m){void 0!==m&&p.push(m)});return p};function ab(a){function q(B,M){B=B.ja;M.opacity=1;M.Da=1;M.va=0>B?1-t.Eh/100*B:1;M.saturation=0>B?1-t.Fh/100*B:1;M.ca=0>B?1+.5*B:1}function l(B){B=B.ja;return Math.max(.001,0===B?1:1+B*(t.Pa-1))}function g(B,M){for(var Q=B.reduce(function(C,U){C[U.id]=U;return C},{}),X=B.length-1;0<=X;X--)Ra.L(B[X],function(C){Q[C.id]=void 0});var Y=[];P.Aa(Q,function(C){C&&Ra.ne(C,function(U){U.open||Y.push(U)})});var aa=[];P.Aa(Q,function(C){C&&C.open&&aa.push(C)});B=[];0!==Y.length&&B.push(w.Bb({m:Y,Ca:!0,Ba:!0},
M,!0));return Ga(B)}function e(B,M,Q,X){var Y=m();if(0===B.length&&!Y)return(new Fa).resolve().promise();var aa=B.reduce(function(ba,ja){ba[ja.id]=!0;return ba},{}),C=[];B=[];if(z.reduce(function(ba,ja){return ba||aa[ja.id]&&(!ja.U||1!==ja.ja)||!aa[ja.id]&&!ja.parent.U&&(ja.U||-1!==ja.ja)},!1)){var U=[],ha={};z.forEach(function(ba){aa[ba.id]&&(ba.U||C.push(ba),ba.U=!0,Ra.za(ba,function(ja){U.push(b(ja,1));ha[ja.id]=!0}))});0<U.length?(Ra.L(n,function(ba){aa[ba.id]||(ba.U&&C.push(ba),ba.U=!1);ha[ba.id]||
U.push(b(ba,-1))}),B.push(v.K.A({}).Qa(U).call(h).Ta()),d(aa),B.push(p(Y)),Q&&(y.ic(E,t.Yb,t.Oa,La.ia(t.Wb)),y.Fb())):(B.push(c(Q)),M&&Ra.L(n,function(ba){ba.U&&C.push(ba)}))}return Ga(B).then(function(){r.bd(M,C,"exposed",function(ba){return ba.U},{indirect:X},a.options.jf,a.options.hf)})}function d(B){z.reduce(f(!0,void 0,function(M){return M.U||B[M.id]}),u(E));E.x-=E.w*(t.Pa-1)/2;E.y-=E.o*(t.Pa-1)/2;E.w*=t.Pa;E.o*=t.Pa}function p(B){if(B||!y.zd())return v.K.A(k).fa({duration:.7*t.Oa,P:{x:{end:E.x+
...
this.qb(q)});X.fa({duration:t.Oa,P:{ja:{end:M,easing:La.ia(t.Wb)}},ba:function(){n.N=!0;n.Fa=!0;a.j.D("foamtree:dirty",!0)}});0===M&&X.call(function(){this.vd();this.cc();this.Nc(O);this.Mc(q)});return X.call(Q).done()}function h(){var B=n.m.reduce(f(!1,O.transformPoint,void 0),u({})).box,M=t.Yb,Q=Math.min(B.x,E.x-E.w*M),X=Math.min(B.y,E.y-E.o*M);y.content(Q,X,Math.max(B.x+B.w,E.x+E.w*(1+M))-Q,Math.max(B.y+B.o,E.y+E.o*(1+M))-X)}function f(B,M,Q){var X={};return function(Y,aa){if(!Q||Q(aa)){for(var C=
B?aa.$||aa.C:aa.C,U,ha=C.length-1;0<=ha;ha--)U=void 0!==M?M(aa,C[ha],X):C[ha],Y.Hc=Math.min(Y.Hc,U.x),Y.wd=Math.max(Y.wd,U.x),Y.Ic=Math.min(Y.Ic,U.y),Y.xd=Math.max(Y.xd,U.y);Y.box.x=Y.Hc;Y.box.y=Y.Ic;Y.box.w=Y.wd-Y.Hc;Y.box.o=Y.xd-Y.Ic}return Y}}function u(B){return{Hc:Number.MAX_VALUE,wd:Number.MIN_VALUE,Ic:Number.MAX_VALUE,xd:Number.MIN_VALUE,box:B}}var t=a.options,n,k,r,y,v,w,z,E,D,G,O={We:function(B,M){M.scale=l(B);return!1},Ib:function(B,M){B=l(B);var Q=k.x,X=k.y;M.translate(Q,X);M.scale(B,B);
M.translate(-Q,-X)},Jb:function(B,M,Q){B=l(B);var X=k.x,Y=k.y;Q.x=(M.x-X)/B+X;Q.y=(M.y-Y)/B+Y},transformPoint:function(B,M,Q){B=l(B);var X=k.x,Y=k.y;Q.x=(M.x-X)*B+X;Q.y=(M.y-Y)*B+Y;return Q}};a.j.subscribe("stage:initialized",function(B,M,Q,X){k={x:Q/2,y:X/2};D=Q;G=X;E={x:0,y:0,w:D,o:G}});a.j.subscribe("stage:resized",function(B,M,Q,X){k.x*=Q/B;k.y*=X/M;D=Q;G=X});a.j.subscribe("api:initialized",function(B){r=B});a.j.subscribe("zoom:initialized",function(B){y=B});a.j.subscribe("model:loaded",function(B,
M){n=B;z=M});a.j.subscribe("model:childrenAttached",function(B){z=B});a.j.subscribe("timeline:initialized",function(B){v=B});a.j.subscribe("openclose:initialized",function(B){w=B});var H=["groupExposureScale","groupUnexposureScale","groupExposureZoomMargin"];a.j.subscribe("options:changed",function(B){P.bb(B,H)&&m()&&(d({}),y.fj(E,t.Yb),y.Fb())});this.M=function(){a.j.D("expose:initialized",this)};this.Vb=function(B,M,Q,X){var Y=B.m.reduce(function(U,ha){for(;ha=ha.parent;)U[ha.id]=!0;return U},{}),
aa=$a(n,B,function(U){return U.U&&!U.open&&!Y[U.id]}),C=new Fa;g(aa,M).then(function(){e(aa.filter(function(U){return U.C&&U.$}),M,Q,X).then(C.resolve)});return C.promise()}};function bb(a){function q(c){function b(D,G){var O=Math.min(1,Math.max(0,D.ra));G.opacity=O;G.va=1;G.saturation=O;G.Da=O;G.ca=D.yb}var h=a.options,f=h.Ui,u=h.Vi,t=h.Ri,n=h.Si,k=h.Ti,r=h.Od,y=f+u+t+n+k,v=0<y?r/y:0,w=[];m.i(h.Nf,h.Mf,h.Of,h.Pf,h.Lf);if(0===v&&c.m&&c.R){r=c.m;for(y=0;y<r.length;y++){var z=r[y];z.ra=1;z.yb=1;z.qb(b);z.cc();z.Mc(b)}c.N=!0;a.j.D("foamtree:dirty",0<v);return(new Fa).resolve().promise()}if(c.m&&c.R){Va.u(c,Va.i(c,a.options.Qd),function(D,G,O){D.mc(m);D.qb(b);O="groups"===
a.options.Pd?O:G;G=g.K.A(D).wait(O*v*f).fa({duration:v*u,P:{ra:{end:1,easing:La.ia(h.Qi)}},ba:function(){this.N=!0;a.j.D("foamtree:dirty",0<v)}}).done();O=g.K.A(D).wait(p?v*(t+O*n):0).fa({duration:p?v*k:0,P:{yb:{end:1,easing:La.Ab}},ba:function(){this.N=!0;a.j.D("foamtree:dirty",0<v)}}).done();D=g.K.A(D).Qa([G,O]).Xd().Xa(function(){this.vd();this.cc();this.Nc(m);this.Mc(b)}).done();w.push(D)});d.i();var E=new Fa;g.K.A({}).Qa(w).call(function(){d.u();E.resolve()}).start();return E.promise()}return(new Fa).resolve().promise()}
...
c);var t=c.reduce(function(n,k){n[k.id]=!0;return n},{});q(t,b).then(function(){l(t,b,h).then(f.resolve)});return f.promise()}};function db(a){function q(e,d){e=$a(l,e,function(b){return b.selected});Ra.L(l,function(b){!0===b.selected&&(b.selected=!b.selected,b.N=!b.N,b.Sa=!b.Sa)});var p;for(p=e.length-1;0<=p;p--){var m=e[p];m.selected=!m.selected;m.N=!m.N;m.Sa=!m.Sa}var c=[];Ra.L(l,function(b){b.N&&c.push(b)});0<c.length&&a.j.D("foamtree:dirty",!1);g.bd(d,c,"selected",function(b){return b.selected},{},a.options.uf,a.options.tf)}var l,g;a.j.subscribe("api:initialized",function(e){g=e});a.j.subscribe("model:loaded",function(e){l=
e});this.M=function(){a.j.D("select:initialized",this)};this.select=function(e,d){return q(e,d)}};function eb(a){function q(N){return function(S){N.call(this,{x:S.x,y:S.y,scale:S.scale,ed:S.delta,ctrlKey:S.ctrlKey,metaKey:S.metaKey,altKey:S.altKey,shiftKey:S.shiftKey,lb:S.secondary,touches:S.touches})}}function l(){function N(S){return function(ca){ca.x*=Y/u.clientWidth;ca.y*=aa/u.clientHeight;return S(ca)}}"external"!==f.Ne&&("hammerjs"===f.Ne&&P.has(window,"Hammer")&&(ba.M(u),ba.A("tap",N(h.i),!0),ba.A("doubletap",N(h.u),!0),ba.A("hold",N(h.sa),!0),ba.A("touch",N(h.ua),!0),ba.A("release",N(h.wa),
!1),ba.A("dragstart",N(h.ga),!0),ba.A("drag",N(h.H),!0),ba.A("dragend",N(h.T),!0),ba.A("transformstart",N(h.pb),!0),ba.A("transform",N(h.transform),!0),ba.A("transformend",N(h.Ka),!0)),Q=new Ka(u),X=new Ja,Q.i(N(h.i)),Q.u(N(h.u)),Q.sa(N(h.sa)),Q.wa(N(h.ua)),Q.Ka(N(h.wa)),Q.ga(N(h.ga)),Q.H(N(h.H)),Q.T(N(h.T)),Q.ta(N(h.ta)),Q.Ja(N(h.ta)),Q.ua(N(h.Ja)),X.addEventListener("keyup",function(S){var ca=!1,I=void 0,T=f.yf({keyCode:S.keyCode,preventDefault:function(){ca=!0},preventOriginalEventDefault:function(){I=
"prevent"},allowOriginalEventDefault:function(){I="allow"}});"prevent"===I&&S.preventDefault();(ca=ca||0<=T.indexOf(!1))||27===S.keyCode&&a.j.D("interaction:reset")}))}function g(){t.pc(2)?a.j.D("interaction:reset"):t.normalize(f.ob,La.ia(f.Kb))}function e(N){return function(){w.empty()||N.apply(this,arguments)}}function d(N,S,ca){var I={},T={};return function(R){switch(N){case "click":var V=f.cf;break;case "doubleclick":V=f.df;break;case "hold":V=f.kf;break;case "hover":V=f.lf;break;case "mousemove":V=
f.nf;break;case "mousewheel":V=f.qf;break;case "mousedown":V=f.mf;break;case "mouseup":V=f.pf;break;case "dragstart":V=f.gf;break;case "drag":V=f.ef;break;case "dragend":V=f.ff;break;case "transformstart":V=f.xf;break;case "transform":V=f.vf;break;case "transformend":V=f.wf}var fa=!1,x=!V.empty(),A=t.absolute(R,I),F=(S||x)&&m(A),L=(S||x)&&c(A);x&&(x=F?F.group:null,A=F?F.Jb(A,T):A,R.Db=void 0,V=V({type:N,group:x,topmostClosedGroup:x,bottommostOpenGroup:L?L.group:null,x:R.x,y:R.y,xAbsolute:A.x,yAbsolute:A.y,
scale:P.I(R.scale,1),secondary:R.lb,touches:P.I(R.touches,1),delta:P.I(R.ed,0),ctrlKey:R.ctrlKey,metaKey:R.metaKey,altKey:R.altKey,shiftKey:R.shiftKey,preventDefault:function(){fa=!0},preventOriginalEventDefault:function(){R.Db="prevent"},allowOriginalEventDefault:function(){R.Db="allow"}}),fa=fa||0<=V.indexOf(!1),F&&F.attribution&&"click"===N&&(fa=!1));fa||ca&&ca({dd:F,vg:L},R)}}function p(N){function S(fa,x){var A=x.m;if(A){for(var F=-Number.MAX_VALUE,L,K=0;K<A.length;K++){var J=A[K];!J.description&&
J.Y&&ja(J,fa)&&J.scale>F&&(L=J,F=J.scale)}var W;L&&(W=S(fa,L));return W||L||x}return x}for(var ca=C.length,I=C[0].scale,T=C[0].scale,R=0;R<ca;R++){var V=C[R];V=V.scale;V<I&&(I=V);V>T&&(T=V)}if(I!==T)for(R=0;R<ca;R++)if(V=C[R],V.scale===T&&V.Y&&ja(V,N))return S(N,V);return S(N,w)}function m(N,S){if("flattened"===f.mb)N=p(N);else{S=S||0;for(var ca=C.length,I=void 0,T=0;T<ca;T++){var R=C[T];R.scale>S&&!1===R.open&&R.Y&&ja(R,N)&&(I=R,S=R.scale)}N=I}N&&N.description&&(N=N.parent);return N}function c(N){var S=
void 0,ca=0;Ra.sc(w,function(I){!0===I.open&&I.Y&&I.scale>ca&&ja(I,N)&&(S=I,ca=I.scale)});return S}var b=ea.Nh(),h=this,f=a.options,u,t,n,k,r,y,v,w,z=!1,E,D,G,O,H,B,M,Q,X,Y,aa;a.j.subscribe("stage:initialized",function(N,S,ca,I){u=S;Y=ca;aa=I;l()});a.j.subscribe("stage:resized",function(N,S,ca,I){Y=ca;aa=I});a.j.subscribe("stage:disposed",function(){Q.Za();ba.Za();X.i()});a.j.subscribe("expose:initialized",function(N){k=N});a.j.subscribe("zoom:initialized",function(N){t=N});a.j.subscribe("openclose:initialized",
function(N){r=N});a.j.subscribe("select:initialized",function(N){y=N});a.j.subscribe("titlebar:initialized",function(N){v=N});a.j.subscribe("timeline:initialized",function(N){n=N});var C;a.j.subscribe("model:loaded",function(N,S){w=N;C=S});a.j.subscribe("model:childrenAttached",function(N){C=N});this.M=function(){};this.ua=e(d("mousedown",!1,function(){t.Zh()}));this.wa=e(d("mouseup",!1,void 0));this.i=e(d("click",!0,function(N,S){S.lb||S.shiftKey||!(N=N.dd)||(N.attribution?S.ctrlKey?document.location.href=
Pa.Qf("iuuqr;..b`ssnurd`sbi/bnl.gn`lusdd"):(S=La.ia(f.Kb),N.be?(t.reset(f.ob,S),N.be=!1):(t.cg(N,f.Yb,f.ob,S),N.be=!0)):y.select({m:[N],Ca:!N.selected,Ba:S.metaKey||S.ctrlKey},!0))}));this.u=e(d("doubleclick",!0,function(N,S){var ca=N.dd;ca&&ca.attribution||(S.lb||S.shiftKey?ca&&(ca.parent.U&&(ca=ca.parent),N={m:ca.parent!==w?[ca.parent]:[],Ca:!0,Ba:!1},y.select(N,!0),k.Vb(N,!0,!0,!1)):ca&&(N={m:[ca],Ca:!0,Ba:!1},ca.Va=!0,a.j.D("foamtree:attachChildren",[ca]),k.Vb(N,!0,!0,!1)),ca&&n.K.A({}).wait(f.Oa/
2).call(function(){r.Bb({m:Ra.uc(w,function(I){return I.Bd&&!Ra.Lh(ca,I)}),Ca:!1,Ba:!0},!0,!0);ca.Bd=!0;r.Bb({m:[ca],Ca:!(S.lb||S.shiftKey),Ba:!0},!0,!0)}).start())}));this.sa=e(d("hold",!0,function(N,S){(N=(S=!(S.metaKey||S.ctrlKey||S.shiftKey)&&!S.lb)?N.dd:N.vg)&&N!==w&&r.Bb({m:[N],Ca:S,Ba:!0},!0,!1)}));this.ga=e(d("dragstart",!1,function(N,S){E=S.x;D=S.y;G=Date.now();z=!0}));this.H=e(d("drag",!1,function(N,S){if(z){N=Date.now();B=Math.min(1,N-G);G=N;N=S.x-E;var ca=S.y-D;t.Xh(N,ca);O=N;H=ca;E=S.x;
D=S.y}}));this.T=e(d("dragend",!1,function(){if(z){z=!1;var N=Math.sqrt(O*O+H*H)/B;4<=N?t.Yh(N,O,H):t.af()}}));this.pb=e(d("transformstart",!1,function(N,S){M=1;E=S.x;D=S.y}));var U=1,ha=!1;this.transform=e(d("transform",!1,function(N,S){N=S.scale-.01;t.qg(S,N/M,S.x-E,S.y-D);M=N;E=S.x;D=S.y;U=M;ha=ha||2<S.touches}));this.Ka=e(d("transformend",!1,function(){ha&&.8>U?a.j.D("interaction:reset"):g();ha=!1}));this.Ja=e(d("mousewheel",!1,function(){var N=P.zg(function(){g()},300);return function(S,ca){S=
f.lj;1!==S&&(S=Math.pow(S,ca.ed),b?(t.rg(ca,S),N()):t.Nb(ca,S,f.ob,La.ia(f.Kb)).then(g))}}()));this.ta=e(function(){var N=void 0,S={},ca=!1,I,T=d("hover",!1,function(){N&&(N.ub=!1,0<N.level&&(N.N=!0));I&&(I.ub=!0,0<I.level&&(I.N=!0));v.update(I);a.j.D("foamtree:dirty",!1)}),R=d("mousemove",!1,void 0);return function(V){if("out"===V.type)I=void 0,ca=I!==N;else if(t.absolute(V,S),N&&!N.open&&ja(N,S)){var fa=m(S,N.scale);fa&&fa!==N?(ca=!0,I=fa):ca=!1}else I=m(S),ca=I!==N;ca&&(T(V),N=I,ca=!1);N&&R(V)}}());
this.Lb={click:q(this.i),doubleclick:q(this.u),hold:q(this.sa),mouseup:q(this.wa),mousedown:q(this.ua),dragstart:q(this.ga),drag:q(this.H),dragend:q(this.T),transformstart:q(this.pb),transform:q(this.transform),transformend:q(this.Ka),hover:q(this.ta),mousewheel:q(this.Ja)};var ba=function(){function N(I,T){return function(R){R=R.gesture;var V=R.center;V=Ia.pe(u,V.pageX,V.pageY,{});V.scale=R.scale;V.lb=1<R.touches.length;V.touches=R.touches.length;I.call(u,V);(void 0===V.Db&&T||"prevent"===V.Db)&&
R.preventDefault()}}var S,ca={};return{M:function(I){S=window.Hammer(I,{doubletap_interval:350,hold_timeout:400,doubletap_distance:10})},A:function(I,T,R){ca[I]=T;S.on(I,N(T,R))},Za:function(){S&&P.Aa(ca,function(I,T){S.off(T,I)})}}}(),ja=function(){var N={};return function(S,ca){S.Jb(ca,N);return S.$&&wa.sa(S.$,N)}}()};function fb(a){function q(e,d,p,m){var c,b=0,h=[];for(c=0;c<d.length;c++){var f=Math.sqrt(wa.i(d[c],d[(c+1)%d.length]));h.push(f);b+=f}for(c=0;c<h.length;c++)h[c]/=b;e[0].x=p.x;e[0].y=p.y;var u=f=b=0;for(c=1;c<e.length;c++){var t=e[c],n=.95*Math.pow(c/e.length,m);for(b+=.3819;f<b;)f+=h[u],u=(u+1)%h.length;var k=(u-1+h.length)%h.length,r=1-(f-b)/h[k],y=d[k].x;k=d[k].y;var v=d[u].x,w=d[u].y;y=(y-p.x)*n+p.x;k=(k-p.y)*n+p.y;v=(v-p.x)*n+p.x;w=(w-p.y)*n+p.y;t.x=y*(1-r)+v*r;t.y=k*(1-r)+w*r}}var l={random:{vb:function(e,
...
var g=a.options;this.i=function(e,d,p){if(0<e.length){p=l[p.relaxationInitializer||p.initializer||g.Li||"random"];if("box"===p.Ob){var m=wa.F(d,{});p.vb(e,m);wa.wa(e,wa.H(m),d)}else p.vb(e,d,wa.u(d,{}));for(p=e.length-1;0<=p;p--){m=e[p];if(m.description){var c=wa.ta(d,g.qc,g.Bg);m.x=c.x;m.y=c.y}m.attribution&&(c=wa.ta(d,g.$d,g.sg),m.x=c.x,m.y=c.y);P.wb(m.group.initialPosition)&&(c=m.group.initialPosition,c=wa.ta(d,c.position||"bottomright",c.distanceFromCenter||1),m.x=c.x,m.y=c.y)}}}};function hb(a){var q,l=a.options,g=new ib(a,this),e=new jb(a,this),d={relaxed:g,ordered:e,squarified:e},p=d[a.options.Dc]||g;this.kg=5E-5;a.j.subscribe("model:loaded",function(m){q=m});a.j.subscribe("options:changed",function(m){m.layout&&P.has(d,l.Dc)&&(p=d[l.Dc])});this.step=function(m,c,b,h){return p.step(m,c,b,h)};this.complete=function(m){p.complete(m)};this.Pe=function(m){return m===q?!0:2*Math.sqrt(m.O.ha/(Math.PI*m.m.length))>=Math.max(l.Ce,5E-5)};this.gd=function(m,c){var b=Math.pow(l.La,
m.level),h=l.$a*b;b*=l.jd;m=m.m;for(var f=m.length-1;0<=f;f--){var u=m[f];p.ce(u,b);var t=u;t.$=0<h?Ta.i(t.C,h):t.C;t.$&&(wa.F(t.$,t.F),wa.Ja(t.$,t.O));u.m&&c.push(u)}};this.fc=function(m){p.fc(m)};this.Eb=function(m){p.Eb(m)}};function ib(a,q){function l(n){if(n.m){n=n.m;for(var k=0;k<n.length;k++){var r=n[k];r.kc=r.hc*f.qh}}}function g(n,k){q.Pe(n)&&(n.G||(n.G=Ta.i(n.C,f.jd*Math.pow(f.La,n.level-1)),n.G&&n.m[0]&&n.m[0].description&&"stab"==f.Tb&&m(n)),n.G&&(b.Eb(n),u.i(e(n),n.G,n.group),n.R=!0,k(n)),l(n))}function e(n){return"stab"===f.Tb&&0<n.m.length&&n.m[0].description?n.m.slice(1):n.m}function d(n){var k=e(n);Ua.i(k,n.G);Ua.u(k,n.G);return Va.H(n)*Math.sqrt(h.O.ha/n.O.ha)}function p(n){return n<f.If||1E-4>n}function m(n){var k=
f.Sb/(1+f.Sb),r=wa.F(n.G,{}),y={x:r.x,y:0},v=r.y,w=r.o,z=f.ie*Math.pow(f.La,n.level-1),E=w*f.he,D=f.qc;"bottom"==D||0<=D&&180>D?(D=Math.PI,v+=w,w=-1):(D=0,w=1);var G=n.G,O=D,H=0,B=1,M=wa.u(G,{}),Q=M.ha;k*=Q;for(var X=0;H<B&&20>X++;){var Y=(H+B)/2;y.y=r.y+r.o*Y;var aa=wa.ua(G,y,O);wa.u(aa[0],M);var C=M.ha-k;if(.01>=Math.abs(C)/Q)break;else 0<(0==O?1:-1)*C?B=Y:H=Y}wa.F(aa[0],r);if(r.o<z||r.o>E)y.y=r.o<z?v+w*Math.min(z,E):v+w*E,aa=wa.ua(n.G,y,D);n.m[0].C=aa[0];n.G=aa[1]}function c(n){n!==h&&2*Math.sqrt(n.O.ha/
(Math.PI*n.m.length))<Math.max(.85*f.Ce,q.kg)&&(n.R=!1,n.xa=!1,n.Ia=!0,n.G=null)}var b=this,h,f=a.options,u=new fb(a),t=0;a.j.subscribe("model:loaded",function(n){h=n;t=0});this.step=function(n,k,r,y){function v(G){G.R&&G.xa?c(G):G.Ia&&G.C&&g(G,function(){var H=e(G);Ua.i(H,G.G);Ua.u(H,G.G);n(G)});if(!G.G||!G.R)return 0;if(G.parent&&G.parent.Z||G.Ea){var O=d(G);y&&y(G);G.Ea=!p(O)&&!r;G.Z=!0}else O=0;q.gd(G,E);return O}function w(G,O,H){t<G&&(t=G);var B=f.If;f.Ad(O?1:1-(G-B)/(t-B||1),O,H);O&&(t=0)}
...
this.Eb=function(n){for(var k=e(n),r=n.ha,y,v=y=0;v<k.length;v++)y+=k[v].weight;n.Gj=y;for(n=0;n<k.length;n++)v=k[n],v.Wf=v.w,v.hc=r/Math.PI*(0<y?v.weight/y:1/k.length)}};function jb(a,q){function l(b,h){if(q.Pe(b)){if(!b.G||b.parent&&b.parent.Z){var f=m.jd*Math.pow(m.La,b.level-1);b.G=wa.H(e(wa.F(b.C,{}),f))}b.G&&(b.R=!0,h(b))}else b.R=!1,Ra.za(b,function(u){u.G=null})}function g(b){function h(t){function n(){r.C=wa.H(y);r.x=y.x+y.w/2;r.y=y.y+y.o/2}var k=m.Sb/(1+m.Sb),r=t.m[0],y=wa.F(t.G,{}),v=y.o;k=Math.min(Math.max(v*k,m.ie*Math.pow(m.La,t.level-1)),v*m.he);var w=m.qc;"bottom"==w||0<=w&&180>w?(y.o=v-k,t.G=wa.H(y),y.y+=v-k,y.o=k,n()):(y.o=k,n(),y.y+=k,y.o=v-k,t.G=
...
518.1);a.quadraticCurveTo(3301,564.8,3207.6,564.8);a.quadraticCurveTo(3139.1,564.8,3095.5,521.2);a.quadraticCurveTo(3051.9,477.6,3051.9,409.1);a.closePath();a.moveTo(3269.9,378);a.quadraticCurveTo(3269.9,353.1,3251.2,339.1);a.quadraticCurveTo(3232.5,325.1,3207.6,325.1);a.quadraticCurveTo(3182.7,325.1,3164,339.1);a.quadraticCurveTo(3145.3,353.1,3145.3,378);a.lineTo(3269.8,378);a.closePath();a.fill();a.restore()}};kb.ke={width:445.2,height:533.5};function lb(a,q){function l(x,A){var F=x.O.r,L=F/15,K=.5*F/15;F/=5;var J=x.O.x;x=x.O.y;A.fillRect(J-K,x-K,L,L);A.fillRect(J-K-F,x-K,L,L);A.fillRect(J-K+F,x-K,L,L)}function g(x,A,F,L){null===x&&F.clearRect(0,0,O,H);var K,J=Array(T.length);for(K=T.length-1;0<=K;K--)J[K]=T[K].na(F,L);for(K=T.length-1;0<=K;K--)J[K]&&T[K].before(F,L);X.rc([F,G],function(W){var Z;if(null!==x){F.save();F.globalCompositeOperation="destination-out";F.fillStyle=F.strokeStyle="rgba(255, 255, 255, 1)";for(Z=x.length-1;0<=Z;Z--){var ia=
x[Z],la=ia.C;la&&(F.save(),F.beginPath(),ia.Ib(F),ya.Ud(F,la),F.fill(),ia=C.$a*Math.pow(C.La,ia.level-1),0<ia&&(F.lineWidth=ia/2,F.stroke()),F.restore())}F.restore()}W=W.scale;if(0!==A.length){Z={};for(la=T.length-1;0<=la;la--)T[la].og(Z);for(ia=I.length-1;0<=ia;ia--)if(la=I[ia],Z[la.id]){var qa=la.Kd;for(la=0;la<A.length;la++){var oa=A[la];!oa.parent||oa.parent.xa&&oa.parent.R?qa(oa,W):oa.aa.clear()}}}for(Z=T.length-1;0<=Z;Z--)ia=T[Z],J[Z]&&ia.Nd(A,F,W)});for(K=T.length-1;0<=K;K--)J[K]&&T[K].after(F);
C.Zc&&(F.canvas.style.opacity=.99,setTimeout(function(){F.canvas.style.opacity=1},1))}function e(x){k===y?x<.9*u&&(k=r,w=z,c()):x>=u&&(k=y,w=E,c())}function d(){function x(K,J,W){K.sb=Math.floor(1E3*K.scale)-W*J;0<K.opacity&&!K.open&&J++;var Z=K.m;if(Z)for(var ia=Z.length-1;0<=ia;ia--)K.W&&x(Z[ia],J,W)}var A=null,F=null,L=null;X.rc([],function(K){e(K.scale);var J=!1;Ra.L(U,function(da){da.W&&(J=da.vd()||J,da.cc(),da.Ma=M.i(da)||da.Ma)});J&&(U.N=!0);var W="onSurfaceDirty"===C.Ng;Ra.fd(U,function(da){da.parent&&
da.parent.Z&&(da.aa.clear(),da.Ma=!0,W||(da.oc=!0,da.Qb.clear()));W&&(da.oc=!0,da.Qb.clear())});var Z=K.scale*K.scale;Ra.fd(U,function(da){if(da.R){for(var ma=da.m,sa=0;sa<ma.length;sa++)if(5<ma[sa].O.ha*Z){da.X=!0;return}da.X=!1}});f(K);L=[];Ra.tc(U,function(da){if(da.parent.X&&da.Y&&da.W){L.push(da);for(var ma=da.parent;ma!==U&&(ma.open||0===ma.opacity);)ma=ma.parent;ma!==U&&.02>Math.abs(ma.scale-da.scale)&&(da.scale=Math.min(da.scale,ma.scale))}});x(U,0,"flattened"===C.mb?-1:1);L.sort(function(da,
ma){return da.sb-ma.sb});if(p())A=L,F=null;else{var ia={},la={},qa="none"!=C.ld&&C.$a<C.ab/2,oa=C.$a<C.yc/2+C.kd*C.Ee.a;Ra.L(U,function(da){if(da.W&&!da.description&&(da.Z||da.N||da.Fc&&da.parent.X&&da.Ma)){var ma,sa,ua=[da],va=da.J||da.parent.m;if(qa)for(ma=0;ma<va.length;ma++)(sa=va[ma])&&ua.push(sa);else if(oa)if(!da.selected&&da.Sa){sa=!0;for(ma=0;ma<va.length;ma++)va[ma]?ua.push(va[ma]):sa=!1;!sa&&1<da.level&&ua.push(da.parent)}else for(ma=0;ma<va.length;ma++)(sa=va[ma])&&sa.selected&&ua.push(sa);
var za;for(ma=da.parent;ma!=U;)ma.selected&&(za=ma),ma=ma.parent;za&&ua.push(za);for(ma=0;ma<ua.length;ma++){za=ua[ma];for(da=za.parent;da&&da!==U;)0<da.opacity&&(za=da),da=da.parent;la[za.id]=!0;Ra.za(za,function(rb){ia[rb.id]=!0})}}});A=L.filter(function(da){return ia[da.id]});F=A.filter(function(da){return la[da.id]})}});(function(){var K=!1;C.Hf&&Ra.L(U,function(J){if(J.W&&0!==J.pa.a&&1!==J.pa.a)return K=!0,!1});K?(Ra.sc(U,function(J){if(J.W&&(J.opacity!==J.Jc||J.Fa)){var W=J.m;if(W){for(var Z=
0,ia=W.length-1;0<=ia;ia--)Z=Math.max(Z,W[ia].Ec);J.Ec=Z+J.opacity*J.pa.a}else J.Ec=J.opacity*J.pa.a}}),Ra.L(U,function(J){if(J.W&&(J.opacity!==J.Jc||J.Fa)){for(var W=J.Ec,Z=J;(Z=Z.parent)&&Z!==U;)W+=Z.opacity*Z.pa.a*C.Ff;J.$c=0<W?1-Math.pow(1-J.pa.a,1/W):0;J.Jc=J.opacity}})):Ra.L(U,function(J){J.W&&(J.$c=1,J.Jc=-1)})})();return{bg:A,ag:F,Y:L}}function p(){var x=U.Z||U.N||"none"==C.Le;if(!x&&!U.empty()){var A=U.m[0].scale;Ra.L(U,function(F){if(F.W&&F.Y&&F.scale!==A)return x=!0,!1})}!x&&0<C.ye&&1!=
C.Pa&&Ra.L(U,function(F){if(F.W&&0<F.ja)return x=!0,!1});"accurate"==C.Le&&(x=(x=x||0===C.$a)||"none"!=C.ld&&C.$a<C.ab/2,!x&&C.$a<C.yc/2+C.kd*C.Ee.a&&Ra.L(U,function(F){if(F.W&&(F.selected&&!F.Sa||!F.selected&&F.Sa))return x=!0,!1}));return x}function m(){if(C.B!==C.nb)return!0;var x="polygonPlainFill polygonPlainStroke polygonGradientFill polygonGradientStroke labelPlainFill contentDecoration".split(" ");Ra.L(U,function(L){if(L.W&&L.U)return x.push("polygonExposureShadow"),!1});for(var A=x.length-
1;0<=A;A--){var F=x[A];if(!!ba[F]!==!!N[F])return!0}return!1}function c(){function x(J,W,Z,ia,la){function qa(da,ma,sa,ua,va){da[ua]&&(ma-=sa*t[ua],da[ua]=!1,va&&(ma+=sa*t[va],da[va]=!0));return ma}J=P.extend({},J);switch(Z){case "never":J.labelPlainFill=!1;break;case "always":case "auto":J.labelPlainFill=!0}if(C.xc)switch(ia){case "never":J.contentDecoration=!1;break;case "always":case "auto":J.contentDecoration=!0}else J.contentDecoration=!1;var oa=0;P.Aa(J,function(da,ma){da&&(oa+=W*t["contentDecoration"===
ma?"labelPlainFill":ma])});J.polygonExposureShadow=A;oa+=2*t.polygonExposureShadow;if(oa<=la||(oa=qa(J,oa,2,"polygonExposureShadow"))<=la||(oa=qa(J,oa,W,"polygonGradientFill","polygonPlainFill"))<=la||(oa=qa(J,oa,W,"polygonGradientStroke"))<=la||(oa=qa(J,oa,W,"polygonPlainStroke"))<=la||"auto"===ia&&(oa=qa(J,oa,W,"contentDecoration"))<=la)return J;"auto"===Z&&(oa=qa(J,oa,W,"labelPlainFill"));return J}var A=k===r,F=0,L=0;Ra.oe(U,function(J){var W=1;Ra.L(J,function(){W++});F+=W;L=Math.max(L,W)});var K=
{};switch(C.Wg){case "plain":K.polygonPlainFill=!0;break;case "gradient":K.polygonPlainFill=!A,K.polygonGradientFill=A}switch(C.ld){case "plain":K.polygonPlainStroke=!0;break;case "gradient":K.polygonPlainStroke=!A,K.polygonGradientStroke=A}ba=x(K,F,C.jj,C.hj,C.ij);N=x(K,2*L,"always","always",C.Fg);ja=x(K,F,"always","always",C.Eg)}function b(x){return function(A,F){return A===k?!0===ba[x]:!0===(F?N:ja)[x]}}function h(x,A){return function(F,L){return x(F,L)&&A(F,L)}}function f(x){U.Y=!0;Ra.fd(U,function(A){if(A.W&&
A.X&&A.xa&&A.R&&(U.N||A.Z||A.Vd)){A.Vd=!1;var F=A.m,L={x:0,y:0,w:0,o:0},K=!!A.G;if(1<O/x.w){var J;for(J=F.length-1;0<=J;J--)F[J].Y=!1;if(A.Y&&K)for(J=F.length-1;0<=J;J--)if(A=F[J],1!==A.scale&&(A.Jb(x,L),L.w=x.w/A.scale,L.o=x.o/A.scale),!1===A.Y&&A.C){K=A.C;var W=K.length;if(wa.sa(A.C,1===A.scale?x:L))A.Y=!0;else for(var Z=0;Z<W;Z++)if(wa.Vc(K[Z],K[(Z+1)%W],1===A.scale?x:L)){A.Y=!0;A.J&&(A=A.J[Z])&&(F[A.index].Y=!0);break}}}else for(J=0;J<F.length;J++)F[J].Y=K}})}var u=ea.Te()?50:1E4,t,n,k,r,y,v,
w,z,E,D,G,O,H,B,M=new mb(a),Q=new nb(a),X,Y,aa,C=a.options,U,ha,ba,ja,N;a.j.subscribe("stage:initialized",function(x,A,F,L){B=x;O=F;H=L;n=B.dc("wireframe",C.nb,!1);r=n.getContext("2d");y=new xa(r);v=B.dc("hifi",C.B,!1);z=v.getContext("2d");E=new xa(z);k=r;w=z;r.B=C.nb;y.B=C.nb;z.B=C.B;E.B=C.B;D=B.dc("tmp",Math.max(C.B,C.nb),!0);G=D.getContext("2d");G.B=1;[r,z,G].forEach(function(K){K.scale(K.B,K.B)})});a.j.subscribe("stage:resized",function(x,A,F,L){O=F;H=L;[r,z,G].forEach(function(K){K.scale(K.B,
K.B)})});a.j.subscribe("model:loaded",function(x){function A(F){var L=0;if(!F.empty()){for(var K=F.m,J=K.length-1;0<=J;J--)L=Math.max(L,A(K[J]));L+=1}return F.Tf=L}U=x;ha=!0;A(U);c();a.j.D("render:renderers:resolved",ba,N,ja)});var S="groupFillType groupStrokeType wireframeDrawMaxDuration wireframeLabelDrawing wireframeContentDecorationDrawing finalCompleteDrawMaxDuration finalIncrementalDrawMaxDuration groupContentDecorator".split(" "),ca=["groupLabelLightColor","groupLabelDarkColor","groupLabelColorThreshold",
"groupUnexposureLabelColorThreshold"];a.j.subscribe("options:changed",function(x){function A(L,K,J,W){B.Ki(L,J);K.B=J;W&&K.scale(J,J)}x.dataObject||(P.bb(x,S)&&c(),P.bb(x,ca)&&Ra.L(U,function(L){L.hd=-1}));var F=P.has(x,"pixelRatio");x=P.has(x,"wireframePixelRatio");if(F||x)F&&A(v,w,C.B,!0),x&&A(n,k,C.nb,!0),A(D,G,Math.max(C.B,C.nb),!1)});a.j.subscribe("zoom:initialized",function(x){X=x});a.j.subscribe("timeline:initialized",function(x){Y=x});a.j.subscribe("api:initialized",function(x){aa=x});var I=
[{id:"offsetPolygon",Kd:function(x){if((x.selected||0<x.opacity&&!1===x.open||!x.X)&&x.aa.Ga()){var A=x.aa;A.clear();if(x.$){var F=x.$,L=C.Ig;0<L?ya.Wi(A,F,x.parent.O.r/32,Math.min(1,L*Math.pow(1-C.Jg*L,x.Tf))):ya.Ud(A,F)}x.Dd=!0}}},{id:"label",Kd:function(x){x.Ma&&x.Fc&&M.u(x)}},{id:"custom",Kd:function(x,A){if(x.$&&(0<x.opacity&&(!1===x.open||!0===x.selected)||!x.X)&&x.oc&&a.options.xc&&!x.attribution){var F={};aa.Xc(F,x);aa.Yc(F,x);aa.Wc(F,x,!0);F.context=x.Qb;F.polygonContext=x.aa;F.labelContext=
x.Bc;F.shapeDirty=x.Dd;F.viewportScale=A;A={groupLabelDrawn:!0,groupPolygonDrawn:!0};a.options.Mg(a.Cd,F,A);x.Ue=A.groupLabelDrawn;x.Ed=A.groupPolygonDrawn;x.Dd=!1;x.oc=!1}}}].reverse(),T=[new function(x){var A=Array(x.length);this.Nd=function(F,L,K){if(0!==F.length){var J,W=[],Z=F[0].sb;for(J=0;J<F.length;J++){var ia=F[J];ia.sb!==Z&&(W.push(J),Z=ia.sb)}W.push(J);for(var la=Z=0;la<W.length;la++){for(var qa=W[la],oa=x.length-1;0<=oa;oa--)if(A[oa]){var da=x[oa];L.save();for(J=Z;J<qa;J++)ia=F[J],L.save(),
ia.Ib(L),da.kb.call(da,ia,L,K),L.restore();da.Wa.call(da,L,K);L.restore()}Z=qa}}};this.na=function(F,L){for(var K=!1,J=x.length-1;0<=J;J--)A[J]=x[J].na(F,L),K|=A[J];return K};this.before=function(F,L){for(var K=x.length-1;0<=K;K--)if(A[K]){var J=x[K];J.before.call(J,F,L)}};this.after=function(F){for(var L=x.length-1;0<=L;L--)if(A[L]){var K=x[L];K.after.call(K,F)}};this.og=function(F){for(var L=x.length-1;0<=L;L--){var K=x[L];if(A[L])for(var J=K.Ra.length-1;0<=J;J--)F[K.Ra[J]]=!0}}}([{Ra:["offsetPolygon"],
na:b("polygonExposureShadow"),before:function(x){G.save();G.scale(x.B,x.B)},after:function(){G.restore()},rb:function(){},Wa:function(x){this.Sf&&(this.Sf=!1,x.save(),x.setTransform(1,0,0,1,0,0),x.drawImage(D,0,0,x.canvas.width,x.canvas.height,0,0,x.canvas.width,x.canvas.height),x.restore(),G.save(),G.setTransform(1,0,0,1,0,0),G.clearRect(0,0,D.width,D.height),G.restore())},kb:function(x,A,F){if(!(x.open&&x.X||x.aa.Ga())){var L=C.ye*x.opacity*x.ja*("flattened"===C.mb?1-x.parent.ja:(1-x.Cb)*x.parent.Cb)*
(1.1<=C.Pa?1:(C.Pa-1)/.1);0<L&&(G.save(),G.beginPath(),x.Ib(G),x.aa.Na(G),G.shadowBlur=F*A.B*L,G.shadowColor=C.Og,G.fillStyle="rgba(0, 0, 0, 1)",G.globalCompositeOperation="source-over",G.globalAlpha=x.opacity,G.fill(),G.shadowBlur=0,G.shadowColor="transparent",G.globalCompositeOperation="destination-out",G.fill(),G.restore(),this.Sf=!0)}}},{Ra:["offsetPolygon"],na:function(){return!0},before:function(){function x(K){var J=K.pa,W=K.ub,Z=K.selected,ia=(J.h+(W?C.$g:0)+(Z?C.rh:0))%360,la=A(J.l*K.va+
(W?C.ah:0)+(Z?C.sh:0));J=A(J.s*K.saturation+(W?C.bh:0)+(Z?C.th:0));K=K.xe;K.h=ia;K.s=J;K.l=la;return K}function A(K){return 100<K?100:0>K?0:K}var F=[{type:"fill",na:b("polygonPlainFill"),Pc:function(K,J){J.fillStyle=Ea.H(x(K))}},{type:"fill",na:b("polygonGradientFill"),Pc:function(K,J){var W=K.O.r,Z=x(K);W=J.createRadialGradient(K.x,K.y,0,K.x,K.y,W*C.Sg);var ia=Z.l,la=C.Qg;W.addColorStop(0,Ea.i((Z.h+C.Pg)%360,A(Z.s+C.Rg),A(ia+la)));ia=Z.l;la=C.Ug;W.addColorStop(1,Ea.i((Z.h+C.Tg)%360,A(Z.s+C.Vg),A(ia+
la)));K.aa.Na(J);J.fillStyle=W}},{type:"stroke",na:h(b("polygonPlainStroke"),function(){return 0<C.ab}),Pc:function(K,J){var W=K.pa,Z=K.ub,ia=K.selected,la=(W.h+C.Ie+(Z?C.ze:0)+(ia?C.Fe:0))%360,qa=A(W.s*K.saturation+C.Ke+(Z?C.Be:0)+(ia?C.He:0));W=A(W.l*K.va+C.Je+(Z?C.Ae:0)+(ia?C.Ge:0));J.strokeStyle=Ea.i(la,qa,W);J.lineWidth=C.ab*Math.pow(C.La,K.level-1)}},{type:"stroke",na:h(b("polygonGradientStroke"),function(){return 0<C.ab}),Pc:function(K,J){var W=K.O.r*C.zh,Z=K.pa,ia=Math.PI*C.vh/180;W=J.createLinearGradient(K.x+
W*Math.cos(ia),K.y+W*Math.sin(ia),K.x+W*Math.cos(ia+Math.PI),K.y+W*Math.sin(ia+Math.PI));var la=K.ub,qa=K.selected;ia=(Z.h+C.Ie+(la?C.ze:0)+(qa?C.Fe:0))%360;var oa=A(Z.s*K.saturation+C.Ke+(la?C.Be:0)+(qa?C.He:0));Z=A(Z.l*K.va+C.Je+(la?C.Ae:0)+(qa?C.Ge:0));la=C.xh;W.addColorStop(0,Ea.i((ia+C.wh)%360,A(oa+C.yh),A(Z+la)));la=C.Bh;W.addColorStop(1,Ea.i((ia+C.Ah)%360,A(oa+C.Ch),A(Z+la)));J.strokeStyle=W;J.lineWidth=C.ab*Math.pow(C.La,K.level-1)}}],L=Array(F.length);return function(K,J){for(var W=F.length-
1;0<=W;W--)L[W]=F[W].na(K,J);this.$i=F;this.wg=L}}(),after:function(){},rb:function(){},Wa:function(){},kb:function(x,A){if(!(!x.Ed||(0===x.opacity||x.open)&&x.X||x.aa.Ga()||!C.je&&x.description)){var F=this.$i,L=this.wg;A.beginPath();x.aa.Na(A);for(var K=!1,J=!1,W=F.length-1;0<=W;W--){var Z=F[W];if(L[W])switch(Z.Pc(x,A),Z.type){case "fill":K=!0;break;case "stroke":J=!0}}F=(x.X?x.opacity:1)*x.pa.a;L=!x.empty();W=C.Hf?x.$c:1;K&&(x=L&&x.X&&x.R&&x.m[0].W?1-x.m.reduce(function(ia,la){return ia+la.ra*
la.Hd},0)/x.m.length*(1-C.Ff):1,A.globalAlpha=F*x*W,ob(A));J&&(A.globalAlpha=F*(L?C.$h:1)*W,A.closePath(),pb(A),A.stroke())}}},{Ra:["offsetPolygon"],na:function(){return 0<C.yc},before:function(){},after:function(){},rb:function(){},Wa:function(){},kb:function(x,A,F){if(x.Ed&&x.selected&&!x.aa.Ga()){A.globalAlpha=x.Da;A.beginPath();var L=Math.pow(C.La,x.level-1);A.lineWidth=C.yc*L;A.strokeStyle=C.uh;var K=C.kd;0<K&&(A.shadowBlur=K*L*F*A.B,A.shadowColor=C.De);x.aa.Na(A);A.closePath();A.stroke()}}},
{Ra:[],na:function(){return!0},before:function(){},after:function(){},rb:function(){},Wa:function(){},Rh:kb,kb:function(x,A){function F(K,J,W){var Z=wa.Ka(x.$,x.O,K/J);Z=Math.min(Math.min(.9*Z,.5*x.F.o)/J,.5*x.F.w/K);A.save();A.translate(x.x,x.y);A.globalAlpha=x.opacity*x.ca;A.scale(Z,Z);A.translate(-K/2,-J/2);W(A);A.restore()}var L=this.Rh;x.attribution&&!x.aa.Ga()&&F(L.ke.width,L.ke.height,function(K){L.Hg(K,C.ae)})}},{Ra:[],na:function(x,A){return function(F,L){return x(F,L)||A(F,L)}}(b("labelPlainFill"),
h(b("contentDecoration"),function(){return C.xc})),before:function(){},after:function(){},rb:function(){},Wa:function(){},kb:function(x,A,F){(0<x.opacity&&0<x.ca&&!x.open||!x.X)&&!x.aa.Ga()&&(x.Cc=x.oa&&x.oa.ka&&C.B*x.oa.fontSize*x.scale*F>=C.oh,"auto"===x.pd?!C.je&&x.description?x.fb=x.parent.fb:(F=x.xe,A=F.h+(F.s<<9)+(F.l<<16),x.hd!==A&&(F=Ea.T(F),x.fb=F>(0>x.ja?C.Dh:C.dh)?C.eh:C.nh,x.hd=A)):x.fb=x.pd)}},{Ra:["custom"],na:h(b("contentDecoration"),function(){return C.xc}),before:function(){},after:function(){},
rb:function(){},Wa:function(){},kb:function(x,A){!(0<x.opacity&&0<x.ca&&!x.open||!x.X)||x.Qb.Ga()||x.aa.Ga()||(x.Cc||void 0===x.oa?(A.globalAlpha=x.ca*(x.X?x.opacity:1)*(x.empty()?1:C.Gf),A.fillStyle=x.fb,A.strokeStyle=x.fb,x.Qb.Na(A)):l(x,A))}},{Ra:["label"],na:b("labelPlainFill"),before:function(){},after:function(){},rb:function(){},Wa:function(){},kb:function(x,A,F){x.Ue&&x.Fc&&(0<x.opacity&&0<x.ca&&!x.open||!x.X)&&!x.aa.Ga()&&x.oa&&(A.fillStyle=x.fb,A.globalAlpha=x.ca*(x.X?x.opacity:1)*(x.empty()?
1:C.Gf),x.Cc?qb(x,A,F):l(x,A))}}].reverse())];this.M=function(){t=Ma.Jh(function(){return Aa.estimate()},"CarrotSearchFoamTree",12096E5)(sb());Q.M()};this.clear=function(){k.clearRect(0,0,O,H);w.clearRect(0,0,O,H)};var R=!1,V=void 0;this.u=function(x){R?V=x:x()};this.Nd=function(){function x(){window.clearTimeout(A);R=!0;A=setTimeout(function(){R=!1;if(m()){var L=!p();g(null,F.Y,w,L);P.defer(function(){fa.Xi();V&&(V(),V=void 0)})}else V&&(V(),V=void 0)},Math.max(C.kj,3*q.Xf.sd,3*q.Xf.rd))}var A,F;
return function(L){tb(Q);F=d();var K=null!==F.ag,J=0<B.$b("hifi"),W=J&&(K||!L);L=K||ha||!L;ha=!1;J&&!W&&fa.Yi();g(F.ag,F.bg,W?w:k,L);Ra.za(U,function(Z){Z.Z=!1;Z.N=!1;Z.Sa=!1});W||x();C.Bf(K)}}();this.i=function(x){x=x||{};tb(Q);U.N=!0;var A=d(),F=C.B;try{var L=P.I(x.pixelRatio,C.B);C.B=L;var K=B.dc("export",L,!0),J=K.getContext("2d");k===y&&(J=new xa(J));J.scale(L,L);var W=P.has(x,"backgroundColor");W&&(J.save(),J.fillStyle=x.backgroundColor,J.fillRect(0,0,O,H),J.restore());g(W?[]:null,A.bg,J,!0)}finally{C.B=
F}return K.toDataURL(P.I(x.format,"image/png"),P.I(x.quality,.8))};var fa=function(){function x(L,K,J,W,Z,ia){function la(ma,sa,ua,va){return Y.K.A({opacity:B.$b(ma)}).fa({duration:ua,P:{opacity:{end:sa,easing:va}},ba:function(){B.$b(ma,this.opacity)}}).done()}var qa=P.od(B.$b(L),K),oa=P.od(B.$b(W),Z);if(!qa||!oa){for(var da=F.length-1;0<=da;da--)F[da].stop();F=[];qa||F.push(la(L,K,J,La.Gb));oa||F.push(la(W,Z,ia,La.Uf));return Y.K.A({}).Qa(F).start()}}var A,F=[];return{Yi:function(){C.Zc?1!==n.style.opacity&&
(n.style.visibility="visible",v.style.visibility="hidden",n.style.opacity=1,v.style.opacity=0):A&&A.xb()||(A=x("wireframe",1,C.te,"hifi",0,C.te))},Xi:function(){C.Zc?(v.style.visibility="visible",n.style.visibility="hidden",n.style.opacity=0,v.style.opacity=1):x("hifi",1,C.eg,"wireframe",0,C.eg)}}}();tb=function(x){x.apply()};ob=function(x){x.fill()};pb=function(x){x.stroke()};return this}var ob,pb,tb;function mb(a){function q(c){"undefined"!==typeof c.groupLabelFontFamily&&(g.fontFamily=c.groupLabelFontFamily);"undefined"!==typeof c.groupLabelFontStyle&&(g.fontStyle=c.groupLabelFontStyle);"undefined"!==typeof c.groupLabelFontVariant&&(g.fontVariant=c.groupLabelFontVariant);"undefined"!==typeof c.groupLabelFontWeight&&(g.fontWeight=c.groupLabelFontWeight);"undefined"!==typeof c.groupLabelLineHeight&&(g.lineHeight=c.groupLabelLineHeight);"undefined"!==typeof c.groupLabelHorizontalPadding&&(g.cb=
c.groupLabelHorizontalPadding);"undefined"!==typeof c.groupLabelVerticalPadding&&(g.Ua=c.groupLabelVerticalPadding);"undefined"!==typeof c.groupLabelMaxTotalHeight&&(g.ib=c.groupLabelMaxTotalHeight);"undefined"!==typeof c.groupLabelMaxFontSize&&(g.hb=c.groupLabelMaxFontSize)}var l=a.options,g={},e={},d,p={groupLabel:""},m={};a.j.subscribe("api:initialized",function(c){d=c});a.j.subscribe("options:changed",q);q(a.Cd);this.i=function(c){if(!c.$)return!1;var b=c.group.label;l.gh&&!c.attribution&&(p.labelText=
b,d.nc(l.fh,c,p),b=p.labelText);c.Ve=b;return c.qd!==b};this.u=function(c){var b=c.Ve;c.qd=b;c.Bc.clear();c.oa=void 0;if(c.$&&!P.Oe(b)&&("flattened"!==l.mb||c.empty()||!c.R||!c.m[0].W)){var h=ta,f=h.de;if(l.mh){m.fontFamily=g.fontFamily;m.fontStyle=g.fontStyle;m.fontVariant=g.fontVariant;m.fontWeight=g.fontWeight;m.lineHeight=g.lineHeight;m.horizontalPadding=g.cb;m.verticalPadding=g.Ua;m.maxTotalTextHeight=g.ib;m.maxFontSize=g.hb;d.nc(l.lh,c,m);e.fontFamily=m.fontFamily;e.fontStyle=m.fontStyle;e.fontVariant=
m.fontVariant;e.fontWeight=m.fontWeight;e.lineHeight=m.lineHeight;e.cb=m.horizontalPadding;e.Ua=m.verticalPadding;e.ib=m.maxTotalTextHeight;e.hb=m.maxFontSize;var u=e}else u=g;c.oa=f.call(h,u,c.Bc,b,c.$,c.F,c.O,!1,!1,c.Oh,c.O.ha,l.ph,c.Ma)}c.Ma=!1};qb=this.H=function(c,b){c.Bc.Na(b)}}var qb;function nb(a){function q(b,h){var f=b.m,u=f.length,t,n=m.O.r;for(t=0;t<u;t++){var k=f[t];k.tb=(180*(Math.atan2(k.x-b.x,k.y-b.y)+h)/Math.PI+180)/360;k.wc=Math.min(1,Math.sqrt(wa.i(k,b))/n)}}function l(b,h){b=b.m;var f=b.length;if(1===f||2===f&&b[0].description)b[0].tb=.5;else{var u=0,t=Number.MAX_VALUE,n=Math.sin(h),k=Math.cos(h);for(h=0;h<f;h++){var r=b[h];var y=r.x*n+r.y*k;u<y&&(u=y);t>y&&(t=y);r.tb=y;r.wc=1}for(h=0;h<f;h++)r=b[h],r.tb=(r.tb-t)/(u-t)}}function g(b,h,f,u){h=h[u];return h+(f[u]-h)*
b}var e={radial:q,linear:l},d=a.options,p,m,c={groupColor:null,labelColor:null};a.j.subscribe("model:loaded",function(b){m=b});a.j.subscribe("api:initialized",function(b){p=b});this.M=function(){};this.apply=function(){function b(z){if(z.R&&z.xa){var E=z.m,D;if(z.Z||z.Fa||y){0===z.level?u(z,d.zi*Math.PI/180):t(z,d.Di*Math.PI/180);for(D=E.length-1;0<=D;D--){var G=E[D];G.Fa=!0;var O=G.tb,H=G.we;if(0===z.level){var B=g(O,n,k,"h");var M=(w+(1-w)*G.wc)*g(O,n,k,"s");var Q=(1+(0>G.ja?v*(G.ja+1):v)*(1-G.wc))*
g(O,n,k,"l");var X=g(O,n,k,"a")}else Q=z.pa,B=Q.h,M=Q.s,Q=h(Q.l,O,d.Ei,d.Fi),X=z.we.a;H.h=B;H.s=M;H.l=Q;H.a=X;B=G.pa;G.attribution?(B.h=0,B.s=0,B.l="light"==d.ae?90:10,B.a=1):(B.h=H.h,B.s=H.s,B.l=H.l,B.a=H.a);y&&!G.attribution&&(c.groupColor=B,c.labelColor="auto",p.nc(r,G,c,function(Y){Y.ratio=O}),G.pa=Ea.u(c.groupColor),G.pa.a=P.has(c.groupColor,"a")?c.groupColor.a:1,"auto"!==c.labelColor&&(G.pd=Ea.wa(c.labelColor)))}z.Fa=!1}for(D=E.length-1;0<=D;D--)b(E[D])}}function h(z,E,D,G){var O=f(z+D*G);z=
f(z-D*(1-G));return O+E*(z-O)}function f(z){return 0>z?0:100<z?100:z}var u=e[d.yi]||q,t=l,n=d.Ii,k=d.Bi,r=d.Kg,y=d.Lg,v=d.Ci,w=d.Gi;b(m)};return this};function Za(){this.kc=this.Yd=this.hc=this.Wf=this.w=this.dg=this.weight=this.y=this.x=this.id=0;this.C=this.parent=this.m=null;this.F={x:0,y:0,w:0,o:0};this.J=null;this.qd=this.Ve=void 0;this.Sc=!1;this.wc=this.tb=0;this.we={h:0,s:0,l:0,a:0,model:"hsla"};this.pa={h:0,s:0,l:0,a:0,model:"hsla"};this.xe={h:0,s:0,l:0,model:"hsl"};this.hd=-1;this.pd="auto";this.fb="#000";this.Tf=this.level=this.nd=this.index=0;this.attribution=!1;this.ha=this.$e=0;this.Y=!1;this.$=null;this.O={x:0,y:0,ha:0,r:0};this.Fd=
this.G=null;this.Fc=this.W=this.Sa=this.oc=this.Vd=this.Dd=this.Ma=this.Fa=this.N=this.Z=this.Ea=this.xa=this.R=this.Ia=!1;this.saturation=this.va=this.Da=this.ca=this.opacity=this.scale=1;this.ra=0;this.Hd=1;this.Cb=this.ja=this.yb=0;this.description=this.selected=this.ub=this.Bd=this.open=this.U=!1;this.sb=0;this.Ue=this.Ed=this.X=!0;this.oa=void 0;this.Cc=!1;this.Bc=new ra;this.aa=new ra;this.Qb=new ra;this.Oh=ta.bi();this.Ec=0;this.$c=1;this.Jc=-1;this.empty=function(){return!this.m||0===this.m.length};
var a=[];this.mc=function(e){a.push(e)};this.Nc=function(e){P.Jf(a,e)};var q={scale:1};this.vd=function(){var e=!1;this.scale=1;for(var d=0;d<a.length;d++)e=a[d].We(this,q)||e,this.scale*=q.scale;return e};this.Ib=function(e){for(var d=0;d<a.length;d++)a[d].Ib(this,e)};this.transformPoint=function(e,d){d.x=e.x;d.y=e.y;for(e=0;e<a.length;e++)a[e].transformPoint(this,d,d);return d};this.Jb=function(e,d){d.x=e.x;d.y=e.y;for(e=0;e<a.length;e++)a[e].Jb(this,d,d);return d};var l=[];this.qb=function(e){l.push(e)};
this.Mc=function(e){P.Jf(l,e)};var g={opacity:1,saturation:1,va:1,ca:1,Da:1};this.cc=function(){if(0!==l.length){this.Da=this.ca=this.va=this.saturation=this.opacity=1;for(var e=l.length-1;0<=e;e--)(0,l[e])(this,g),this.opacity*=g.opacity,this.va*=g.va,this.saturation*=g.saturation,this.ca*=g.ca,this.Da*=g.Da}}}function gb(a,q){return q.weight>a.weight?1:q.weight<a.weight?-1:a.index-q.index};function ub(a){var q=this,l,g,e,d,p=a.options,m,c;a.j.subscribe("stage:initialized",function(b,h,f,u){e=f;d=u;l=b.dc("titlebar",p.B,!1);g=l.getContext("2d");g.B=p.B;g.scale(g.B,g.B);a.j.D("titlebar:initialized",q)});a.j.subscribe("stage:resized",function(b,h,f,u){e=f;d=u;g.scale(g.B,g.B)});a.j.subscribe("zoom:initialized",function(b){c=b});a.j.subscribe("api:initialized",function(b){m=b});a.j.subscribe("model:loaded",function(){g.clearRect(0,0,e,d)});this.update=function(b){g.clearRect(0,0,e,d);if(b){!b.empty()&&
b.m[0].description&&(b=b.m[0]);var h=p.ej,f=p.dj,u=Math.min(d/2,p.Wd+2*h),t=u-2*h,n=e-2*f;if(!(0>=t||0>=n)){var k=b.Cc?b.oa.fontSize*b.scale*c.scale():0,r={titleBarText:b.qd,titleBarTextColor:p.$f,titleBarBackgroundColor:p.Zf,titleBarMaxFontSize:p.Wd,titleBarShown:k<p.Vh};if(b.attribution)var y=Pa.Qf("B`ssnu!Rd`sbi!Gn`lUsdd!whrt`mh{`uhno/!Busm,bmhbj!uid!mnfn!un!fn!un!iuuqr;..b`ssnurd`sbi/bnl.gn`lusdd!gns!lnsd!edu`hmr/");else m.nc(p.aj,b,r,function(v){v.titleBarWidth=n;v.titleBarHeight=t;v.labelFontSize=
k;v.viewportScale=c.scale()}),y=r.titleBarText;y&&0!==y.length&&r.titleBarShown&&(b=c.Uc(b.transformPoint(b,{}),{}).y>d/2,h={x:f,y:b?h:d-u+h,w:n,o:t},f=wa.H(h),g.fillStyle=p.Zf,g.fillRect(0,b?0:d-u,e,u),g.fillStyle=p.$f,ta.se({fontFamily:p.bj||p.hh,fontStyle:p.Dj||p.ih,fontWeight:p.Fj||p.kh,fontVariant:p.Ej||p.jh,hb:p.Wd,Gc:p.cj,cb:0,Ua:0,ib:1},g,y,f,h,{x:h.x+h.w/2,y:h.y+h.o/2},!0,!0).ka||g.clearRect(0,0,e,d))}}}};function vb(a){function q(v,w,z){y=!0;h&&h.stop();u&&u.stop();return p(c.reset(v),w,z).then(function(){y=!1})}function l(v){c.update(v);k.N=!0;a.j.D("foamtree:dirty",!0)}function g(v,w){return c.i((0!==c.u()?.35:1)*v,(0!==c.H()?.35:1)*w)}function e(){if(1===b.ratio){var v=Math.round(1E4*c.u())/1E4;0!==v&&(f.Id=v,h=r.K.jc(f).fa({duration:500,P:{x:{start:v,end:0,easing:La.Gb}},ba:function(){c.i(f.x-f.Id,0);l(1);f.Id=f.x}}).start())}}function d(){if(1===b.ratio){var v=Math.round(1E4*c.H())/1E4;0!==v&&
(t.Jd=v,u=r.K.jc(t).fa({duration:500,P:{y:{start:v,end:0,easing:La.Gb}},ba:function(){c.i(0,t.y-t.Jd);l(1);t.Jd=t.y}}).start())}}function p(v,w,z){return v?r.K.jc(b).fa({duration:void 0===w?700:w,P:{ratio:{start:0,end:1,easing:z||La.Vf}},ba:function(){l(b.ratio)}}).Ta():(new Fa).resolve().promise()}function m(v){return function(){return y?(new Fa).resolve().promise():v.apply(this,arguments)}}var c=new Da(a),b={ratio:1},h,f={le:0,x:0,Id:0},u,t={me:0,y:0,Jd:0},n=this,k,r,y=!1;a.j.subscribe("model:loaded",
function(v){k=v;c.reset(!1);c.update(1)});a.j.subscribe("timeline:initialized",function(v){r=v});this.M=function(){a.j.D("zoom:initialized",this)};this.reset=function(v,w){c.Fb(1);return q(!0,v,w)};this.normalize=m(function(v,w){c.pc(1)?q(!1,v,w):n.af()});this.af=function(){e();d()};this.cg=m(function(v,w,z,E){return n.ic(v.F,w,z,E)});this.Nb=m(function(v,w,z,E){return p(c.Nb(v,w),z,E)});this.ic=m(function(v,w,z,E){return p(c.ic(v,w),z,E)});this.fj=m(function(v,w){c.ic(v,w)&&l(1)});this.Xh=m(function(v,
w){1===b.ratio&&g(v,w)&&l(1)});this.rg=m(function(v,w){c.Nb(v,w)&&l(1)});this.qg=m(function(v,w,z,E){v=0|c.Nb(v,w);(v|=g(z,E))&&l(1)});this.Yh=m(function(v,w,z){1===b.ratio&&(h=r.K.jc(f).fa({duration:v/.03,P:{le:{start:w,end:0,easing:La.Gb}},ba:function(){c.i(f.le,0)&&l(1);e()}}).start(),u=r.K.jc(t).fa({duration:v/.03,P:{me:{start:z,end:0,easing:La.Gb}},ba:function(){g(0,t.me)&&l(1);d()}}).start())});this.Zh=function(){h&&0===c.u()&&h.stop();u&&0===c.H()&&u.stop()};this.rc=function(v,w){c.rc(v,w)};
this.Fb=function(v){return c.Fb(v)};this.pc=function(v){return c.pc(v)};this.zd=function(){return c.zd()};this.absolute=function(v,w){return c.absolute(v,w)};this.Uc=function(v,w){return c.Uc(v,w)};this.scale=function(){return c.scale()};this.i=function(v){return c.T(v)};this.content=function(v,w,z,E){c.content(v,w,z,E)}};function wb(a,q,l){function g(I){var T=[];Ra.L(u,function(R){I(R)&&T.push(R.group)});return{groups:T}}function e(I,T){var R=f.options,V=R.Pi,fa=R.Oi;R=R.Od;var x=0<V+fa?R:0,A=[];Va.u(I,Va.i(I,f.options.Qd),function(F,L,K){L="groups"===f.options.Pd?K:L;F.m&&(F=n.K.A(F).wait(x*(fa+V*L)).call(T).done(),A.push(F))});return n.K.A({}).Qa(A).Ta()}function d(I){ca||(ca=!0,t.once(function(){ca=!1;f.j.D("repaint:before");E.Nd(this.pg)},{pg:I}))}function p(I){function T(A,F){var L=A.W;A.W=F<=R;A.Fc=F<=V;A.W!==
L&&Ra.ne(A,function(K){K.Vd=!0});A.open||A.Va||F++;if(A=A.m)for(L=0;L<A.length;L++)T(A[L],F)}var R=f.options.Xe,V=Math.min(f.options.Xe,f.options.Sh);if(I)for(var fa=0;fa<I.length;fa++){var x=I[fa];T(x,b(x))}else T(u,0)}function m(I,T){var R=[];I=c(I,T);I.Wh&&f.j.D("model:childrenAttached",Ra.uc(u));I.Ji&&z.complete(function(fa){N.eb(fa);R.push(fa)});for(T=I=0;T<R.length;T++){var V=R[T];V.m&&(I+=V.m.length);V.xa=!0;O.i(V)}return I}function c(I,T){function R(L,K){var J=!L.attribution&&K-(L.Va?1:0)<
V;x=x||J;L.Ia=L.Ia||J;L.open||L.Va||K++;var W=L.m;!W&&J&&(fa=w.T(L)||fa,W=L.m,F&&(L.Ma=!0));if(W)for(L=0;L<W.length;L++)A.push(W[L],K)}var V=T||f.options.Th,fa=!1,x=!1,A,F="flattened"===q.mb;for(I?A=I.reduce(function(L,K){L.push(K,1);return L},[]):A=[u,1];0<A.length;)R(A.shift(),A.shift());return{Wh:fa,Ji:x}}function b(I){for(var T=0;I.parent;)I.open||I.Va||T++,I=I.parent;return T}var h=this,f={j:new Oa,options:q,Cd:l},u,t=new na,n=new Qa(t),k=ka.create(),r=new Ba(f),y=new vb(f),v=new Xa(f),w=new Ya(f.options),
z=new hb(f),E=new lb(f,t),D=new eb(f);new ub(f);var G=new ab(f),O=new bb(f),H=new cb(f),B=new db(f);f.j.subscribe("stage:initialized",function(I,T,R,V){C.Me(R,V)});f.j.subscribe("stage:resized",function(I,T,R,V){C.Ni(I,T,R,V)});f.j.subscribe("foamtree:attachChildren",m);f.j.subscribe("openclose:changing",p);f.j.subscribe("interaction:reset",function(){S(!0)});f.j.subscribe("foamtree:dirty",d);this.M=function(){f.j.D("timeline:initialized",n);u=w.M();r.M(a);v.M();E.M();D.M();G.M();O.M();y.M();H.M();
...
X=!1,Y=["groupBorderRadius","groupBorderRadiusCorrection","groupBorderWidth","groupInsetWidth","groupBorderWidthScaling"],aa=["maxGroupLevelsDrawn","maxGroupLabelLevelsDrawn"];this.ig=function(I){f.j.D("options:changed",I);P.bb(I,M)&&Ra.L(u,function(T){T.Ma=!0});P.bb(I,Q)&&(u.Fa=!0);P.bb(I,Y)&&(X=!0);P.bb(I,aa)&&(p(),m())};this.reload=function(){U.reload()};this.jg=function(I,T){P.defer(function(){if(X)C.Ph(I),X=!1;else{if(T)for(var R=w.u(T),V=R.length-1;0<=V;V--)R[V].N=!0;else u.N=!0;d(I)}})};this.ga=
function(){r.u()};this.update=function(I){I=I?w.u(I):[u];var T=I.reduce(function(R,V){R[V.id]=V;return R},{});I=I.filter(function(R){for(R=R.parent;R;){if(P.has(T,R.id))return!1;R=R.parent}return!0});w.update(I);C.gj(I)};this.reset=function(){return S(!1)};this.T=E.i;this.Ja=function(){var I={};return function(T,R){return(T=w.i(T))?v.Wc(I,T,R):null}}();this.wa=function(){var I={x:0,y:0},T={x:0,y:0};return function(R,V){return(R=w.i(R))?(I.x=V.x,I.y=V.y,R.transformPoint(I,I),y.Uc(I,I),T.x=I.x,T.y=
I.y,T):null}}();this.sa=function(){var I={};return function(T){return(T=w.i(T))?v.Yc(I,T):null}}();this.hg=function(){var I={};return function(T){return(T=w.i(T))?v.Xc(I,T):null}}();this.ta=function(){var I={};return function(){return y.i(I)}}();this.lg=function(){this.H({groups:g(function(I){return I.group.selected}),newState:!0,keepPrevious:!1});this.u({groups:g(function(I){return I.group.open}),newState:!0,keepPrevious:!1});this.i({groups:g(function(I){return I.group.exposed}),newState:!0,keepPrevious:!1})};
this.Ka=function(){return g(function(I){return I.U})};this.i=function(I){return U.submit(function(){return G.Vb(w.H(I,"exposed",!1),!1,!0,!1)})};this.pb=function(){return g(function(I){return I.open})};this.u=function(I){return U.submit(function(){return H.Bb(w.H(I,"open",!0),!1,!1)})};this.Lb=function(){return g(function(I){return I.selected})};this.H=function(I){return U.submit(function(){B.select(w.H(I,"selected",!0),!1);return(new Fa).resolve().promise()})};this.ng=function(I){return(I=w.i(I))?
I===u?y.reset(q.ob,La.ia(q.Kb)):y.cg(I,q.Yb,q.ob,La.ia(q.Kb)):(new Fa).resolve().promise()};this.ua=function(I,T){return(I=w.u(I))?(T=m(I,T),p(I),T):0};this.Vc=function(I){return D.Lb[I]};this.mg=function(){var I=pa;return{frames:I.frames,totalTime:I.totalTime,lastFrameTime:I.rd,lastInterFrameTime:I.sd,fps:I.ve}};var C=function(){function I(fa,x){var A=fa||R,F=x||V;R=A;V=F;(fa=q.Rb&&q.Rb.boundary)&&2<fa.length?u.C=fa.map(function(L){return{x:A*L.x,y:F*L.y}}):u.C=[{x:0,y:0},{x:A,y:0},{x:A,y:F},{x:0,
y:F}];T()}function T(){u.Z=!0;u.G=u.C;u.F=wa.F(u.C,u.F);u.O=u;wa.Ja(u.C,u.O)}var R,V;return{Me:I,Ni:function(fa,x,A,F){N.stop();var L=A/fa,K=F/x;Ra.oe(u,function(J){J.x=J.x*L+(Math.random()-.5)*A/1E3;J.y=J.y*K+(Math.random()-.5)*F/1E3});I(A,F);u.Ea=!0;z.step(N.eb,!0,!1,function(J){var W=J.m;if(W){z.Eb(J);for(var Z=W.length-1;0<=Z;Z--){var ia=W[Z];ia.w=ia.hc}J.Ea=!0}})?d(!1):(z.fc(u),f.options.Md?(d(!1),ja.Kf(),ja.Oc()):(z.complete(N.eb),u.Fa=!0,d(!1)))},Ph:function(fa){var x=!1;u.empty()||(T(),ja.xb()||
(x=z.step(N.eb,!1,!1),d(fa)));return x},gj:function(fa){fa.forEach(function(x){Ra.za(x,function(A){A.empty()||z.Eb(A)});z.fc(x);f.options.Md?(ja.Kf(),Ra.za(x,function(A){A.empty()||N.grow(A)})):(Ra.za(x,function(A){A.empty()||N.eb(A)}),z.complete(N.eb),x.Fa=!0,d(!1))})}}}(),U=function(){function I(){0===q.Gd&&y.reset(0);f.options.Af(q.Rb);C.Me();w.load(q.Rb);c();p();f.j.D("model:loaded",u,Ra.uc(u));if(!u.empty()){u.open=!0;u.Ia=!0;if(q.Md)var F=ja.Oc();else ja.ai(),F=V();T();0<q.Od?(E.clear(),r.i(1)):
F=Ga([F,R(1)])}f.options.zf(q.Rb);F&&(f.options.Df(),F.then(function(){E.u(function(){t.once(f.options.Cf)})}))}function T(){var F=q.Oa,L=q.Kc;q.Oa=0;q.Kc=0;h.lg();q.Oa=F;q.Kc=L}function R(F,L){return 0===q.re||L?(r.i(F),(new Fa).resolve().promise()):n.K.A({opacity:r.i()}).Xd(2).fa({duration:q.re,P:{opacity:{end:F,easing:La.ia(q.Dg)}},ba:function(){r.i(this.opacity)}}).Ta()}function V(){Ra.za(u,function(K){K.xa=!1});var F=new Fa,L=new Ha(F.resolve);L.i();u.xa=!0;O.i(u).then(L.u);e(u,function J(){this.R&&
this.C&&(this.Z=this.xa=!0,L.i(),O.i(this).then(L.u),L.i(),e(this,J).then(L.u))});return F.promise()}function fa(){for(var F=0;F<A.length;F++){var L=A[F],K=L.action();P.has(K,"then")?K.then(L.ge.resolve):L.ge.resolve()}A=[]}var x=!1,A=[];return{reload:function(){x||(u.empty()?I():(N.stop(),n.i(),ja.stop(),x=!0,Ga(0<q.Gd?[O.u(),S(!1)]:[R(0)]).then(function(){R(0,!0);x=!1;I();P.defer(fa)})))},submit:function(F){if(x){var L=new Fa;A.push({action:F,ge:L});return L.promise()}return F()}}}(),ha,ba=new Ha(function(){ha.resolve()}),
ja=function(){function I(){V||(ba.initial()&&(ha=new Fa),ba.i(),T(),V=!0,t.repeat(R));return ha.promise()}function T(){fa=k.now()}function R(){var x=k.now()-fa>q.Mi;x=z.step(function(A){A.xa=!0;N.grow(A);ba.i();O.i(A).then(ba.u);ba.i();e(A,function(){this.Ia=!0;I()}).then(ba.u)},!0,x)||x;d(!0);x&&(V=!1,ba.u());return x}var V=!1,fa;return{ai:function(){z.complete(N.eb)},Oc:I,Kf:T,xb:function(){return!ba.initial()},stop:function(){t.cancel(R);V=!1;ba.clear()}}}(),N=function(){function I(R){var V=!R.empty();
R.xa=!0;if(V){for(var fa=R.m,x=fa.length-1;0<=x;x--){var A=fa[x];A.w=A.hc}R.Ea=!0}return V}var T=[];return{grow:function(R){var V=f.options,fa=V.Yg;0<fa?Va.u(R,Va.i(R,f.options.Qd),function(x,A,F){A="groups"===f.options.Pd?F:A;ba.i();T.push(n.K.A(x).wait(A*V.Xg*fa).fa({duration:fa,P:{w:{start:x.Wf,end:x.hc,easing:La.ia(V.Zg)}},ba:function(){this.w=Math.max(0,this.w);this.parent.Ea=!0;ja.Oc()}}).Xa(ba.u).start())}):I(R)&&ja.Oc()},eb:I,stop:function(){for(var R=T.length-1;0<=R;R--)T[R].stop();T=[]}}}(),
S=function(){var I=!1;return function(T){if(I)return(new Fa).resolve().promise();I=!0;var R=[];R.push(y.reset(q.ob,La.ia(q.Kb)));var V=new Fa;G.Vb({m:[],Ca:!1,Ba:!1},T,!1,!0).then(function(){H.Bb({m:[],Ca:!1,Ba:!1},T,!1).then(V.resolve)});R.push(V.promise());return Ga(R).then(function(){I=!1;T&&q.Ef()})}}(),ca=!1}function sb(){return{version:"3.5.1",build:"bugfix/3.5.x/26b14206",brandingAllowed:!1}};ea.md(function(){window.CarrotSearchFoamTree=function(a){function q(u,t){if(!m||m.exists(u))switch(u){case "selection":return h.Lb();case "open":return h.pb();case "exposure":return h.Ka();case "state":return h.sa.apply(this,t);case "geometry":return h.Ja.apply(this,t);case "hierarchy":return h.hg.apply(this,t);case "containerCoordinates":return h.wa.apply(this,t);case "imageData":return h.T.apply(this,t);case "viewport":return h.ta();case "times":return h.mg();case "onModelChanged":case "onRedraw":case "onRolloutStart":case "onRolloutComplete":case "onRelaxationStep":case "onGroupHover":case "onGroupOpenOrCloseChanging":case "onGroupExposureChanging":case "onGroupSelectionChanging":case "onGroupSelectionChanged":case "onGroupClick":case "onGroupDoubleClick":case "onGroupHold":return u=
c[u],Array.isArray(u)?u:[u];default:return c[u]}}function l(u){function t(y,v){return P.has(n,y)?(v(n[y]),delete n[y],1):0}if(0===arguments.length)return 0;if(1===arguments.length)var n=P.extend({},arguments[0]);else 2===arguments.length&&(n={},n[arguments[0]]=arguments[1]);m&&m.validate(n,b.Qh);var k=0;h&&(k+=t("selection",h.H),k+=t("open",h.u),k+=t("exposure",h.i));var r={};P.Aa(n,function(y,v){if(c[v]!==y||P.wb(y))r[v]=y,k++;c[v]=y});0<k&&e(r);return k}function g(u,t){u="on"+u.charAt(0).toUpperCase()+
u.slice(1);var n=c[u];c[u]=t(Array.isArray(n)?n:[n]);t={};t[u]=c[u];e(t)}function e(u){(function(){function t(n,k){return P.has(u,n)||void 0===k?Na.A(c[n],p):k}b.Qh=c.logging;b.Rb=c.dataObject;b.B=c.pixelRatio;b.nb=c.wireframePixelRatio;b.mb=c.stacking;b.Ag=c.descriptionGroup;b.Tb=c.descriptionGroupType;b.qc=c.descriptionGroupPosition;b.Bg=c.descriptionGroupDistanceFromCenter;b.Sb=c.descriptionGroupSize;b.ie=c.descriptionGroupMinHeight;b.he=c.descriptionGroupMaxHeight;b.je=c.descriptionGroupPolygonDrawn;
b.Dc=c.layout;b.ac=c.layoutByWeightOrder;b.Zi=c.showZeroWeightGroups;b.Ce=c.groupMinDiameter;b.Ld=c.rectangleAspectRatioPreference;b.Li=c.initializer||c.relaxationInitializer;b.Mi=c.relaxationMaxDuration;b.Md=c.relaxationVisible;b.If=c.relaxationQualityThreshold;b.qh=c.groupResizingBudget;b.Yg=c.groupGrowingDuration;b.Xg=c.groupGrowingDrag;b.Zg=c.groupGrowingEasing;b.Ig=c.groupBorderRadius;b.$a=c.groupBorderWidth;b.La=c.groupBorderWidthScaling;b.jd=c.groupInsetWidth;b.Jg=c.groupBorderRadiusCorrection;
b.ab=c.groupStrokeWidth;b.yc=c.groupSelectionOutlineWidth;b.uh=c.groupSelectionOutlineColor;b.kd=c.groupSelectionOutlineShadowSize;b.De=c.groupSelectionOutlineShadowColor;b.rh=c.groupSelectionFillHueShift;b.th=c.groupSelectionFillSaturationShift;b.sh=c.groupSelectionFillLightnessShift;b.Fe=c.groupSelectionStrokeHueShift;b.He=c.groupSelectionStrokeSaturationShift;b.Ge=c.groupSelectionStrokeLightnessShift;b.Wg=c.groupFillType;b.Sg=c.groupFillGradientRadius;b.Pg=c.groupFillGradientCenterHueShift;b.Rg=
c.groupFillGradientCenterSaturationShift;b.Qg=c.groupFillGradientCenterLightnessShift;b.Tg=c.groupFillGradientRimHueShift;b.Vg=c.groupFillGradientRimSaturationShift;b.Ug=c.groupFillGradientRimLightnessShift;b.ld=c.groupStrokeType;b.ab=c.groupStrokeWidth;b.Ie=c.groupStrokePlainHueShift;b.Ke=c.groupStrokePlainSaturationShift;b.Je=c.groupStrokePlainLightnessShift;b.zh=c.groupStrokeGradientRadius;b.vh=c.groupStrokeGradientAngle;b.Ah=c.groupStrokeGradientUpperHueShift;b.Ch=c.groupStrokeGradientUpperSaturationShift;
b.Bh=c.groupStrokeGradientUpperLightnessShift;b.wh=c.groupStrokeGradientLowerHueShift;b.yh=c.groupStrokeGradientLowerSaturationShift;b.xh=c.groupStrokeGradientLowerLightnessShift;b.$g=c.groupHoverFillHueShift;b.bh=c.groupHoverFillSaturationShift;b.ah=c.groupHoverFillLightnessShift;b.ze=c.groupHoverStrokeHueShift;b.Be=c.groupHoverStrokeSaturationShift;b.Ae=c.groupHoverStrokeLightnessShift;b.Pa=c.groupExposureScale;b.Og=c.groupExposureShadowColor;b.ye=c.groupExposureShadowSize;b.Yb=c.groupExposureZoomMargin;
b.Eh=c.groupUnexposureLightnessShift;b.Fh=c.groupUnexposureSaturationShift;b.Dh=c.groupUnexposureLabelColorThreshold;b.Oa=c.exposeDuration;b.Wb=c.exposeEasing;b.Kc=c.openCloseDuration;b.Kg=Na.A(c.groupColorDecorator,p);b.Lg=c.groupColorDecorator!==P.qa;b.fh=Na.A(c.groupLabelDecorator,p);b.gh=c.groupLabelDecorator!==P.qa;b.lh=Na.A(c.groupLabelLayoutDecorator,p);b.mh=c.groupLabelLayoutDecorator!==P.qa;b.Mg=Na.A(c.groupContentDecorator,p);b.xc=c.groupContentDecorator!==P.qa;b.Ng=c.groupContentDecoratorTriggering;
b.Hi=c.rainbowStartColor;b.Ai=c.rainbowEndColor;b.yi=c.rainbowColorDistribution;b.zi=c.rainbowColorDistributionAngle;b.Di=c.rainbowLightnessDistributionAngle;b.Ei=c.rainbowLightnessShift;b.Fi=c.rainbowLightnessShiftCenter;b.Gi=c.rainbowSaturationCorrection;b.Ci=c.rainbowLightnessCorrection;b.Ff=c.parentFillOpacity;b.$h=c.parentStrokeOpacity;b.Gf=c.parentLabelOpacity;b.Hf=c.parentOpacityBalancing;b.ph=c.groupLabelUpdateThreshold;b.hh=c.groupLabelFontFamily;b.ih=c.groupLabelFontStyle;b.jh=c.groupLabelFontVariant;
b.kh=c.groupLabelFontWeight;b.oh=c.groupLabelMinFontSize;b.vj=c.groupLabelMaxFontSize;b.uj=c.groupLabelLineHeight;b.tj=c.groupLabelHorizontalPadding;b.xj=c.groupLabelVerticalPadding;b.wj=c.groupLabelMaxTotalHeight;b.eh=c.groupLabelDarkColor;b.nh=c.groupLabelLightColor;b.dh=c.groupLabelColorThreshold;b.ij=c.wireframeDrawMaxDuration;b.jj=c.wireframeLabelDrawing;b.hj=c.wireframeContentDecorationDrawing;b.eg=c.wireframeToFinalFadeDuration;b.kj=c.wireframeToFinalFadeDelay;b.Eg=c.finalCompleteDrawMaxDuration;
b.Fg=c.finalIncrementalDrawMaxDuration;b.te=c.finalToWireframeFadeDuration;b.Zc=c.androidStockBrowserWorkaround;b.Le=c.incrementalDraw;b.Uh=c.maxGroups;b.Th=c.maxGroupLevelsAttached;b.Xe=c.maxGroupLevelsDrawn;b.Sh=c.maxGroupLabelLevelsDrawn;b.Qd=c.rolloutStartPoint;b.Pd=c.rolloutMethod;b.Qi=c.rolloutEasing;b.Od=c.rolloutDuration;b.Mf=c.rolloutScalingStrength;b.Of=c.rolloutTranslationXStrength;b.Pf=c.rolloutTranslationYStrength;b.Lf=c.rolloutRotationStrength;b.Nf=c.rolloutTransformationCenter;b.Ui=
c.rolloutPolygonDrag;b.Vi=c.rolloutPolygonDuration;b.Ri=c.rolloutLabelDelay;b.Si=c.rolloutLabelDrag;b.Ti=c.rolloutLabelDuration;b.Pi=c.rolloutChildGroupsDrag;b.Oi=c.rolloutChildGroupsDelay;b.ri=c.pullbackStartPoint;b.ki=c.pullbackMethod;b.gi=c.pullbackEasing;b.Bj=c.pullbackType;b.Gd=c.pullbackDuration;b.pi=c.pullbackScalingStrength;b.ti=c.pullbackTranslationXStrength;b.ui=c.pullbackTranslationYStrength;b.oi=c.pullbackRotationStrength;b.si=c.pullbackTransformationCenter;b.li=c.pullbackPolygonDelay;
b.mi=c.pullbackPolygonDrag;b.ni=c.pullbackPolygonDuration;b.hi=c.pullbackLabelDelay;b.ii=c.pullbackLabelDrag;b.ji=c.pullbackLabelDuration;b.di=c.pullbackChildGroupsDelay;b.ei=c.pullbackChildGroupsDrag;b.fi=c.pullbackChildGroupsDuration;b.re=c.fadeDuration;b.Dg=c.fadeEasing;b.lj=c.zoomMouseWheelFactor;b.ob=c.zoomMouseWheelDuration;b.Kb=c.zoomMouseWheelEasing;b.Vh=c.maxLabelSizeForTitleBar;b.bj=c.titleBarFontFamily;b.Zf=c.titleBarBackgroundColor;b.$f=c.titleBarTextColor;b.cj=c.titleBarMinFontSize;b.Wd=
c.titleBarMaxFontSize;b.dj=c.titleBarTextPaddingLeftRight;b.ej=c.titleBarTextPaddingTopBottom;b.aj=c.titleBarDecorator;b.pj=c.attributionText;b.mj=c.attributionLogo;b.oj=c.attributionLogoScale;b.qj=c.attributionUrl;b.$d=c.attributionPosition;b.sg=c.attributionDistanceFromCenter;b.tg=c.attributionWeight;b.ae=c.attributionTheme;b.Ne=c.interactionHandler;b.Af=t("onModelChanging",b.Af);b.zf=t("onModelChanged",b.zf);b.Bf=t("onRedraw",b.Bf);b.Df=t("onRolloutStart",b.Df);b.Cf=t("onRolloutComplete",b.Cf);
b.Ad=t("onRelaxationStep",b.Ad);b.Ef=t("onViewReset",b.Ef);b.sf=t("onGroupOpenOrCloseChanging",b.sf);b.rf=t("onGroupOpenOrCloseChanged",b.rf);b.jf=t("onGroupExposureChanging",b.jf);b.hf=t("onGroupExposureChanged",b.hf);b.uf=t("onGroupSelectionChanging",b.uf);b.tf=t("onGroupSelectionChanged",b.tf);b.lf=t("onGroupHover",b.lf);b.nf=t("onGroupMouseMove",b.nf);b.cf=t("onGroupClick",b.cf);b.df=t("onGroupDoubleClick",b.df);b.kf=t("onGroupHold",b.kf);b.qf=t("onGroupMouseWheel",b.qf);b.pf=t("onGroupMouseUp",
b.pf);b.mf=t("onGroupMouseDown",b.mf);b.gf=t("onGroupDragStart",b.gf);b.ef=t("onGroupDrag",b.ef);b.ff=t("onGroupDragEnd",b.ff);b.xf=t("onGroupTransformStart",b.xf);b.vf=t("onGroupTransform",b.vf);b.wf=t("onGroupTransformEnd",b.wf);b.yf=t("onKeyUp",b.yf)})();b.Ii=Ea.u(b.Hi);b.Bi=Ea.u(b.Ai);b.Ee=Ea.u(b.De);b.nj=null;h&&(h.ig(u),P.has(u,"dataObject")&&h.reload())}function d(u){return function(){return u.apply(this,arguments).Gg(p)}}var p=this,m=window.CarrotSearchFoamTree.asserts,c=P.extend({},window.CarrotSearchFoamTree.defaults),
b={};l(a);(a=c.element||document.getElementById(c.id))||Ca.i("Element to embed FoamTree in not found.");c.element=a;var h=new wb(a,b,c);h.M();var f={get:function(u){return 0===arguments.length?P.extend({},c):q(arguments[0],Array.prototype.slice.call(arguments,1))},set:l,on:function(u,t){g(u,function(n){n.push(t);return n})},off:function(u,t){g(u,function(n){return n.filter(function(k){return k!==t})})},resize:h.ga,redraw:h.jg,update:h.update,attach:h.ua,select:d(h.H),expose:d(h.i),open:d(h.u),reset:d(h.reset),
zoom:d(h.ng),trigger:function(u,t){(u=h.Vc(u))&&u(t)},dispose:function(){function u(){throw"FoamTree instance disposed";}h.Za();P.Aa(f,function(t,n){"dispose"!==n&&(p[n]=u)})}};P.Aa(f,function(u,t){p[t]=u});h.reload()};window["CarrotSearchFoamTree.asserts"]&&(window.CarrotSearchFoamTree.asserts=window["CarrotSearchFoamTree.asserts"],delete window["CarrotSearchFoamTree.asserts"]);window.CarrotSearchFoamTree.supported=!0;window.CarrotSearchFoamTree.version=sb;window.CarrotSearchFoamTree.defaults=Object.freeze({id:void 0,
...
attributionDistanceFromCenter:1,attributionWeight:.025,attributionTheme:"light",interactionHandler:ea.Ih()?"hammerjs":"builtin",onModelChanging:[],onModelChanged:[],onRedraw:[],onRolloutStart:[],onRolloutComplete:[],onRelaxationStep:[],onViewReset:[],onGroupOpenOrCloseChanging:[],onGroupOpenOrCloseChanged:[],onGroupExposureChanging:[],onGroupExposureChanged:[],onGroupSelectionChanging:[],onGroupSelectionChanged:[],onGroupHover:[],onGroupMouseMove:[],onGroupClick:[],onGroupDoubleClick:[],onGroupHold:[],
